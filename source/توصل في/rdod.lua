...
if text == 'سيمو' or text == 'مين سيمو' then
if not Redis:get(Fast.."rb:bna"..msg_chat_id) then
return bot.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
...
if text == 'سمسم' or text == 'يا سمسم' then
if not Redis:get(Fast.."rb:bna"..msg_chat_id) then
return bot.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
return bot.sendText(msg_chat_id,msg_id,'*شق سيمو متحكش بقا☺️*',"md",true)  
end
...
return bot.sendText(msg_chat_id,msg_id,'*اخو سيمو المفضل خدبالك💕*',"md",true)  
end
...
return bot.sendText(msg_chat_id,msg_id,'*حته من سيمو💎💕*',"md",true)  
end
...
if text == 'سي في سيمو' or text == 'cv semo' then
if not Redis:get(Fast.."rb:bna"..msg_chat_id) then
return bot.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
...
data = {
{
{text = '◜𝙨𝙤𝙪𝙍𝘾𝙀 𝙀𝙡𝙉𝙂𝙤𝙤𝙈◞', url = 't.me/SSE_MO'}, 
},
}
}
