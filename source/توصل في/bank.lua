...
return send(msg.chat_id,msg.id, "ᥫ᭡  لديك حساب بنكي مسبقاً\n\nᥫ᭡  لعرض معلومات حسابك اكتب\n⇠ `حسابي`","md",true)
end
...
send(msg.chat_id,msg.id, "\nᥫ᭡ وسوينا لك حساب في بنك تايجر 🏦\nᥫ᭡ وشحنالك 50 ريال 💵 هدية\n\nᥫ᭡  رقم حسابك ↢ ( `"..creditcc.."` )\nᥫ᭡  نوع البطاقة ↢ ( ماستر 💳 )\nᥫ᭡  فلوسك ↢ ( 50 ريال 💵 )  ","md",true)  
end 
if text == "فيزا" then
local ban = bot.getUser(msg.sender_id.user_id)
if ban.first_name then
...
Redis:sadd(Fast.."booob",msg.sender_id.user_id)
Redis:del(Fast.."booobb" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
send(msg.chat_id,msg.id, "\nᥫ᭡ وسوينا لك حساب في بنك تايجر 🏦\nᥫ᭡ وشحنالك 50 ريال 💵 هدية\n\nᥫ᭡  رقم حسابك ↢ ( `"..creditex.."` )\nᥫ᭡  نوع البطاقة ↢ ( اكسبرس 💳 )\nᥫ᭡  فلوسك ↢ ( 50 ريال 💵 )  ","md",true)   
end 
end
...
send(msg.chat_id,msg.id, "ᥫ᭡  مسحت حسابك البنكي 🏦","md",true)
else
send(msg.chat_id,msg.id, "ᥫ᭡  ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
send(msg.chat_id,msg.id, "ᥫ᭡  مسحت لعبه البنك 🏦","md",true)
end
end
...
return send(msg.chat_id,msg.id, "ᥫ᭡  ماعندك فلوس ارسل الالعاب وابدأ بجمع الفلوس \n✦","md",true)
end
send(msg.chat_id,msg.id, "ᥫ᭡  فلوسك "..ballancee.." ريال 💵","md",true)
else
send(msg.chat_id,msg.id, "ᥫ᭡  ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
send(msg.chat_id,msg.id,"\n*ᥫ᭡ بنك تايجر ماعنده حساب بالبنك 🤣*","md",true)  
return false
end
if Redis:sismember(Fast.."booob",rep_idd) then
ballanceed = Redis:get(Fast.."boob"..rep_idd) or 0
send(msg.chat_id,msg.id, "ᥫ᭡  فلوسه "..ballanceed.." ريال 💵","md",true)
else
send(msg.chat_id,msg.id, "ᥫ᭡  ماعنده حساب بنكي ","md",true)
end
end
...
ballancee = Redis:get(Fast.."boob"..msg.sender_id.user_id) or 0
send(msg.chat_id,msg.id, "ᥫ᭡  الاسم ↢ "..news.."\nᥫ᭡  الحساب ↢ `"..cccc.."`\nᥫ᭡  بنك ↢ (بنك تايجر )\nᥫ᭡  نوع ↢ ( "..uuuu.." )\nᥫ᭡  الرصيد ↢ ( "..ballancee.." ريال 💵 )\nᥫ᭡  الزرف ( "..pppp.." ريال 💵 )\n✦","md",true)
else
send(msg.chat_id,msg.id, "ᥫ᭡  ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
send(msg.chat_id,msg.id, "ᥫ᭡  الاسم ↢ "..news.."\nᥫ᭡  الحساب ↢ `"..ccccc.."`\nᥫ᭡  بنك ↢ (بنك تايجر )\nᥫ᭡  نوع ↢ ( "..uuuuu.." )\nᥫ᭡  الرصيد ↢ ( "..ballanceed.." ريال 💵 )\nᥫ᭡  الزرف ↢ ( "..ppppp.." ريال 💵 )\nᥫ᭡  مسكين مسحت حسابه \n✦","md",true)
else
send(msg.chat_id,msg.id, "ᥫ᭡  ماعنده حساب بنكي اصلاً ","md",true)
end
end
end
...
send(msg.chat_id,msg.id, "ᥫ᭡  الاسم ↢ "..yty.."\nᥫ᭡  الحساب ↢ `"..coniss.."`\nᥫ᭡  بنك ↢ (بنك تايجر )\nᥫ᭡  نوع ↢ ( "..fsvhh.." )\nᥫ᭡  الرصيد ↢ ( "..dfhb.." ريال 💵 )\n✦","md",true)
else
send(msg.chat_id,msg.id, "ᥫ᭡  مافيه حساب بنكي كذا","md",true)
end
end
...
return send(msg.chat_id,msg.id,"ᥫ᭡  مايمديك تضارب الحين\nᥫ᭡  تعال بعد ( "..time_ex.." )","md",true)
end
ballancee = Redis:get(Fast.."boob"..msg.sender_id.user_id) or 0
if tonumber(coniss) < 99 then
return send(msg.chat_id,msg.id, "ᥫ᭡  الحد الادنى المسموح هو 100 ريال 💵\n✦","md",true)
end
if tonumber(ballancee) < tonumber(coniss) then
return send(msg.chat_id,msg.id, "ᥫ᭡  فلوسك ماتكفي \n✦","md",true)
end
...
send(msg.chat_id,msg.id, "ᥫ᭡  مضاربة فاشلة 📉\nᥫ᭡  نسبة الخسارة ↢ "..modarbaa.."%\nᥫ᭡  المبلغ الذي خسرته ↢ ( "..ballanceekku.." ريال 💵 )\nᥫ᭡  فلوسك صارت ↢ ( "..ballanceekkku.." ريال 💵 )\n✦","md",true)
elseif Descriptioontt == "2" or Descriptioontt == "4" then
ballanceekku = coniss / 100 * modarbaa
ballanceekkku = ballancee + ballanceekku
Redis:set(Fast.."boob"..msg.sender_id.user_id , math.floor(ballanceekkku))
Redis:setex(Fast.."iiooooo" .. msg.sender_id.user_id,1200, true)
send(msg.chat_id,msg.id, "ᥫ᭡  مضاربة ناجحة 📈\nᥫ᭡  نسبة الربح ↢ "..modarbaa.."%\nᥫ᭡  المبلغ الذي ربحته ↢ ( "..ballanceekku.." ريال 💵 )\nᥫ᭡  فلوسك صارت ↢ ( "..ballanceekkku.." ريال 💵 )\n✦","md",true)
else
Redis:setex(Fast.."iiooooo" .. msg.sender_id.user_id,1200, true)
send(msg.chat_id,msg.id, "ᥫ᭡  تأخرت اليوم والبنك مسكر ارجع بعدين \n✦","md",true)
end
else
send(msg.chat_id,msg.id, "ᥫ᭡  ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
...
return send(msg.chat_id,msg.id,"ᥫ᭡  مايمديك تستثمر الحين\nᥫ᭡  تعال بعد ( "..time_ex.." )","md",true)
end
ballancee = Redis:get(Fast.."boob"..msg.sender_id.user_id) or 0
if tonumber(coniss) < 99 then
return send(msg.chat_id,msg.id, "ᥫ᭡  الحد الادنى المسموح هو 100 ريال 💵\n✦","md",true)
...
send(msg.chat_id,msg.id, "ᥫ᭡  استثمار ناجح 💰\nᥫ᭡  نسبة الربح ↢ "..hadddd.."%\nᥫ᭡  مبلغ الربح ↢ ( "..ballanceekk.." ريال 💵 )\nᥫ᭡  فلوسك صارت ↢ ( "..ballanceekkk.." ريال 💵 )\n✦","md",true)
else
send(msg.chat_id,msg.id, "ᥫ᭡  ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
return send(msg.chat_id,msg.id,"ᥫ᭡  مايمديك تلعب لعبة الحظ الحين\nᥫ᭡  تعال بعد ( "..time_ex.." )","md",true)
end
ballancee = Redis:get(Fast.."boob"..msg.sender_id.user_id) or 0
if tonumber(ballancee) < tonumber(coniss) then
return send(msg.chat_id,msg.id, "ᥫ᭡  فلوسك ماتكفي \n✦","md",true)
...
send(msg.chat_id,msg.id, "ᥫ᭡  مبروك فزت بالحظ 🎉\nᥫ᭡  فلوسك قبل ↢ ( "..ballancee.." ريال 💵 )\nᥫ᭡  فلوسك الحين ↢ ( "..ballanceek.." ريال 💵 )\n✦","md",true)
else
local ballanceekk = ballancee - coniss
Redis:decrby(Fast.."boob"..msg.sender_id.user_id , coniss)
Redis:setex(Fast.."iiooo" .. msg.sender_id.user_id,1200, true)
send(msg.chat_id,msg.id, "ᥫ᭡  للاسف خسرت بالحظ 😬\nᥫ᭡  فلوسك قبل ↢ ( "..ballancee.." ريال 💵 )\nᥫ᭡  فلوسك الحين ↢ ( "..ballanceekk.." ريال 💵 )\n✦","md",true)
end
else
send(msg.chat_id,msg.id, "ᥫ᭡  ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
...
return send(msg.chat_id,msg.id, "ᥫ᭡  ماعندك حساب بنكي ","md",true)
end
if tonumber(coniss) < 100 then
return send(msg.chat_id,msg.id, "ᥫ᭡  الحد الادنى المسموح به هو 100 ريال \n✦","md",true)
end
ballancee = Redis:get(Fast.."boob"..msg.sender_id.user_id) or 0
...
send(msg.chat_id,msg.id,[[
ᥫ᭡  ارسل الحين رقم الحساب البنكي الي تبي تحول له
...
return send(msg.chat_id,msg.id,"ᥫ᭡  ارسل رقم حساب بنكي ","md",true)
end
if text == cccc then
Redis:del(Fast.."trans" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
Redis:del(Fast.."transn" .. msg.sender_id.user_id)
return send(msg.chat_id,msg.id,"ᥫ᭡  مايمديك تحول لنفسك ","md",true)
end
...
if #ty_users == 0 then
return send(msg.chat_id,msg.id,"ᥫ᭡  لا يوجد احد","md",true)
end
...
return send(msg.chat_id,msg.id,"ᥫ᭡  من شوي اخذت بخشيش استنى ( "..time_ex.." )","md",true)
end
local jjjo = math.random(1,200);
Redis:incrby(Fast.."boob"..msg.sender_id.user_id , jjjo)
send(msg.chat_id,msg.id,"ᥫ᭡  تكرم وهي بخشيش "..jjjo.." ريال 💵","md",true)
...
if not Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
return send(msg.chat_id,msg.id,"ᥫ᭡ ما عندك حساب بنكي")
end
local Remsg = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
local UserInfo = bot.getUser(rep_idd)
if UserInfo and UserInfo.type and UserInfo.type.Fastbots == "userTypeBot" then
send(msg.chat_id,msg.id,"\n*ᥫ᭡ البوت ماعنده حساب بالبنك *","md",true)  
return false
end
if rep_idd == msg.sender_id.user_id then
send(msg.chat_id,msg.id,"\n*ᥫ᭡  بدك تزرف نفسك 🤡*","md",true)  
return false
end
if Redis:get(Fast.."polic" .. msg.sender_id.user_id) then
local time_ex = ctime(Redis:ttl(Fast.."polic" .. msg.sender_id.user_id))
return send(msg.chat_id,msg.id,"ᥫ᭡  انتا بالسجن 🏤 استنى ( "..time_ex.." )","md",true)
end
if Redis:get(Fast.."hrame" .. rep_idd) then
local time_ex = ctime(Redis:ttl(Fast.."hrame" .. rep_idd))
return send(msg.chat_id,msg.id,"ᥫ᭡  ذا المسكين مزروف قبل شوي\nᥫ᭡  يمديك تزرفه بعد ( "..time_ex.." )","md",true)
end
if Redis:sismember(Fast.."booob",rep_idd) then
ballanceed = Redis:get(Fast.."boob"..rep_idd) or 0
if tonumber(ballanceed) < 199 then
return send(msg.chat_id,msg.id, "ᥫ᭡  مايمديك تزرفه فلوسه اقل من 200 ريال 💵","md",true)
end
...
send(msg.chat_id,msg.id, "ᥫ᭡  خذ يالحرامي زرفته "..hrame.." ريال 💵\n✦","md",true)
else
Redis:setex(Fast.."polic" .. msg.sender_id.user_id,300, true)
send(msg.chat_id,msg.id, "ᥫ᭡  مسكتك الشرطة وانتا تزرف 🚔\n✦","md",true)
end
else
send(msg.chat_id,msg.id, "ᥫ᭡  ماعنده حساب بنكي ","md",true)
end
...
Redis:setex(Fast.."iiihoo" .. msg.sender_id.user_id,600, true)
elseif Descriptioont == "كنزبنك تايجر المفقود 💲" then
Redis:incrby(Fast.."boob"..msg.sender_id.user_id , 150)
local ballancee = Redis:get(Fast.."boob"..msg.sender_id.user_id) or 0
bot.sendText(msg.chat_id,msg.id,"اشعار ايداع "..neews.."\nتم استبداله بمبلغ وقدره : 150 ريال 💵\nكنزك هـو : كنزبنك تايجر المفقود 💲\nنوع العملية : البحث عن كنز\nرصيدك دلوقتي : "..ballancee.." ريال 💵","md",true)
Redis:setex(Fast.."iiihoo" .. msg.sender_id.user_id,600, true)
...
return send(msg.chat_id,msg.id,"ᥫ᭡  راتبك بينزل بعد ( "..time_ex.." )","md",true)
end
local ban = bot.getUser(msg.sender_id.user_id)
if ban.first_name then
neews = "["..ban.first_name.."](tg://user?id="..ban.id..")"
...
local jobs = {"طيار","محامي","دكتور","خباز","مدير بنك","قلب تايجر","مدرس"}
...
local ballancee = Redis:get(Fast.."boob"..msg.sender_id.user_id) or 0
send(msg.chat_id,msg.id,"ᥫ᭡ اشعار ايداع "..neews.."\nᥫ᭡ وظيفتك : "..your_job.."\nᥫ᭡ المبلغ : "..ratbk.." ريال 💵\nᥫ᭡ نوع العملية : اضافة راتب\nᥫ᭡ رصيدك الحين : "..ballancee.." ريال 💵","md",true)
...
return send(msg.chat_id,msg.id, "ᥫ᭡ استخدم الامر بالرد علي الاعضاء")
end
if not Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
return send(msg.chat_id,msg.id,"ᥫ᭡ ما عندك حساب بنكي")
end
...
if rep_idd == msg.sender_id.user_id then
send(msg.chat_id,msg.id,"\n*ᥫ᭡ ما ينفع تهاجم نفسك*","md",true)  
return false
end
if not Redis:sismember(Fast.."booob",rep_idd) then
return send(msg.chat_id,msg.id,"ᥫ᭡ ما عنده حساب بنكي")
end
if Redis:get(Fast..'hgomm'..msg.sender_id.user_id) then
return send(msg.chat_id,msg.id,"ᥫ᭡ استنا "..ctime(Redis:ttl(Fast..'hgomm'..msg.sender_id.user_id)).." وبعدين هاجم تاني")
end
...
return send(msg.chat_id,msg.id, "ᥫ᭡ فلوسك اقل من هذا المبلغ")
end
if tonumber(his_balance) < coniss then
return send(msg.chat_id,msg.id, "ᥫ᭡ فلوسه اقل من هذا المبلغ")
end
...
return send(msg.chat_id,msg.id, "ᥫ᭡ نجحت في الهجوم وسرقت منه "..coniss.."\nᥫ᭡ اصبح رصيدك الان "..balance.."\nᥫ᭡ اصبح رصيده هو "..Hbalance)
else
Redis:incrby(Fast.."boob"..rep_idd , coniss)
Redis:decrby(Fast.."boob"..msg.sender_id.user_id , coniss)
local balance = Redis:get(Fast.."boob"..msg.sender_id.user_id) or 0
local Hbalance = Redis:get(Fast.."boob"..rep_idd) or 0
Redis:setex(Fast..'hgomm'..msg.sender_id.user_id,300,true)
return send(msg.chat_id,msg.id, "ᥫ᭡ فشلت في الهجوم عليه وخصم منك "..coniss.."\nᥫ᭡ اصبح رصيدك الان "..balance.."\nᥫ᭡ اصبح رصيده هو "..Hbalance)
end
end
...
return send(msg.chat_id,msg.id,"ᥫ᭡ تم رفعك مميز بنجاح وخصم 3000 ريال من فلوسك")
...
Redis:del(Fast..msg.chat_id..msg.sender_id.user_id.."txtrtb") 
return send(msg.chat_id,msg.id,"ᥫ᭡ تم رفعك ادمن بنجاح وخصم 4000 ريال من فلوسك")
...
Redis:del(Fast..msg.chat_id..msg.sender_id.user_id.."txtrtb") 
return send(msg.chat_id,msg.id,"ᥫ᭡ تم رفعك مدير بنجاح وخصم 6000 ريال من فلوسك")
...
Redis:del(Fast..msg.chat_id..msg.sender_id.user_id.."txtrtb") 
return send(msg.chat_id,msg.id,"ᥫ᭡ تم رفعك منشئ بنجاح وخصم 8000 ريال من فلوسك")
end
end
if text == "شراء رتبه" then
if not Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
return send(msg.chat_id,msg.id,"ᥫ᭡ ما عندك حساب بنكي \nᥫ᭡ ارسل `انشاء حساب بنكي`","md")
end
local balance = Redis:get(Fast.."boob"..msg.sender_id.user_id)
if tonumber(balance) == tonumber(0) then
return send(msg.chat_id,msg.id,"ᥫ᭡ ما عندك اي فلوس تشتري بيها")
end
if tonumber(balance) < 2000 then
return send(msg.chat_id,msg.id,"ᥫ᭡ فلوسك لا تكفي لشراء اي رتبه")
end
if tonumber(balance)  >= 2000 and tonumber(balance) < 4000 then
Txtrtb = "ᥫ᭡ الرتب اللتي يمكنك شرائها هي \n\nᥫ᭡ `مميز` (2000 ريال) \n\n ᥫ᭡ اضغط علي الرتبه ليتم نسخها"
