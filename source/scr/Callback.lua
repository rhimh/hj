...
local txt = '⌔️ بواسطه 「 ['..UserInfo.first_name..'](tg://user?id='..who_promot..')⁪⁬‌‌‌‌ 」\n⌔️  تم تفعيل الجروب ['..Get_Chat.title..']('..Info_Chats.invite_link.invite_link..') تلقائياً\n✦'
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
return send(Sudo_Id,0,'*\n⌔️ تم طرد البوت من جروب جديده \n⌔️ اسم الجروب : '..Get_Chat.title..'\n⌔️ ايدي الجروب :*`-100'..data.supergroup.id..'`\n⌔️ تم مسح جميع البيانات المتعلقه بالجروب',"md")
end
...
if tonumber(Message_Edit.sender_id.user_id) == 5934060011 then
data.The_Controller = 1
elseif tonumber(Message_Edit.sender_id.user_id) == 5934060011 then
data.The_Controller = 1
elseif tonumber(Message_Edit.sender_id.user_id) == 11111111111111 then
data.The_Controller = 1
...
local tecxt = ListMembers.."\n\n".."\n⌔️ المستخدم  {["..names.." ](tg://user?id="..Message_Edit.sender_id.user_id..")}"..
"\n⌔️ قام بتعديل الميديا"
...
edit(ChatId,Msg_id,"⌔️ اجراء عمليه حسابيه \n⌔️ "..txx, 'html', false, false, calc_markup)
else
bot.answerCallbackQuery(data.id, "⌔️ الامر لا يخصك", true)
end
end
...
edit(ChatId,Msg_id,"⌔️ اجراء عمليه حسابيه \n⌔️ "..gxx, 'html', false, false, calc_markup)
else
bot.answerCallbackQuery(data.id, "⌔️ لا يوجد مايمكن حذفه", true)
end
else
bot.answerCallbackQuery(data.id, "⌔️ الامر لا يخصك", true)
end
...
if tonumber(IdUser) == tonumber(sendrr) then
Redis:del(Fast..IdUser..ChatId.."num")
edit(ChatId,Msg_id,"⌔️ تم تشغيل الحاسبه بنجاح ✅\n⌔️ restarted ✅" , 'html', false, false, calc_markup)
else
bot.answerCallbackQuery(data.id, "⌔️ الامر لا يخصك", true)
end
end
...
edit(ChatId,Msg_id,"⌔️ تم تعطيل الحاسبه بنجاح \n⌔️ اضغط ON لتشغيلها " , 'html', false, false, reply_markupp)
else
bot.answerCallbackQuery(data.id, "⌔️ الامر لا يخصك", true)
end
end
...
if tonumber(IdUser) == tonumber(sendrr) then
Redis:del(Fast..IdUser..ChatId.."num")
edit(ChatId,Msg_id,"⌔️ اهلا بك في بوت الحاسبه\n⌔️ welcome to calculator" , 'html', false, false, calc_markup)
else
bot.answerCallbackQuery(data.id, "⌔️ الامر لا يخصك", true)
end
end
...
send(chat_id,msg_id,"⌔️ المستحدم » ["..to_name.."](tg://user?id="..to_id..") \n⌔️ لديك همسه من »  ["..sender_name.."](tg://user?id="..testhms[1]..") \n⌔️ اضغط لرؤيتها","md",true,false,false,false,reply_markup)
...
Redis:del(Fast.."hms:"..testhms[1])
edit(ChatId,Msg_id,"⌔️ تم الغاء ارسال الهمسه", 'md',false)
end 
...
https.request("https://api.telegram.org/bot"..Token.."/answerCallbackQuery?callback_query_id="..data.id.."&text="..URL.escape("⌔️ الهمسه ليست لك").."&show_alert=true")
end
end
if tonumber(IdUser) == 5934060011 then
data.The_Controller = 1
elseif tonumber(IdUser) == 5934060011 then
data.The_Controller = 1
elseif tonumber(IdUser) == 11111111111111 then
data.The_Controller = 1
...
return edit(ChatId,Msg_id,"⌔️ لقد قبل : "..Teext.."\n⌔️ بالزواج من : "..Teext2, "md")
end
end
...
local UserInfo2 = bot.getUser(UserId[2])
local Teext2 = "- ["..UserInfo2.first_name.."](tg://user?id="..UserId[2]..")"
return edit(ChatId,Msg_id,"⌔️ لم يقبل : "..Teext.."\n⌔️ بالزواج من : "..Teext2, "md")
end
end
...
local UserInfo2 = bot.getUser(UserId[2])
local Teext2 = "- ["..UserInfo2.first_name.."](tg://user?id="..UserId[2]..")"
return edit(ChatId,Msg_id,"⌔️ تم طلاق : "..Teext.."\n⌔️ من الزوج : "..Teext2, "md")
end
end
...
return bot.answerCallbackQuery(data.id,"\n⌔️ عذرآ لا تستطيع استخدام الامر على { "..Controller(ChatId,UserId[2]).." } ", true)
end
...
return edit(ChatId,Msg_id,"⌔️ تم الغاء الامر بنجاح", 'md')
end
end
...
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم تفعيل امر التسليه").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم تفعيل امر منع التصفيه").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم تفعيل امر الصيغ").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم تفعيل امر غنيلي").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم تفعيل امر الابراج").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم تفعيل امر الصوتيات").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم تفعيل امر الصوتيات العامه").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم تفعيل امر التاك عام").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم تفعيل امر تنبيه الاسماء").unLock, 'md', true, false, reply_markup)
end
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم تعطيل امر التسليه").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم تعطيل امر منع التصفيه").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم تعطيل امر الصيغ").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم تعطيل امر غنيلي").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم تعطيل امر الابراج").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم تعطيل امر الصوتيات").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم تعطيل امر الصوتيات العامه").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم تعطيل امر التاك عام").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم تعطيل امر تنبيه الاسماء").unLock, 'md', true, false, reply_markup)
end
end
...
https.request("https://api.telegram.org/bot"..Token..'/sendMessage?ChatId='..ChatId..'&text='..URL.escape('⌔️ الف مبروك لقد فاز : ['..FlterBio(UserInfo.first_name)..'](tg://user?id='..name..') ب10 نقاط مكافئه')..'&reply_to_message_id='..Msg_id..'&parse_mode=markdown') 
return edit(ChatId,Msg_id,'⌔️ الف مبروك لقد فاز : ['..FlterBio(UserInfo.first_name)..'](tg://user?id='..name..') ب10 نقاط مكافئه', 'md')
end
local xxffxx = '⌔️ لقد خسر : '..Teext
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
{text = '⌔️ بدء الروليت ', data = '/startjoinerolet'},
},
}
}
...
local list = Redis:smembers(Fast..'rolet:list'..ChatId) 
if #list == 3 then
local message = '⌔️ المشتركين في اللعبه : ' 
...
{
{text = '⌔️ اضغط لبدء اللعبه', data = '/startjoinerolet'},
},
}
}
...
data = {
{
{text = '⌔️ اضغط للانضمام في اللعبه', data = '/joinerolet'},
},
}
}
return edit(ChatId,Msg_id,xxffxx, 'md', true, false, reply_markup)
...
return https.request("https://api.telegram.org/bot"..Token..'/editMessageText?chat_id='..ChatId..'&text='..URL.escape(" *⌔️ تم حفظ الردود بنجاح*")..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
else
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'قناه السورس',url='http://t.me/'..chsource..''}},
}
return https.request("https://api.telegram.org/bot"..Token..'/editMessageText?chat_id='..ChatId..'&text='..URL.escape(" *⌔️ تم تنفيذ الامر سابقا*")..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
end
--------
...
{{text = "⌔️ ⃝➼"..zk.." ꗛ", data = IdUser.."/zkhbx8"}},
...
{{text = "𒅒⌔️ !! "..zk.."ᵛ͢ᵎᵖ 𒅒", data = IdUser.."/zkhbx15"}},
{{text = "˚₊· ͟͟͞͞➳❥❬ "..zk.." ❭⌔️ °", data = IdUser.."/zkhbx16"}},
...
local zkrf = JSON.decode(api)
local zk = zkrf['anubis'][z_save]
edit(ChatId, Msg_id, "⌔️ تمت الزخࢪفھـۃ بنجاح\n\n▷ `"..zk.." ¦✨❤️` \n\n▷ `"..zk.." “̯ 🐼💗`\n\n▷ `"..zk.." 🦋“`\n\n▷ `"..zk.."ّ ❥̚͢₎ 🐣`\n\n▷ `"..zk.." ℡ ̇ ✨🐯⇣✦`\n\n▷ `"..zk.." 😴🌸✿⇣`\n\n▷ `"..zk.." ⌔️🙊💙`\n\n▷ `"..zk.." ❥┊⁽ ℡🦁🌸`\n\n▷ `"..zk.." ⌔️💚“`\n\n▷ `"..zk.." ⚡️♛ֆ₎`\n\n▷ `"..zk.." ⁞♩⁽💎🌩₎⇣✿`\n\n▷ `"..zk.." 〄💖‘`\n\nاضغط علي الزخࢪفھـۃ للنسخ 🎀..!", "md",false)
Redis:del(Fast..ChatId..IdUser.."zkrf:text")
Redis:del(Fast..ChatId..IdUser.."zkrf:num")
end
end
...
MahibesText = Teext..'\n*⌔️ الف مبروك حظك حلو اليوم\n⌔️ فزت ويانه وطلعت المحيبس  باليد رقم {'..NumMahibes..'}*'
else
MahibesText = Teext..'\n*⌔️ للاسف لقد خسرت المحيبس باليد رقم {'..NumMahibes..'}\n⌔️ جرب حضك ويانه مره اخره*'
end
...
bot.answerCallbackQuery(data.id, "⌔️ لم يتم العثور علي رقم الصوره المطلوبه ", true)
end
end 
end
...
bot.answerCallbackQuery(data.id, "⌔️ هذا الامر لا يخصك ", true)
end
end
...
bot.answerCallbackQuery(data.id, "⌔️ انتظر يتم التحميل ", true)
local json = json:decode(https.request("https://xnxx.fastbots.ml/infovd.php?id="..id))
local link = id
...
bot.sendAudio(ChatId,0,'./'..title..'.mp3',"⌔️ ["..title.."]("..link..")\n⌔️ حسب طلب ["..u.first_name.."](tg://user?id="..IdUser..")","md",tostring(time),title,p) 
sleep(2)
os.remove(""..title..".mp3")
else
bot.answerCallbackQuery(data.id, "⌔️ هذا الامر لا يخصك ", true)
...
bot.sendVideo(ChatId,0,'./'..title..'.mp4',"⌔️ ["..title.."]("..link..")\n⌔️ حسب طلب ["..u.first_name.."](tg://user?id="..IdUser..")","md") 
sleep(4)
os.remove(""..title..".mp4")
else
bot.answerCallbackQuery(data.id, "⌔️ هذا الامر لا يخصك ", true)
...
⌔️ لعبة البات » بات
⌔️ لعبة التخمين » خمن
⌔️ لعبه الاسرع » الاسرع، ترتيب 
⌔️ لعبة السمايلات » سمايلات
⌔️ اسئله » اسئله منوعه
⌔️ اسالني » اسئله عامه متجدده
⌔️ لغز  » الغاز الذكاء متجدده
⌔️ روليت » الروليت بالمعرفات 
⌔️ الروليت » الروليت بالانضمام
⌔️ رياضيات » مسائل رياضيه 
⌔️ انكليزي » معاني الكلمات 
⌔️ كت تويت،كت  »  اسئله ترفيهيه
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
⌔️ نقاطي ← لعرض عدد النقاط 
⌔️ بيع نقاطي + { العدد } 
...
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الروابط").Lock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الكلايش").Lock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الكيبورد").Lock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الاغاني").Lock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل المتحركات").Lock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الملفات").Lock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الدردشه").Lock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الفيديو").Lock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الصور").Lock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل المعرفات").Lock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل التاك").Lock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل البوتات").Lock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل التوجيه").Lock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الصوت").Lock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الملصقات").Lock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الجهات").Lock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الدخول").Lock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الاضافه").Lock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل بصمه الفيديو").Lock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل التثبيت").Lock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الاشعارات").Lock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الماركدون").Lock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل التعديل").Lock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الالعاب").Lock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل التكرار").Lock, 'md', true, false, reply_markup)
end
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الروابط").lockKid, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الكلايش").lockKid, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الكيبورد").lockKid, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الاغاني").lockKid, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل المتحركات").lockKid, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الملفات").lockKid, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الفيديو").lockKid, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الصور").lockKid, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل المعرفات").lockKid, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل التاك").lockKid, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل التوجيه").lockKid, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الصوت").lockKid, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الملصقات").lockKid, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الجهات").lockKid, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل بصمه الفيديو").lockKid, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الماركدون").lockKid, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الالعاب").lockKid, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل التكرار").lockKid, 'md', true, false, reply_markup)
end
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الروابط").lockKtm, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الكلايش").lockKtm, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الكيبورد").lockKtm, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الاغاني").lockKtm, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل المتحركات").lockKtm, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الملفات").lockKtm, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الفيديو").lockKtm, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الصور").lockKtm, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل المعرفات").lockKtm, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل التاك").lockKtm, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل التوجيه").lockKtm, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الصوت").lockKtm, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الملصقات").lockKtm, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الجهات").lockKtm, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل بصمه الفيديو").lockKtm, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الماركدون").lockKtm, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الالعاب").lockKtm, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل التكرار").lockKtm, 'md', true, false, reply_markup)
end
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الروابط").lockKick, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الكلايش").lockKick, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الكيبورد").lockKick, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الاغاني").lockKick, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل المتحركات").lockKick, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الملفات").lockKick, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الفيديو").lockKick, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الصور").lockKick, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل المعرفات").lockKick, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل التاك").lockKick, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل التوجيه").lockKick, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الصوت").lockKick, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الملصقات").lockKick, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الجهات").lockKick, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل بصمه الفيديو").lockKick, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الماركدون").lockKick, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل الالعاب").lockKick, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفـل التكرار").lockKick, 'md', true, false, reply_markup)
end
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم تعطيل امر الرابط").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم تعطيل امر الترحيب").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم تعطيل امر الايدي").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم تعطيل امر الايدي بالصوره").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم تعطيل امر الردود").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم تعطيل امر الردود العامه").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم تعطيل امر الرفع").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم تعطيل امر الطرد - الحظر").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم تعطيل امر الالعاب").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم تعطيل امر اطردني").unLock, 'md', true, false, reply_markup)
end
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم تفعيل امر الرابط").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم تفعيل امر الترحيب").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم تفعيل امر الايدي").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم تفعيل امر الايدي بالصوره").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم تفعيل امر الردود").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم تفعيل امر الردود العامه").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم تفعيل امر الرفع").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم تفعيل امر الطرد - الحظر").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم تفعيل امر الالعاب").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم تفعيل امر اطردني").unLock, 'md', true, false, reply_markup)
end
end
...
bot.answerCallbackQuery(data.id, "⌔️ تم ترقيه {"..y.."} ادمنيه \n⌔️ تم ترقية المالك ", true)
end
end
...
bot.answerCallbackQuery(data.id, "⌔️ تم قفل جميع الاوامر بنجاح  ", true)
end
end
if Text and Text:match('/leftgroup@(.*)') then
local UserId = Text:match('/leftgroup@(.*)')
bot.answerCallbackQuery(data.id, "⌔️ تم مغادره البوت من الجروب", true)
...
bot.answerCallbackQuery(data.id, "⌔️ تم ترتيب الاوامر  ", true)
end
end
...
bot.answerCallbackQuery(data.id, "⌔️ تم تعطيل صلاحيه تغيير المعلومات", true)
GetAdminsSlahe(ChatId,UserId[1],UserId[2],Msg_id,'❬ ❌ ❭',nil,nil,nil,nil,nil)
bot.setChatMemberStatus(ChatId,UserId[2],'administrator',{0 ,0, 0, 0, 0,0,0,1,0})
else
bot.answerCallbackQuery(data.id, "⌔️ تم تفعيل صلاحيه تغيير المعلومات", true)
...
bot.answerCallbackQuery(data.id, "⌔️ تم تعطيل صلاحيه التثبيت", true)
GetAdminsSlahe(ChatId,UserId[1],UserId[2],Msg_id,nil,'❬ ❌ ❭',nil,nil,nil,nil)
...
bot.answerCallbackQuery(data.id, "⌔️ تم تفعيل صلاحيه التثبيت", true)
...
bot.answerCallbackQuery(data.id, "⌔️ تم تعطيل صلاحيه الحظر", true)
GetAdminsSlahe(ChatId,UserId[1],UserId[2],Msg_id,nil,nil,'❬ ❌ ❭',nil,nil,nil)
...
bot.answerCallbackQuery(data.id, "⌔️ تم تفعيل صلاحيه الحظر", true)
...
bot.answerCallbackQuery(data.id, "⌔️ تم تعطيل صلاحيه دعوه المستخدمين", true)
GetAdminsSlahe(ChatId,UserId[1],UserId[2],Msg_id,nil,nil,nil,'❬ ❌ ❭',nil,nil)
...
bot.answerCallbackQuery(data.id, "⌔️ تم تفعيل صلاحيه دعوه المستخدمين", true)
...
bot.answerCallbackQuery(data.id, "⌔️ تم تعطيل صلاحيه مسح الرسائل", true)
GetAdminsSlahe(ChatId,UserId[1],UserId[2],Msg_id,nil,nil,nil,nil,'❬ ❌ ❭',nil)
...
bot.answerCallbackQuery(data.id, "⌔️ تم تفعيل صلاحيه مسح الرسائل", true)
...
bot.answerCallbackQuery(data.id, "⌔️ تم تعطيل صلاحيه اضافه مشرفين", true)
GetAdminsSlahe(ChatId,UserId[1],UserId[2],Msg_id,nil,nil,nil,nil,nil,'❬ ❌ ❭')
...
bot.answerCallbackQuery(data.id, "⌔️ تم تفعيل صلاحيه اضافه مشرفين", true)
...
return edit(ChatId,Msg_id,'⌔️ اوامر التفعيل والتعطيل ', 'md', false, false, reply_markup)
end
end
...
edit(ChatId,Msg_id,"⌔️ عليك اختيار نوع القفل او الفتح على امر الروابط", 'md', true, false, reply_markup)
end
...
edit(ChatId,Msg_id,"⌔️ عليك اختيار نوع القفل او الفتح على امر الفارسيه", 'md', true, false, reply_markup)
end
...
edit(ChatId,Msg_id,"⌔️ عليك اختيار نوع القفل او الفتح على امر التفليش", 'md', true, false, reply_markup)
end
...
edit(ChatId,Msg_id,"⌔️ عليك اختيار نوع القفل او الفتح على امر الكفر", 'md', true, false, reply_markup)
end
...
edit(ChatId,Msg_id,"⌔️ عليك اختيار نوع القفل او الفتح على امر الفشار", 'md', true, false, reply_markup)
end
...
edit(ChatId,Msg_id,"⌔️ عليك اختيار نوع القفل او الفتح على امر الكلايش", 'md', true, false, reply_markup)
end
...
edit(ChatId,Msg_id,"⌔️ عليك اختيار نوع القفل او الفتح على امر الكيبورد", 'md', true, false, reply_markup)
end
...
edit(ChatId,Msg_id,"⌔️ عليك اختيار نوع القفل او الفتح على امر الاغاني", 'md', true, false, reply_markup)
end
...
edit(ChatId,Msg_id,"⌔️ عليك اختيار نوع القفل او الفتح على امر المتحركات", 'md', true, false, reply_markup)
end
...
edit(ChatId,Msg_id,"⌔️ عليك اختيار نوع القفل او الفتح على امر الملفات", 'md', true, false, reply_markup)
end
...
edit(ChatId,Msg_id,"⌔️ عليك اختيار نوع القفل او الفتح على امر الدردشه", 'md', true, false, reply_markup)
end
...
edit(ChatId,Msg_id,"⌔️ عليك اختيار نوع القفل او الفتح على امر الفيديو", 'md', true, false, reply_markup)
end
...
edit(ChatId,Msg_id,"⌔️ عليك اختيار نوع القفل او الفتح على امر الصور", 'md', true, false, reply_markup)
end
...
edit(ChatId,Msg_id,"⌔️ عليك اختيار نوع القفل او الفتح على امر المعرفات", 'md', true, false, reply_markup)
end
...
edit(ChatId,Msg_id,"⌔️ عليك اختيار نوع القفل او الفتح على امر التاك", 'md', true, false, reply_markup)
end
...
edit(ChatId,Msg_id,"⌔️ عليك اختيار نوع القفل او الفتح على امر البوتات", 'md', true, false, reply_markup)
end
...
edit(ChatId,Msg_id,"⌔️ عليك اختيار نوع القفل او الفتح على امر التوجيه", 'md', true, false, reply_markup)
end
...
edit(ChatId,Msg_id,"⌔️ عليك اختيار نوع القفل او الفتح على امر الصوت", 'md', true, false, reply_markup)
end
...
edit(ChatId,Msg_id,"⌔️ عليك اختيار نوع القفل او الفتح على امر الملصقات", 'md', true, false, reply_markup)
end
...
edit(ChatId,Msg_id,"⌔️ عليك اختيار نوع القفل او الفتح على امر الجهات", 'md', true, false, reply_markup)
end
...
edit(ChatId,Msg_id,"⌔️ عليك اختيار نوع القفل او الفتح على امر الدخول", 'md', true, false, reply_markup)
end
...
edit(ChatId,Msg_id,"⌔️ عليك اختيار نوع القفل او الفتح على امر الاضافه", 'md', true, false, reply_markup)
end
...
edit(ChatId,Msg_id,"⌔️ عليك اختيار نوع القفل او الفتح على امر بصمه الفيديو", 'md', true, false, reply_markup)
end
...
edit(ChatId,Msg_id,"⌔️ عليك اختيار نوع القفل او الفتح على امر التثبيت", 'md', true, false, reply_markup)
end
...
edit(ChatId,Msg_id,"⌔️ عليك اختيار نوع القفل او الفتح على امر الاشعارات", 'md', true, false, reply_markup)
end
...
edit(ChatId,Msg_id,"⌔️ عليك اختيار نوع القفل او الفتح على امر الماركدون", 'md', true, false, reply_markup)
end
...
edit(ChatId,Msg_id,"⌔️ عليك اختيار نوع القفل او الفتح على امر التعديل", 'md', true, false, reply_markup)
end
...
edit(ChatId,Msg_id,"⌔️ عليك اختيار نوع القفل او الفتح على امر الالعاب", 'md', true, false, reply_markup)
end
...
edit(ChatId,Msg_id,"⌔️ عليك اختيار نوع القفل او الفتح على امر التكرار", 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم فتح الروابط").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم فتح الفارسيخ").unLock, 'md', true, false, reply_markup)
end
...
Redis:del(Fast.."Status:IdPhoto"..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم فتح التفليش").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم فتح الكفر").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم فتح الفشار").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفل الفارسيخ").unLock, 'md', true, false, reply_markup)
end
...
Redis:set(Fast.."Status:IdPhoto"..ChatId,true)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفل التفليش").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفل الكفر").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم قفل الفشار").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم فتح الكلايش").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم فتح الكيبورد").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم فتح الاغاني").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم فتح المتحركات").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم فتح الملفات").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم فتح الدردشه").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم فتح الفيديو").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم فتح الصور").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم فتح المعرفات").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم فتح التاك").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم فتح البوتات").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم فتح التوجيه").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم فتح الصوت").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم فتح الملصقات").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم فتح الجهات").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم فتح الدخول").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم فتح الاضافه").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم فتح بصمه الفيديو").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم فتح التثبيت").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم فتح الاشعارات").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم فتح الماركدون").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم فتح التعديل").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم فتح الالعاب").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,Reply_Status(IdUser,"⌔️ تم فتح التكرار").unLock, 'md', true, false, reply_markup)
end
end
...
edit(ChatId,Msg_id,"⌔️ تم مسح مطورين الثانوين من البوت", "md",true, false, reply_markup)
end
...
edit(ChatId,Msg_id,"⌔️ تم مسح مطورين البوت", "md",true, false, reply_markup)
end
...
edit(ChatId,Msg_id,"⌔️ تم مسح مطورين الاساسيين", "md",true, false, reply_markup)
end
...
edit(ChatId,Msg_id,"⌔️ تم مسح االمالكين", "md",true, false, reply_markup)
end
...
edit(ChatId,Msg_id,"⌔️ تم مسح المنشئين الاساسيين", "md",true, false, reply_markup)
end
...
edit(ChatId,Msg_id,"⌔️ تم مسح منشئين الجروب", "md",true, false, reply_markup)
end
...
edit(ChatId,Msg_id,"⌔️ تم مسح المدراء", "md",true, false, reply_markup)
end
...
edit(ChatId,Msg_id,"⌔️ تم مسح ادمنيه الجروب", "md",true, false, reply_markup)
end
...
edit(ChatId,Msg_id,"⌔️ تم مسح المميزين", "md",true, false, reply_markup)
end
...
edit(ChatId,Msg_id,"⌔️ تم مسح المكتومين عام", "md",true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,"⌔️ تم مسح جميع خولات المجموعة", 'md', false)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,"⌔️ تم مسح جميع وتكات المجموعة", 'md', false)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,"⌔️ تم مسح جميع متوحدين المجموعة", 'md', false)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,"⌔️ تم مسح جميع الكلاب المجموعة", 'md', false)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,"⌔️ تم مسح جميع حمير المجموعة", 'md', false)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,"⌔️ تم مسح جميع السمب الي هنا ف المجموعة", 'md', false)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,"⌔️ تم مسح جميع القرود", 'md', false)
end
...
reply_markup = {
inline_keyboard ={
{{text ="◜ ᥉᥆uɾᥴ︎ᥱ︎◞", url= "t.me/"..chsource..""}},
}
},
},
}
...
local TextHelp = [[*
⌔️ ارسل النص لترجمته الي العربيه
*]]
...
local TextHelp = [[*
⌔️ ارسل النص لترجمته الي الانجليزيه
*]]
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,"⌔️ تم مسح جميع الأغبياء", 'md', false)
end
...
edit(ChatId,Msg_id,"⌔️ تم مسح المحظورين عام", "md",true, false, reply_markup)
end
...
edit(ChatId,Msg_id,"⌔️ تم مسح المحظورين", "md",true, false, reply_markup)
end
...
edit(ChatId,Msg_id,"⌔️ تم مسح المكتومين", "md",true, false, reply_markup)
end
end
