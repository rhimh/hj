...
return send(msg_chat_id,msg_id,"⌔️ تم الغاء منع عام ("..Filters..")","md",true)  
end
end
...
local TextWelcome = (GroupsWelcome or '*⌔️نورت يقمر ♥♡\n ْ'..(FlterBio(UserInfo.first_name) or '---')..'\n ْ'..(Get_Chat.title or '---')..' \n⌔️ يجب احترام الادمنية\n⌔️ الالتزام بالقوانين في الوصف\n⌔️ الاعضاء '..Info_Chats.member_count..'~ الادمنيه '..Info_Chats.administrator_count..' \n⌔️ وقت الانضمام :('..os.date("%H:%M:%S")..')\n⌔️ تاريخ الانضمام :('..os.date("%Y/%m/%d")..')*\n')
send(msg_chat_id,msg_id,TextWelcome,"md")  
else
local TextWelcome = ('*⌔️نورت يقمر♥♡\n ْ'..(FlterBio(UserInfo.first_name) or '---')..'\n ْ'..(Get_Chat.title or '---')..' \n⌔️ يجب احترام الادمنية\n⌔️ الالتزام بالقوانين في الوصف\n⌔️ الاعضاء '..Info_Chats.member_count..'~ الادمنيه '..Info_Chats.administrator_count..' \n⌔️ وقت الانضمام :('..os.date("%H:%M:%S")..')\n⌔️ تاريخ الانضمام :('..os.date("%Y/%m/%d")..')*\n')
send(msg_chat_id,msg_id,TextWelcome,"md")  
end
end
end
...
if type == "kick" then 
return bot.setChatMemberStatus(msg.chat_id,msg.sender_id.user_id,'banned',0), send(msg_chat_id,msg_id,Reply_Status(msg.sender_id.user_id,"⌔️ قام بالتكرار في الجروب وتم طرده").Reply,"md",true)
end
if type == "del" then 
return bot.deleteMessages(msg.chat_id,{[1]= msg.id})
end
if type == "keed" then
return bot.setChatMemberStatus(msg.chat_id,msg.sender_id.user_id,'restricted',{1,0,0,0,0,0,0,0,0}), send(msg_chat_id,msg_id,Reply_Status(msg.sender_id.user_id,"⌔️ قام بالتكرار في الجروب وتم تقييده").Reply,"md",true)  
end
if type == "mute" then
Redis:sadd(Fast.."SilentGroup:Group"..msg.chat_id,tonumber(msg.sender_id.user_id)) 
return send(msg_chat_id,msg_id,Reply_Status(msg.sender_id.user_id,"⌔️ قام بالتكرار في الجروب وتم كتمه").Reply,"md",true)  
end
end
...
local UserInfo = bot.getUser(msg.sender_id.user_id)
local Teext = '⌔️ المستخدم : ['..FlterBio(UserInfo.first_name)..'](tg://user?id='..msg.sender_id.user_id..')\n'
return send(msg_chat_id,msg_id,Teext..'⌔️ ممنوع ارسال الكلايش \n ✓',"md")
end
...
local UserInfo = bot.getUser(msg.sender_id.user_id)
local Teext = '⌔️ المستخدم : ['..FlterBio(UserInfo.first_name)..'](tg://user?id='..msg.sender_id.user_id..')\n'
return send(msg_chat_id,msg_id,Teext..'⌔️ ممنوع ارسال التوجيه \n ✓',"md")
end
...
local UserInfo = bot.getUser(msg.sender_id.user_id)
local Teext = '⌔️ المستخدم : ['..FlterBio(UserInfo.first_name)..'](tg://user?id='..msg.sender_id.user_id..')\n'
return send(msg_chat_id,msg_id,Teext..'⌔️ ممنوع ارسال الكيبورد \n ✓',"md")
end
...
local UserInfo = bot.getUser(msg.sender_id.user_id)
local Teext = '⌔️ المستخدم : ['..FlterBio(UserInfo.first_name)..'](tg://user?id='..msg.sender_id.user_id..')\n'
return send(msg_chat_id,msg_id,Teext..'⌔️ ممنوع ارسال المواقع \n ✓',"md")
end
end
...
local UserInfo = bot.getUser(msg.sender_id.user_id)
local Teext = '⌔️ المستخدم : ['..FlterBio(UserInfo.first_name)..'](tg://user?id='..msg.sender_id.user_id..')\n'
return send(msg_chat_id,msg_id,Teext..'⌔️ ممنوع ارسال الماركداون \n ✓',"md")
end
...
local UserInfo = bot.getUser(msg.sender_id.user_id)
local Teext = '⌔️ المستخدم : ['..FlterBio(UserInfo.first_name)..'](tg://user?id='..msg.sender_id.user_id..')\n'
return send(msg_chat_id,msg_id,Teext..'⌔️ ممنوع ارسال الالعاب \n ✓',"md")
end
...
local v = monsha[1]
local tecxt = ListMembers.."\n⌔️ نداء للمالك {[ > Click < ](tg://user?id="..v..")}"..
"\n⌔️ المشرف {["..names.." ](tg://user?id="..msg.sender_id.user_id..")}"..
"\n⌔️ قام بالتكرار في ازاله الاعضاء \n⌔️ لا يمكنني تنزيله من المشرفين"
...
local tecxt = ListMembers.."\n⌔️ نداء للمالك {[ > Click < ](tg://user?id="..v..")}"..
"\n⌔️ المشرف {["..names.." ](tg://user?id="..msg.sender_id.user_id..")}"..
"\n⌔️ هناك عمليه تخريب وطرد الاعضاء , ليست لدي صلاحيه اضافه مشرفين لتنزيله"
send(msg_chat_id,msg_id,tecxt,"md")
end
end
...
local tecxt = ListMembers.."\n⌔️ نداء للمالك {[ > Click < ](tg://user?id="..v..")}"..
"\n⌔️ المشرف {["..names.." ](tg://user?id="..msg.sender_id.user_id..")}"..
"\n⌔️ قام بتكرار طرد الاعضاء وطرد اكثر من 3 وتم تنزيله من المشرفين "
send(msg_chat_id,msg_id,tecxt,"md")
end
end
Redis:del(Fast.."delmembars"..msg.chat_id..msg.sender_id.user_id)
...
return send(msg_chat_id,msg_id, '⌔️ تم تغيير صـورهہ‏‏ آلترحيب للبوت\n✓')
end
...
'\n*⌔️ اهلا انآ بوت اسمي '..Bot_Name..''..
'\n⌔️ آختصـآصـي حمـآيهہ‌‏ آلمـجمـوعآت'..
'\n⌔️ مـن آلسـبآم وآلتوجيهہ‌‏ وآلتگرآر وآلخ...'..
'\n⌔️ مـعـرف الـمـطـور  : @'..UserSudo..
'*', "md")
end
end
local Info_User = bot.getUser(v) 
...
local UserInfo = bot.getUser(msg.sender_id.user_id)
local Teext = '⌔️ المستخدم : ['..FlterBio(UserInfo.first_name)..'](tg://user?id='..msg.sender_id.user_id..')\n'
return send(msg_chat_id,msg_id,Teext..'⌔️ ممنوع ارسال الجهات \n ✓',"md")
end
...
local UserInfo = bot.getUser(msg.sender_id.user_id)
local Teext = '⌔️ المستخدم : ['..FlterBio(UserInfo.first_name)..'](tg://user?id='..msg.sender_id.user_id..')\n'
return send(msg_chat_id,msg_id,Teext..'⌔️ ممنوع ارسال بصمات الفيديو \n ✓',"md")
end
...
local UserInfo = bot.getUser(msg.sender_id.user_id)
local Teext = '⌔️ المستخدم : ['..FlterBio(UserInfo.first_name)..'](tg://user?id='..msg.sender_id.user_id..')\n'
return send(msg_chat_id,msg_id,Teext..'⌔️ ممنوع ارسال الملفات \n ✓',"md")
end
...
local UserInfo = bot.getUser(msg.sender_id.user_id)
local Teext = '⌔️ المستخدم : ['..FlterBio(UserInfo.first_name)..'](tg://user?id='..msg.sender_id.user_id..')\n'
return send(msg_chat_id,msg_id,Teext..'⌔️ ممنوع ارسال الصوتيات \n ✓',"md")
end
...
local UserInfo = bot.getUser(msg.sender_id.user_id)
local Teext = '⌔️ المستخدم : ['..FlterBio(UserInfo.first_name)..'](tg://user?id='..msg.sender_id.user_id..')\n'
return send(msg_chat_id,msg_id,Teext..'⌔️ ممنوع ارسال الفيديو \n ✓',"md")
end
...
local UserInfo = bot.getUser(msg.sender_id.user_id)
local Teext = '⌔️ المستخدم : ['..FlterBio(UserInfo.first_name)..'](tg://user?id='..msg.sender_id.user_id..')\n'
return send(msg_chat_id,msg_id,Teext..'⌔️ ممنوع ارسال كلمات انكليزيه \n ✓',"md")
end
end
end
...
local UserInfo = bot.getUser(msg.sender_id.user_id)
local Teext = '⌔️ المستخدم : ['..FlterBio(UserInfo.first_name)..'](tg://user?id='..msg.sender_id.user_id..')\n'
return send(msg_chat_id,msg_id,Teext..'⌔️ ممنوع ارسال البصمات \n ✓',"md")
end
...
local UserInfo = bot.getUser(msg.sender_id.user_id)
local Teext = '⌔️ المستخدم : ['..FlterBio(UserInfo.first_name)..'](tg://user?id='..msg.sender_id.user_id..')\n'
return send(msg_chat_id,msg_id,Teext..'⌔️ ممنوع ارسال الملصقات \n ✓',"md")
end
...
local UserInfo = bot.getUser(msg.sender_id.user_id)
local Teext = '⌔️ المستخدم : ['..FlterBio(UserInfo.first_name)..'](tg://user?id='..msg.sender_id.user_id..')\n'
return send(msg_chat_id,msg_id,Teext..'⌔️ ممنوع ارسال الاونلاين \n ✓',"md")
end
...
local UserInfo = bot.getUser(msg.sender_id.user_id)
local Teext = '⌔️ المستخدم : ['..FlterBio(UserInfo.first_name)..'](tg://user?id='..msg.sender_id.user_id..')\n'
return send(msg_chat_id,msg_id,Teext..'⌔️ ممنوع ارسال المتحركات \n ✓',"md")
end
...
local UserInfo = bot.getUser(msg.sender_id.user_id)
local Teext = '⌔️ المستخدم : ['..FlterBio(UserInfo.first_name)..'](tg://user?id='..msg.sender_id.user_id..')\n'
return send(msg_chat_id,msg_id,Teext..'⌔️ ممنوع ارسال الفارسيه \n ✓',"md")
end
end
end
...
local UserInfo = bot.getUser(msg.sender_id.user_id)
local Teext = '⌔️ المستخدم : ['..FlterBio(UserInfo.first_name)..'](tg://user?id='..msg.sender_id.user_id..')\n'
return send(msg_chat_id,msg_id,Teext..'⌔️ ممنوع ارسال الفشار \n ✓',"md")
end
end
end
...
local UserInfo = bot.getUser(msg.sender_id.user_id)
local Teext = '⌔️ المستخدم : ['..FlterBio(UserInfo.first_name)..'](tg://user?id='..msg.sender_id.user_id..')\n'
return send(msg_chat_id,msg_id,Teext..'⌔️ ممنوع ارسال الكفر \n ✓',"md")
end
end
end
...
local UserInfo = bot.getUser(msg.sender_id.user_id)
local Teext = '⌔️ المستخدم : ['..FlterBio(UserInfo.first_name)..'](tg://user?id='..msg.sender_id.user_id..')\n'
return send(msg_chat_id,msg_id,Teext..'⌔️ ممنوع ارسال الصور \n ✓',"md")
end
...
return send(msg_chat_id,msg_id,"⌔️ لا استطيع تغيير صوره الجروب لاني لست ادمن او ليست لديه الصلاحيه ","md",true)    
end
Redis:del(Fast.."Chat:Photo"..msg_chat_id..":"..msg.sender_id.user_id)
return send(msg_chat_id,msg_id,"⌔️ تم تغيير صوره الجروب بنـجاح ","md",true)    
end
...
local UserInfo = bot.getUser(msg.sender_id.user_id)
local Teext = '⌔️ المستخدم : ['..FlterBio(UserInfo.first_name)..'](tg://user?id='..msg.sender_id.user_id..')\n'
return send(msg_chat_id,msg_id,Teext..'⌔️ عذرا التفليش مقفل تم المسح \n ✓',"md")
end
end
end
...
local UserInfo = bot.getUser(msg.sender_id.user_id)
local Teext = '⌔️ المستخدم : ['..FlterBio(UserInfo.first_name)..'](tg://user?id='..msg.sender_id.user_id..')\n'
return send(msg_chat_id,msg_id,Teext..'⌔️ ممنوع ارسال الروابط \n ✓',"md")
end
...
local UserInfo = bot.getUser(msg.sender_id.user_id)
local Teext = '⌔️ المستخدم : ['..FlterBio(UserInfo.first_name)..'](tg://user?id='..msg.sender_id.user_id..')\n'
return send(msg_chat_id,msg_id,Teext..'⌔️ ممنوع ارسال المعرفات \n ✓',"md")
end
...
local UserInfo = bot.getUser(msg.sender_id.user_id)
local Teext = '⌔️ المستخدم : ['..FlterBio(UserInfo.first_name)..'](tg://user?id='..msg.sender_id.user_id..')\n'
return send(msg_chat_id,msg_id,Teext..'⌔️ ممنوع ارسال الهاشتاك \n ✓',"md")
end
...
local UserInfo = bot.getUser(msg.sender_id.user_id)
local Teext = '⌔️ المستخدم : ['..FlterBio(UserInfo.first_name)..'](tg://user?id='..msg.sender_id.user_id..')\n'
return send(msg_chat_id,msg_id,Teext..'⌔️ ممنوع ارسال الشارحه \n ✓',"md")
end
...
Redis:del(Fast..'FilterText'..msg_chat_id..':'..msg.sender_id.user_id)
return send(msg_chat_id,msg_id,"⌔️ تم الغاء منع ("..Filters..")","md",true)  
end
end
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
...
bot.deleteMessages(msg.chat_id,{[1]= msg.id})
return send(msg_chat_id,msg_id,"*⌔️ لقد تم منع هذه ( "..statusfilter.." ) هنا*\n⌔️ "..ReplyFilters,"md",true)   
end
end
...
bot.sendText(msg_chat_id,msg_id,"⌔️ تم حفظ الكلمه","md",true)  
return false 
end
...
bot.sendText(msg_chat_id,msg_id,'\n⌔️ ارسل كلمه جديده ليتم استبدالها مكان *'..text..'*',"md",true)  
return false 
end
...
send(msg_chat_id,msg_id,"⌔️ تم ازالة هذا الامر ← { "..text.." }","md",true)
else
send(msg_chat_id,msg_id,"⌔️ لا يوجد امر بهذا الاسم","md",true)
end
...
return send(msg_chat_id,msg_id,"⌔️ ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
...
return send(msg_chat_id,msg_id,"⌔️ تم حفظ الامر باسم ← { "..text..' }',"md",true)
end
...
return send(msg_chat_id,msg_id,"⌔️ تم الغاء حفظ الرابط","md",true)         
end
...
Redis:del(Fast.."Set:Link"..msg_chat_id..""..msg.sender_id.user_id) 
return send(msg_chat_id,msg_id,"⌔️ تم حفظ الرابط بنجاح","md",true)         
end
end 
...
return send(msg_chat_id,msg_id,"⌔️ تم الغاء حفظ الترحيب","md",true)   
end 
Redis:del(Fast.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender_id.user_id)  
Redis:set(Fast.."Welcome:Group"..msg_chat_id,text) 
return send(msg_chat_id,msg_id,"⌔️ تم حفظ ترحيب الجروب","md",true)     
end
...
return send(msg_chat_id,msg_id,"⌔️ تم الغاء حفظ القوانين","md",true)   
end 
Redis:set(Fast.."Group:Rules" .. msg_chat_id,text) 
Redis:del(Fast.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender_id.user_id)
return send(msg_chat_id,msg_id,"⌔️ تم حفظ قوانين الجروب","md",true)  
end  
...
return send(msg_chat_id,msg_id,"⌔️ تم الغاء حفظ وصف الجروب","md",true)   
end 
bot.setChatDescription(msg_chat_id,text) 
Redis:del(Fast.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender_id.user_id)
return send(msg_chat_id,msg_id,"⌔️ تم حفظ وصف الجروب","md",true)  
end  
...
return send(msg_chat_id,msg_id,"⌔️ تم حفظ الرد  بنجاح \n⌔️ ارسل ( ["..test.."] ) لعرض الرد","md",true)  
end  
end
...
send(msg_chat_id,msg_id,"⌔️ تم مسح الرد من الردود المضافه","md",true)  
return false
end
end
...
send(msg_chat_id,msg_id,"⌔️ تم حفظ رد للمطور \n⌔️ ارسل ( ["..test.."] ) لعرض الرد","md",true)  
return false
end  
end
if text and text:match("^(.*)$") then
...
return send(msg_chat_id,msg_id,"⌔️ تم مسح الرد من الردود العامه","md",true)  
end
end
...
send(msg_chat_id,msg_id,"⌔️ تمت الاذاعه الى *- "..#list.." * جروب في البوت ","md",true)      
Redis:del(Fast.."Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender_id.user_id) 
return false
end
------------------------------------------------------------------------------------------------------------
...
send(msg_chat_id,msg_id,"⌔️ تمت الاذاعه الى *- "..#list.." * مشترك في البوت ","md",true)      
Redis:del(Fast.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender_id.user_id) 
return false
end
------------------------------------------------------------------------------------------------------------
...
local list = Redis:smembers(Fast.."ChekBotAdd")   
send(msg_chat_id,msg_id,"⌔️ تم التوجيه الى *- "..#list.." * جروب في البوت ","md",true)      
for k,v in pairs(list) do  
...
send(msg_chat_id,msg_id,'⌔️ تم تعيين الايدي الجديد عام',"md",true)  
end
...
return send(msg_chat_id,msg_id, "⌔️ تم تغير اسم البوت الى - "..text,"md",true)    
end 
...
return send(msg_chat_id,msg_id, "⌔️ تم تغيير كليشه start - "..text,"md",true)    
end 
...
return send(msg.chat_id, msg.id,'⌔️ ارسل اسم الموسيقى الان ...')
end   
end
...
Redis:del(Fast.."Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id)
return send(msg.chat_id, msg.id,'⌔️ تم حفظ الصوت ')
end
...
Redis:del(Fast.."Games:Set:Answer"..msg.chat_id)
return send(msg.chat_id,msg.id,'*⌔️ الف مبروك اجابتك صحيحه تم اضافه لك 5 نقاط*')
end
end
...
send(msg_chat_id,msg_id,'⌔️ لا يوجد صوتيه بهذا الاسم في العامه')
...
Redis:del(Fast.."All:Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id)
send(msg_chat_id,msg_id,'⌔️ تم مسح الصوتيه بنجاح')
return false
end
...
send(msg_chat_id,msg_id,'⌔️ الان ارسل الصوتيه ليتم حفظها باسم  : '..text)
return false
end
...
Redis:del(Fast.."All:Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id)
send(msg_chat_id,msg_id,'⌔️ تم حفظ الصوتيه باسم : '..nameaudio)
return false
end   
end
...
send(msg_chat_id,msg_id,'⌔️ لا يوجد صوتيه بهذا الاسم في الجروب')
Redis:del(Fast.."Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id)
return false
end
...
local tttttt = '⌔️: اليك النتائج الخـاصة :\n\n⌔️: نسبة الحب بيـن : *'..text..'* '..sendnum..'%'
...
local tttttt = '⌔️: اليك النتائج الخـاصة :\n\n⌔️:  نسبة الرجوله لـ : *'..text..'* '..sendnuj..'%'
send(msg_chat_id,msg_id,tttttt) 
...
numj = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","?? 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnuj = numj[math.random(#numj)]
local tttttt = '⌔️: اليك النتائج الخـاصة :\n\n⌔️:  نسبه الانوثة لـ : *'..text..'* '..sendnuj..'%'
send(msg_chat_id,msg_id,tttttt) 
