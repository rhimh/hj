...
return send(msg_chat_id,msg_id,'\n*⌔️هذا الامر يخص { '..Controller_Num(7)..' }* ',"md",true)  
end
...
return send(msg_chat_id,msg_id,"⌔️تم تعطيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(Fast.."Status:Welcome"..msg_chat_id) 
return send(msg_chat_id,msg_id,"⌔️تم تعطيل الترحيب ","md",true)
end
if TextMsg == 'الايدي' then
if not msg.Manger then
return send(msg_chat_id,msg_id,'\n*⌔️هذا الامر يخص { '..Controller_Num(6)..' }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Fast..'Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(Fast..'Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'*\n⌔️عليك الاشتراك في قناة البوت لأستخدام الاوامر*',"md",false, false, false, false, reply_markup)
...
return send(msg_chat_id,msg_id,"⌔️تم تعطيل الايدي ","md",true)
end
...
return send(msg_chat_id,msg_id,"⌔️تم تعطيل الايدي بالصوره ","md",true)
end
...
return send(msg_chat_id,msg_id,"⌔️تم تعطيل الردود ","md",true)
end
if TextMsg == 'الردود العامه' then
if not msg.Creator then
return send(msg_chat_id,msg_id,'\n*⌔️هذا الامر يخص { '..Controller_Num(5)..' }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Fast..'Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(Fast..'Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'*\n⌔️عليك الاشتراك في قناة البوت لأستخدام الاوامر*',"md",false, false, false, false, reply_markup)
...
return send(msg_chat_id,msg_id,"⌔️تم تعطيل الردود العامه ","md",true)
end
...
return send(msg_chat_id,msg_id,"⌔️تم تعطيل الحظر , الطرد , التقييد","md",true)
end
...
return send(msg_chat_id,msg_id,"⌔️تم تعطيل الرفع ","md",true)
end
if TextMsg == 'الالعاب' then
Redis:del(Fast.."Status:Games"..msg_chat_id) 
return send(msg_chat_id,msg_id,"⌔️تم تعطيل الالعاب ","md",true)
end
if TextMsg == 'اطردني' then
Redis:del(Fast.."Status:KickMe"..msg_chat_id) 
return send(msg_chat_id,msg_id,"⌔️تم تعطيل اطردني ","md",true)
end
if TextMsg == 'البوت الخدمي' then
if not msg.Asasy then 
return send(msg_chat_id,msg_id,'\n*⌔️هذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Fast..'Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(Fast..'Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'*\n⌔️عليك الاشتراك في قناة البوت لأستخدام الاوامر*',"md",false, false, false, false, reply_markup)
...
return send(msg_chat_id,msg_id,"⌔️تم تعطيل البوت الخدمي ","md",true)
end
...
return send(msg_chat_id,msg_id,"⌔️تم تعطيل التواصل داخل البوت ","md",true)
end
...
return send(msg_chat_id,msg_id,'\n*⌔️هذا الامر يخص { '..Controller_Num(2)..' }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Fast..'Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(Fast..'Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'*\n⌔️عليك الاشتراك في قناة البوت لأستخدام الاوامر*',"md",false, false, false, false, reply_markup)
...
return send(msg_chat_id,msg_id,"\n⌔️عذرآ لا يوجد حساب بهذا المعرف ","md",true)  
end
if UserId_Info.type.is_channel == true then
return send(msg_chat_id,msg_id,"\n⌔️عذرآ لا تستطيع استخدام معرف قناة او جروب ","md",true)  
end
if UserName and UserName:match('(%S+)[Bb][Oo][Tt]') then
return send(msg_chat_id,msg_id,"\n⌔️عذرآ لا تستطيع استخدام معرف البوت ","md",true)  
end
if Controllerbanall(msg_chat_id,UserId_Info.id) == true then 
return send(msg_chat_id,msg_id,"\n*⌔️عذرآ لا تستطيع استخدام الامر على { "..Controller(msg_chat_id,UserId_Info.id).." } *","md",true)  
end
if Redis:sismember(Fast.."BanAll:Groups",UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔️تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fast.."BanAll:Groups",UserId_Info.id) 
bot.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔️تم حظره عام من المجموعات ").Reply,"md",true)  
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔️تم الغاء حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
...
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔️تم الغاء حظره عام من المجموعات  ").Reply,"md",true)  
end
end
...
return send(msg_chat_id,msg_id,"\n*⌔️عذرآ البوت ليس ادمن في الجروب يرجى ترقيته وتفعيل الصلاحيات له *","md",true)  
end
if GetInfoBot(msg).BanUser == false then
return send(msg_chat_id,msg_id,'\n*⌔️البوت ليس لديه صلاحيه حظر المستخدمين* ',"md",true)  
end
if not msg.Creator and not Redis:get(Fast.."Status:BanId"..msg_chat_id) then
return send(msg_chat_id,msg_id,"⌔️تم تعطيل (الحظر : الطرد : التقييد) من قبل المنشئين","md",true)
end 
local UserId_Info = bot.searchPublicChat(UserName)
if not UserId_Info.id then
return send(msg_chat_id,msg_id,"\n⌔️عذرآ لا يوجد حساب بهذا المعرف ","md",true)  
...
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔️تم حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fast.."BanGroup:Group"..msg_chat_id,UserId_Info.id) 
bot.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔️تم حظره من الجروب ").Reply,"md",true)  
end
end
...
bot.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔️تم الغاء حظره من الجروب  ").Reply,"md",true)  
end
...
return send(msg_chat_id,msg_id,'\n*⌔️البوت ليس لديه صلاحيه مسح الرسائل* ',"md",true)  
end
local UserId_Info = bot.searchPublicChat(UserName)
if not UserId_Info.id then
return send(msg_chat_id,msg_id,"\n⌔️عذرآ لا يوجد حساب بهذا المعرف ","md",true)  
...
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔️تم كتمه في الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fast.."SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔️تم كتمه في الجروب  ").Reply,"md",true)  
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔️تم الغاء كتمه من الجروب ").Reply,"md",true)  
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔️تم تقييده في الجروب \n⌔️لمدة : "..UserName[1]..' '..UserName[2]).Reply,"md",true)  
end
...
return send(msg_chat_id,msg_id,"\n⌔️عذرآ تستطيع فقط استخدام الامر على المستخدمين ","md",true)  
end
if UserInfo and UserInfo.type and UserInfo.type.Fastbots == "userTypeBot" then
return send(msg_chat_id,msg_id,"\n⌔️عذرآ لا تستطيع استخدام الامر على البوت ","md",true)  
end
if StatusCanOrNotCan(msg_chat_id,rep_idd) then
return send(msg_chat_id,msg_id,"\n*⌔️عذرآ لا تستطيع استخدام الامر على { "..Controller(msg_chat_id,rep_idd).." } *","md",true)  
end
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"⌔️تم تقييده في الجروب \n⌔️لمدة : "..TimeKed[1]..' '..TimeKed[2]).Reply,"md",true)  
end
...
return send(msg_chat_id,msg_id,"\n⌔️عذرآ لا تستطيع استخدام ايدي خطأ ","md",true)  
end
if StatusCanOrNotCan(msg_chat_id,UserId[3]) then
return send(msg_chat_id,msg_id,"\n*⌔️عذرآ لا تستطيع استخدام الامر على { "..Controller(msg_chat_id,UserId[3]).." } *","md",true)  
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId[3],"\n⌔️تم تقييده في الجروب \n⌔️لمدة : "..UserId[1]..' ' ..UserId[2]).Reply,"md",true)  
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔️تم تقييده في الجروب ").Reply,"md",true)  
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔️تم الغاء تقييده من الجروب").Reply,"md",true)  
end
...
bot.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔️تم طرده من الجروب ").Reply,"md",true)  
end
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"⌔️تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fast.."BanAll:Groups",rep_idd) 
bot.setChatMemberStatus(msg.chat_id,rep_idd,'banned',0)
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"⌔️تم حظره عام من المجموعات ").Reply,"md",true)  
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"⌔️تم الغاء حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:srem(Fast.."BanAll:Groups",rep_idd) 
bot.setChatMemberStatus(msg.chat_id,rep_idd,'restricted',{1,1,1,1,1,1,1,1,1})
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"⌔️تم الغاء حظره عام من المجموعات  ").Reply,"md",true)  
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"⌔️تم حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fast.."BanGroup:Group"..msg_chat_id,rep_idd) 
bot.setChatMemberStatus(msg.chat_id,rep_idd,'banned',0)
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"⌔️تم حظره من الجروب ").Reply,"md",true)  
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"⌔️تم الغاء حظره من الجروب  ").Reply,"md",true)  
end
...
return send(msg_chat_id,msg_id,"⌔️تم كتم القناة من المجموعه  ","md",true)  
end
local UserInfo = bot.getUser(rep_idd)
if UserInfo.message == "Invalid user ID" then
return send(msg_chat_id,msg_id,"\n⌔️عذرآ تستطيع فقط استخدام الامر على المستخدمين ","md",true)  
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"⌔️تم كتمه في الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fast.."SilentGroup:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"⌔️تم كتمه في الجروب  ").Reply,"md",true)  
end
end
...
return send(msg_chat_id,msg_id,"⌔️تم الغاء كتم القناة من المجموعه  ","md",true)  
end
local UserInfo = bot.getUser(rep_idd)
if UserInfo.message == "Invalid user ID" then
return send(msg_chat_id,msg_id,"\n⌔️عذرآ تستطيع فقط استخدام الامر على المستخدمين ","md",true)  
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"⌔️تم الغاء كتمه من الجروب ").Reply,"md",true)  
end
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"⌔️تم تقييده في الجروب ").Reply,"md",true)  
end
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"⌔️تم الغاء تقييده من الجروب").Reply,"md",true)  
end
...
bot.setChatMemberStatus(msg.chat_id,rep_idd,'banned',0)
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"⌔️تم طرده من الجروب ").Reply,"md",true)  
end
...
return send(msg_chat_id,msg_id,"\n*⌔️عذرآ لا تستطيع استخدام الامر على { "..Controller(msg_chat_id,UserId).." } *","md",true)  
end
if Redis:sismember(Fast.."BanAll:Groups",UserId) then
return send(msg_chat_id,msg_id,Reply_Status(UserId,"⌔️تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fast.."BanAll:Groups",UserId) 
bot.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
return send(msg_chat_id,msg_id,Reply_Status(UserId,"⌔️تم حظره عام من المجموعات ").Reply,"md",true)  
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId,"⌔️تم الغاء حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:srem(Fast.."BanAll:Groups",UserId) 
return send(msg_chat_id,msg_id,Reply_Status(UserId,"⌔️تم الغاء حظره عام من المجموعات  ").Reply,"md",true)  
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId,"⌔️تم حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fast.."BanGroup:Group"..msg_chat_id,UserId) 
bot.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
return send(msg_chat_id,msg_id,Reply_Status(UserId,"⌔️تم حظره من الجروب ").Reply,"md",true)  
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId,"⌔️تم الغاء حظره من الجروب  ").Reply,"md",true)  
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId,"⌔️تم كتمه في الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fast.."SilentGroup:Group"..msg_chat_id,UserId) 
return send(msg_chat_id,msg_id,Reply_Status(UserId,"⌔️تم كتمه في الجروب  ").Reply,"md",true)  
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId,"⌔️تم الغاء كتمه من الجروب ").Reply,"md",true)  
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId,"⌔️تم تقييده في الجروب ").Reply,"md",true)  
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId,"⌔️تم الغاء تقييده من الجروب").Reply,"md",true)  
end
...
bot.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
return send(msg_chat_id,msg_id,Reply_Status(UserId,"⌔️تم طرده من الجروب ").Reply,"md",true)  
end

if text == "اطردني" or text == "طردني" then
if not Redis:get(Fast.."Status:KickMe"..msg_chat_id) then
return send(msg_chat_id,msg_id,"*⌔️امر اطردني تم تعطيله من قبل المدراء *","md",true)  
end
if msg.can_be_deleted_for_all_users ~= true then
return send(msg_chat_id,msg_id,"\n*⌔️عذرآ البوت ليس ادمن في الجروب يرجى ترقيته وتفعيل الصلاحيات له *","md",true)  
end
...
return send(msg_chat_id,msg_id,"\n*⌔️عذرآ لا تستطيع استخدام الامر على { "..Controller(msg_chat_id,senderr).." } *","md",true)  
end
...
if KickMe == true then
return send(msg_chat_id,msg_id,"*⌔️عذرا لا استطيع طرد ادمنيه ومنشئين الجروب*","md",true)    
end
bot.setChatMemberStatus(msg.chat_id,senderr,'restricted',{1,1,1,1,1,1,1,1,1})
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔️تم طردك من الجروب بنائآ على طلبك").Reply,"md",true)  
end
...
return send(msg_chat_id,msg_id,'⌔️تم الغاء حفظ قناة الاشتراك')
end
Redis:del(Fast..'Channel:Redis'..msg_chat_id..':'..senderr)
...
return send(msg_chat_id,msg_id,"\n⌔️البوت عضو في القناة يرجى رفع البوت ادمن واعادة وضع الاشتراك ","md",true)  
end
Redis:set(Fast..'Channel:Join',ChannelUser) 
Redis:set(Fast..'Channel:Join:Name',UserId_Info.title) 
return send(msg_chat_id,msg_id,"\n⌔️تم تعيين الاشتراك الاجباري على قناة : [@"..ChannelUser..']',"md",true)  
else
return send(msg_chat_id,msg_id,"\n⌔️هذا ليس معرف قناة يرجى ارسال معرف القناة الصحيح: [@"..ChannelUser..']',"md",true)  
end
end
end
...
return send(msg_chat_id,msg_id,"\n⌔️ارسل الي الان قناة الاشتراك ","md",true)  
end
...
return send(msg_chat_id,msg_id,"\n⌔️تم تعطيل الاشتراك الاجباري","md",true)  
end
...
if Channel then
return send(msg_chat_id,msg_id,"\n⌔️الاشتراك الاجباري مفعل على : [@"..Channel..']',"md",true)  
else
return send(msg_chat_id,msg_id,"\n⌔️لا توجد قناة في الاشتراك ارسل تغيير الاشتراك الاجباري","md",true)  
end
end
...
File:write(Get_Json)
File:close()
return bot.sendDocument(msg_chat_id,msg_id,'./'..UserBot..'.json', '*⌔️تم جلب النسخه الاحتياطيه\n⌔️تحتوي على {'..#Groups..'} جروب \n⌔️وتحتوي على {'..#UsersBot..'} مشترك *\n', 'md')
end
...
File:write(Get_Json)
File:close()
bot.sendDocument(Sudo_Id,0,'./'..UserBot..'.json', '*⌔️تم جلب النسخه الاحتياطيه\n⌔️تحتوي على {'..#Groups..'} جروب \n⌔️وتحتوي على {'..#UsersBot..'} مشترك *\n', 'md')
local Get_Json = '{"BotId": '..Fast..','  
Get_Json = Get_Json..'"GroupsBotreply":{'
...
return send(msg_chat_id,msg_id,'\n*⌔️تم استرجاع ردود المجموعات* ',"md",true)  
end
end
...
return send(msg_chat_id,msg_id,'\n*⌔️تم استرجاع ردود العامه* ',"md",true)  
end
end
...
return send(msg_chat_id,msg_id,"⌔️تم تفعيل جميع الاوامر\n✓" )
end
...
return send(msg_chat_id,msg_id,'⌔️تم تعطيل التحذير مسبقا\n ✓',"md")
else
Redis:del(Fast.."AlThther:Chat"..msg.chat_id)
return send(msg_chat_id,msg_id,'⌔️تم تعطيل التحذير\n ✓',"md")
end
end
...
return send(msg_chat_id,msg_id,'⌔️تم تفعيل التحذير مسبقا\n ✓',"md")
else
Redis:set(Fast.."AlThther:Chat"..msg.chat_id,"true")
return send(msg_chat_id,msg_id,'⌔️تم تفعيل التحذير\n ✓',"md")
end
end
...
return send(msg_chat_id,msg_id,'\n*⌔️هذا الامر يخص { '..Controller_Num(4)..' }* ',"md",true)  
end
if Redis:get(Fast..'spammkick'..msg.chat_id)  then
return send(msg_chat_id,msg_id,'⌔️تم تعطيل منع التصفيه مسبقا\n ✓',"md")
else
Redis:set(Fast.."spammkick"..msg.chat_id,"true")
return send(msg_chat_id,msg_id,'⌔️تم تعطيل منع التصفيه\n ✓',"md")
end
end
...
return send(msg_chat_id,msg_id,'⌔️تم تفعيل منع التصفيه مسبقا\n ✓',"md")
else
Redis:del(Fast.."spammkick"..msg.chat_id)
return send(msg_chat_id,msg_id,'⌔️تم تفعيل منع التصفيه\n ✓',"md")
end
end
...
send(msg_chat_id,msg_id, '⌔️تم تفعيل امر التاك مسبقا\n ✓',"md")
else
Redis:set(Fast..'tagallgroup'..msg.chat_id,'open') 
send(msg_chat_id,msg_id, '⌔️تم تفعيل امر التاك\n ✓',"md")
end
end
...
send(msg_chat_id,msg_id, '⌔️تم تعطيل امر التاك مسبقا\n ✓',"md")
else
Redis:set(Fast..'tagallgroup'..msg.chat_id,'close') 
send(msg_chat_id,msg_id, '⌔️تم تعطيل امر التاك\n ✓',"md")
end
end
...
send(msg_chat_id,msg_id, '⌔️تم تعطيل امر اسمي مسبقا\n ✓',"md")
else
Redis:set(Fast.."idnotmemname"..msg.chat_id,"true")
send(msg_chat_id,msg_id, '⌔️تم تعطيل امر اسمي \n ✓',"md")
end
end
...
send(msg_chat_id,msg_id, '⌔️تم تفعيل الاوامر الصوتيه مسبقا\n ✓',"md")
else
Redis:set(Fast..msg_chat_id.."sound:cmd",true)
send(msg_chat_id,msg_id, '⌔️تم تفعيل الاوامر الصوتيه \n ✓',"md")
end
end
...
send(msg_chat_id,msg_id, '⌔️تم تعطيل الاوامر الصوتيه مسبقا\n ✓',"md")
else
Redis:del(Fast..msg_chat_id.."sound:cmd")
send(msg_chat_id,msg_id, '⌔️تم تعطيل الاوامر الصوتيه \n ✓',"md")
end
end
...
send(msg_chat_id,msg_id, '⌔️تم تعطيل امر ايدي العضو مسبقا\n ✓',"md")
else
Redis:set(Fast.."idnotmem"..msg.chat_id,"true")
send(msg_chat_id,msg_id, '⌔️تم تعطيل امر ايدي العضو\n ✓',"md")
end
end
...
send(msg_chat_id,msg_id, '⌔️تم تفعيل امر ايدي العضو مسبقا\n ✓',"md")
else
Redis:del(Fast.."idnotmem"..msg.chat_id)
send(msg_chat_id,msg_id, '⌔️تم تفعيل امر ايدي العضو\n ✓',"md")
end
end
...
Redis:del(Fast.."Status:Del:Media"..msg.chat_id)
 send(msg_chat_id,msg_id,'⌔️تم تعطيل المسح التلقائي للميديا')
return false
end 
...
send(msg_chat_id,msg_id,'⌔️تم تفعيل المسح التلقائي للميديا')
return false
end 
...
return send(msg_chat_id,msg_id,"\n*⌔️عذرآ لا يمكنني تنزيل { "..Controller(msg_chat_id,senderr).." } *","md",true)  
end
...
return send(msg_chat_id,msg_id,' ⌔️عليك الاجابه اذا كمت تريد استمرار الامر',"md",false, false, false, false, reply_markup)
end
...
return send(msg_chat_id,msg_id,'⌔️تم تعطيل صورتي مسبقا\n ✓',"md")
else
Redis:set(Fast.."myphoto"..msg.chat_id,"true")
return send(msg_chat_id,msg_id,'⌔️تم تعطيل صورتي\n ✓',"md")
end
end
...
return send(msg_chat_id,msg_id,'⌔️تم تفعيل صورتي مسبقا\n ✓',"md")
else
Redis:del(Fast.."myphoto"..msg.chat_id)
return send(msg_chat_id,msg_id,'⌔️تم تفعيل صورتي\n ✓',"md")
end
end
