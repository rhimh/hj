...
"تم زواجكم... ودا رقمي عشان لو العريس معرفش يسد 010249156..",
...
return send(msg.chat_id,msg.id,'⌔️ لايوجد زوجات',"md",true) 
end 
local zwga_list = "⌔️ عدد الزوجات : "..#zwgat_list.."\n⌔️ الزوجات :\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
...
return send(msg.chat_id,msg.id,'⌔️ لايوجد مطلقات',"md",true) 
end 
local mutlqa_list = "⌔️ عدد المطلقات : "..#mutlqat_list.."\n⌔️ المطلقات :\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
