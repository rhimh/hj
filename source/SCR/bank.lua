...
return send(msg.chat_id,msg.id, "⌔️  لديك حساب بنكي مسبقاً\n\n⌔️  لعرض معلومات حسابك اكتب\n⇠ `حسابي`","md",true)
end
...
send(msg.chat_id,msg.id, "\n⌔️ وسوينا لك حساب في بنك تايجر 🏦\n⌔️ وشحنالك 50 ريال 💵 هدية\n\n⌔️  رقم حسابك ↢ ( `"..creditcc.."` )\n⌔️  نوع البطاقة ↢ ( ماستر 💳 )\n⌔️  فلوسك ↢ ( 50 ريال 💵 )  ","md",true)  
end 
if text == "فيزا" then
local ban = bot.getUser(msg.sender_id.user_id)
if ban.first_name then
...
Redis:sadd(Fast.."booob",msg.sender_id.user_id)
Redis:del(Fast.."booobb" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
send(msg.chat_id,msg.id, "\n⌔️ وسوينا لك حساب في بنك تايجر 🏦\n⌔️ وشحنالك 50 ريال 💵 هدية\n\n⌔️  رقم حسابك ↢ ( `"..creditex.."` )\n⌔️  نوع البطاقة ↢ ( اكسبرس 💳 )\n⌔️  فلوسك ↢ ( 50 ريال 💵 )  ","md",true)   
end 
end
...
send(msg.chat_id,msg.id, "⌔️  مسحت حسابك البنكي 🏦","md",true)
else
send(msg.chat_id,msg.id, "⌔️  ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
send(msg.chat_id,msg.id, "⌔️  مسحت لعبه البنك 🏦","md",true)
end
end
...
return send(msg.chat_id,msg.id, "⌔️  ماعندك فلوس ارسل الالعاب وابدأ بجمع الفلوس \n✦","md",true)
end
send(msg.chat_id,msg.id, "⌔️  فلوسك "..ballancee.." ريال 💵","md",true)
else
send(msg.chat_id,msg.id, "⌔️  ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
send(msg.chat_id,msg.id,"\n*⌔️ بنك تايجر ماعنده حساب بالبنك 🤣*","md",true)  
return false
end
if Redis:sismember(Fast.."booob",rep_idd) then
ballanceed = Redis:get(Fast.."boob"..rep_idd) or 0
send(msg.chat_id,msg.id, "⌔️  فلوسه "..ballanceed.." ريال 💵","md",true)
else
send(msg.chat_id,msg.id, "⌔️  ماعنده حساب بنكي ","md",true)
end
end
...
ballancee = Redis:get(Fast.."boob"..msg.sender_id.user_id) or 0
send(msg.chat_id,msg.id, "⌔️  الاسم ↢ "..news.."\n⌔️  الحساب ↢ `"..cccc.."`\n⌔️  بنك ↢ (بنك تايجر )\n⌔️  نوع ↢ ( "..uuuu.." )\n⌔️  الرصيد ↢ ( "..ballancee.." ريال 💵 )\n⌔️  الزرف ( "..pppp.." ريال 💵 )\n✦","md",true)
else
send(msg.chat_id,msg.id, "⌔️  ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
send(msg.chat_id,msg.id, "⌔️  الاسم ↢ "..news.."\n⌔️  الحساب ↢ `"..ccccc.."`\n⌔️  بنك ↢ (بنك تايجر )\n⌔️  نوع ↢ ( "..uuuuu.." )\n⌔️  الرصيد ↢ ( "..ballanceed.." ريال 💵 )\n⌔️  الزرف ↢ ( "..ppppp.." ريال 💵 )\n⌔️  مسكين مسحت حسابه \n✦","md",true)
else
send(msg.chat_id,msg.id, "⌔️  ماعنده حساب بنكي اصلاً ","md",true)
end
end
end
...
send(msg.chat_id,msg.id, "⌔️  الاسم ↢ "..yty.."\n⌔️  الحساب ↢ `"..coniss.."`\n⌔️  بنك ↢ (بنك تايجر )\n⌔️  نوع ↢ ( "..fsvhh.." )\n⌔️  الرصيد ↢ ( "..dfhb.." ريال 💵 )\n✦","md",true)
else
send(msg.chat_id,msg.id, "⌔️  مافيه حساب بنكي كذا","md",true)
end
end
...
return send(msg.chat_id,msg.id,"⌔️  مايمديك تضارب الحين\n⌔️  تعال بعد ( "..time_ex.." )","md",true)
end
ballancee = Redis:get(Fast.."boob"..msg.sender_id.user_id) or 0
if tonumber(coniss) < 99 then
return send(msg.chat_id,msg.id, "⌔️  الحد الادنى المسموح هو 100 ريال 💵\n✦","md",true)
end
if tonumber(ballancee) < tonumber(coniss) then
return send(msg.chat_id,msg.id, "⌔️  فلوسك ماتكفي \n✦","md",true)
end
...
send(msg.chat_id,msg.id, "⌔️  مضاربة فاشلة 📉\n⌔️  نسبة الخسارة ↢ "..modarbaa.."%\n⌔️  المبلغ الذي خسرته ↢ ( "..ballanceekku.." ريال 💵 )\n⌔️  فلوسك صارت ↢ ( "..ballanceekkku.." ريال 💵 )\n✦","md",true)
elseif Descriptioontt == "2" or Descriptioontt == "4" then
ballanceekku = coniss / 100 * modarbaa
ballanceekkku = ballancee + ballanceekku
Redis:set(Fast.."boob"..msg.sender_id.user_id , math.floor(ballanceekkku))
Redis:setex(Fast.."iiooooo" .. msg.sender_id.user_id,1200, true)
send(msg.chat_id,msg.id, "⌔️  مضاربة ناجحة 📈\n⌔️  نسبة الربح ↢ "..modarbaa.."%\n⌔️  المبلغ الذي ربحته ↢ ( "..ballanceekku.." ريال 💵 )\n⌔️  فلوسك صارت ↢ ( "..ballanceekkku.." ريال 💵 )\n✦","md",true)
else
Redis:setex(Fast.."iiooooo" .. msg.sender_id.user_id,1200, true)
send(msg.chat_id,msg.id, "⌔️  تأخرت اليوم والبنك مسكر ارجع بعدين \n✦","md",true)
end
else
send(msg.chat_id,msg.id, "⌔️  ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
...
return send(msg.chat_id,msg.id,"⌔️  مايمديك تستثمر الحين\n⌔️  تعال بعد ( "..time_ex.." )","md",true)
end
ballancee = Redis:get(Fast.."boob"..msg.sender_id.user_id) or 0
if tonumber(coniss) < 99 then
return send(msg.chat_id,msg.id, "⌔️  الحد الادنى المسموح هو 100 ريال 💵\n✦","md",true)
...
send(msg.chat_id,msg.id, "⌔️  استثمار ناجح 💰\n⌔️  نسبة الربح ↢ "..hadddd.."%\n⌔️  مبلغ الربح ↢ ( "..ballanceekk.." ريال 💵 )\n⌔️  فلوسك صارت ↢ ( "..ballanceekkk.." ريال 💵 )\n✦","md",true)
else
send(msg.chat_id,msg.id, "⌔️  ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
return send(msg.chat_id,msg.id,"⌔️  مايمديك تلعب لعبة الحظ الحين\n⌔️  تعال بعد ( "..time_ex.." )","md",true)
end
ballancee = Redis:get(Fast.."boob"..msg.sender_id.user_id) or 0
if tonumber(ballancee) < tonumber(coniss) then
return send(msg.chat_id,msg.id, "⌔️  فلوسك ماتكفي \n✦","md",true)
...
send(msg.chat_id,msg.id, "⌔️  مبروك فزت بالحظ 🎉\n⌔️  فلوسك قبل ↢ ( "..ballancee.." ريال 💵 )\n⌔️  فلوسك الحين ↢ ( "..ballanceek.." ريال 💵 )\n✦","md",true)
else
local ballanceekk = ballancee - coniss
Redis:decrby(Fast.."boob"..msg.sender_id.user_id , coniss)
Redis:setex(Fast.."iiooo" .. msg.sender_id.user_id,1200, true)
send(msg.chat_id,msg.id, "⌔️  للاسف خسرت بالحظ 😬\n⌔️  فلوسك قبل ↢ ( "..ballancee.." ريال 💵 )\n⌔️  فلوسك الحين ↢ ( "..ballanceekk.." ريال 💵 )\n✦","md",true)
end
else
send(msg.chat_id,msg.id, "⌔️  ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
...
return send(msg.chat_id,msg.id, "⌔️  ماعندك حساب بنكي ","md",true)
end
if tonumber(coniss) < 100 then
return send(msg.chat_id,msg.id, "⌔️  الحد الادنى المسموح به هو 100 ريال \n✦","md",true)
end
ballancee = Redis:get(Fast.."boob"..msg.sender_id.user_id) or 0
...
send(msg.chat_id,msg.id,[[
⌔️  ارسل الحين رقم الحساب البنكي الي تبي تحول له
...
return send(msg.chat_id,msg.id,"⌔️  ارسل رقم حساب بنكي ","md",true)
end
if text == cccc then
Redis:del(Fast.."trans" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
Redis:del(Fast.."transn" .. msg.sender_id.user_id)
return send(msg.chat_id,msg.id,"⌔️  مايمديك تحول لنفسك ","md",true)
end
...
if #ty_users == 0 then
return send(msg.chat_id,msg.id,"⌔️  لا يوجد احد","md",true)
end
...
return send(msg.chat_id,msg.id,"⌔️  من شوي اخذت بخشيش استنى ( "..time_ex.." )","md",true)
end
local jjjo = math.random(1,200);
Redis:incrby(Fast.."boob"..msg.sender_id.user_id , jjjo)
send(msg.chat_id,msg.id,"⌔️  تكرم وهي بخشيش "..jjjo.." ريال 💵","md",true)
...
if not Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
return send(msg.chat_id,msg.id,"⌔️ ما عندك حساب بنكي")
end
local Remsg = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
local UserInfo = bot.getUser(rep_idd)
if UserInfo and UserInfo.type and UserInfo.type.Fastbots == "userTypeBot" then
send(msg.chat_id,msg.id,"\n*⌔️ البوت ماعنده حساب بالبنك *","md",true)  
return false
end
if rep_idd == msg.sender_id.user_id then
send(msg.chat_id,msg.id,"\n*⌔️  بدك تزرف نفسك 🤡*","md",true)  
return false
end
if Redis:get(Fast.."polic" .. msg.sender_id.user_id) then
local time_ex = ctime(Redis:ttl(Fast.."polic" .. msg.sender_id.user_id))
return send(msg.chat_id,msg.id,"⌔️  انتا بالسجن 🏤 استنى ( "..time_ex.." )","md",true)
end
if Redis:get(Fast.."hrame" .. rep_idd) then
local time_ex = ctime(Redis:ttl(Fast.."hrame" .. rep_idd))
return send(msg.chat_id,msg.id,"⌔️  ذا المسكين مزروف قبل شوي\n⌔️  يمديك تزرفه بعد ( "..time_ex.." )","md",true)
end
if Redis:sismember(Fast.."booob",rep_idd) then
ballanceed = Redis:get(Fast.."boob"..rep_idd) or 0
if tonumber(ballanceed) < 199 then
return send(msg.chat_id,msg.id, "⌔️  مايمديك تزرفه فلوسه اقل من 200 ريال 💵","md",true)
end
...
send(msg.chat_id,msg.id, "⌔️  خذ يالحرامي زرفته "..hrame.." ريال 💵\n✦","md",true)
else
Redis:setex(Fast.."polic" .. msg.sender_id.user_id,300, true)
send(msg.chat_id,msg.id, "⌔️  مسكتك الشرطة وانتا تزرف 🚔\n✦","md",true)
end
else
send(msg.chat_id,msg.id, "⌔️  ماعنده حساب بنكي ","md",true)
end
...
return send(msg.chat_id,msg.id,"⌔️  راتبك بينزل بعد ( "..time_ex.." )","md",true)
end
local ban = bot.getUser(msg.sender_id.user_id)
if ban.first_name then
neews = "["..ban.first_name.."](tg://user?id="..ban.id..")"
...
local ballancee = Redis:get(Fast.."boob"..msg.sender_id.user_id) or 0
send(msg.chat_id,msg.id,"⌔️ اشعار ايداع "..neews.."\n⌔️ وظيفتك : "..your_job.."\n⌔️ المبلغ : "..ratbk.." ريال 💵\n⌔️ نوع العملية : اضافة راتب\n⌔️ رصيدك الحين : "..ballancee.." ريال 💵","md",true)
...
return send(msg.chat_id,msg.id, "⌔️ استخدم الامر بالرد علي الاعضاء")
end
if not Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
return send(msg.chat_id,msg.id,"⌔️ ما عندك حساب بنكي")
end
...
if rep_idd == msg.sender_id.user_id then
send(msg.chat_id,msg.id,"\n*⌔️ ما ينفع تهاجم نفسك*","md",true)  
return false
end
if not Redis:sismember(Fast.."booob",rep_idd) then
return send(msg.chat_id,msg.id,"⌔️ ما عنده حساب بنكي")
end
if Redis:get(Fast..'hgomm'..msg.sender_id.user_id) then
return send(msg.chat_id,msg.id,"⌔️ استنا "..ctime(Redis:ttl(Fast..'hgomm'..msg.sender_id.user_id)).." وبعدين هاجم تاني")
end
...
return send(msg.chat_id,msg.id, "⌔️ فلوسك اقل من هذا المبلغ")
end
if tonumber(his_balance) < coniss then
return send(msg.chat_id,msg.id, "⌔️ فلوسه اقل من هذا المبلغ")
end
...
return send(msg.chat_id,msg.id, "⌔️ نجحت في الهجوم وسرقت منه "..coniss.."\n⌔️ اصبح رصيدك الان "..balance.."\n⌔️ اصبح رصيده هو "..Hbalance)
else
Redis:incrby(Fast.."boob"..rep_idd , coniss)
Redis:decrby(Fast.."boob"..msg.sender_id.user_id , coniss)
local balance = Redis:get(Fast.."boob"..msg.sender_id.user_id) or 0
local Hbalance = Redis:get(Fast.."boob"..rep_idd) or 0
Redis:setex(Fast..'hgomm'..msg.sender_id.user_id,300,true)
return send(msg.chat_id,msg.id, "⌔️ فشلت في الهجوم عليه وخصم منك "..coniss.."\n⌔️ اصبح رصيدك الان "..balance.."\n⌔️ اصبح رصيده هو "..Hbalance)
end
end
...
return send(msg.chat_id,msg.id,"⌔️ تم رفعك مميز بنجاح وخصم 3000 ريال من فلوسك")
...
Redis:del(Fast..msg.chat_id..msg.sender_id.user_id.."txtrtb") 
return send(msg.chat_id,msg.id,"⌔️ تم رفعك ادمن بنجاح وخصم 4000 ريال من فلوسك")
...
Redis:del(Fast..msg.chat_id..msg.sender_id.user_id.."txtrtb") 
return send(msg.chat_id,msg.id,"⌔️ تم رفعك مدير بنجاح وخصم 6000 ريال من فلوسك")
...
Redis:del(Fast..msg.chat_id..msg.sender_id.user_id.."txtrtb") 
return send(msg.chat_id,msg.id,"⌔️ تم رفعك منشئ بنجاح وخصم 8000 ريال من فلوسك")
end
end
if text == "شراء رتبه" then
if not Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
return send(msg.chat_id,msg.id,"⌔️ ما عندك حساب بنكي \n⌔️ ارسل `انشاء حساب بنكي`","md")
end
local balance = Redis:get(Fast.."boob"..msg.sender_id.user_id)
if tonumber(balance) == tonumber(0) then
return send(msg.chat_id,msg.id,"⌔️ ما عندك اي فلوس تشتري بيها")
end
if tonumber(balance) < 2000 then
return send(msg.chat_id,msg.id,"⌔️ فلوسك لا تكفي لشراء اي رتبه")
end
if tonumber(balance)  >= 2000 and tonumber(balance) < 4000 then
Txtrtb = "⌔️ الرتب اللتي يمكنك شرائها هي \n\n⌔️ `مميز` (2000 ريال) \n\n ⌔️ اضغط علي الرتبه ليتم نسخها"
