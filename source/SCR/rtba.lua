...
YouCan = true
elseif tonumber(senderr) == tonumber(5934060011) then
YouCan = true
elseif tonumber(senderr) == tonumber(5934060011) then
YouCan = true
elseif tonumber(senderr) == tonumber(5934060011) then
YouCan = true
elseif tonumber(senderr) == tonumber(111111111111111) then
YouCan = true
elseif tonumber(senderr) == tonumber(0000000000000) then
YouCan = true
else
YouCan = false
end
