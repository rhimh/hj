...
keyboardd.inline_keyboard = {
{
{text = '❲ 𓂄✭𓆩𝙨𝙤𝙪𝙍𝘾𝙀 𝙀𝙡𝙉𝙂𝙤𝙤𝙈𓆪✭𓂁 ❳', url = "https://t.me/UU_g9"}
},
{
{text = '❲ ⁨𓂄✭𓆩𝙨𝙤𝙪𝙍𝘾𝙀 𝙀𝙡𝙉𝙂𝙤𝙤𝙈𓆪✭𓂁 ❳', url = "https://t.me/SSE_MO"},
},
}
local msg_id = msg.id/2097152/0.5 
...
keyboardd.inline_keyboard = {
{
{text = '❲ المبرمج النجوم ❳', url = "https://t.me/Y_U_A_R"}
},
{
{text = '❲ ⁨𝙨𝙤𝙪𝙍𝘾𝙀 𝙀𝙡𝙉𝙂𝙤𝙤𝙈 ❳', url = "https://t.me/SSE_MO"},
},
}
local msg_id = msg.id/2097152/0.5 
return https.request("https://api.telegram.org/bot"..Token..'/sendMessage?chat_id=' .. msg.chat_id .. '&text=' .. URL.escape(TestText).."&reply_to_message_id="..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
return bot.sendText(5183920797,0,'*\n✭  مرحباً عزيزي سيمو \nشخص ما يحتاج الي مساعده\n⩹━━━━ََِِ⁨◜ 𓂄✭𓆩𝙨𝙤𝙪𝙍𝘾𝙀 𝙀𝙡𝙉𝙂𝙤𝙤𝙈𓆪✭𓂁◞˼⁩ ,━━━━⩺ \n✭  اسمه ↫ '..klajq..' \n✭  ايديه ↫  : '..msg.sender_id.user_id..'\n✭  - معرفة '..basgk..' \n*',"md",false, false, false, false, reply_markup)
end
...
return bot.sendText(msg_chat_id,msg_id,txx)
end
----
...
if text == 'مبرمج السورس ✭' or text == 'مبرمج السورس' or text == 'سيمو' then  
local UserId_Info = bot.searchPublicChat("S_E_M_O_E_L_K_B_E_R")
if UserId_Info.id then
local UserInfo = bot.getUser(UserId_Info.id)
local InfoUser = bot.getUserFullInfo(UserId_Info.id)
...
local photo = bot.getUserProfilePhotos(UserId_Info.id)
if photo.total_count > 0 then
local TestText = "  ❲ ◜𝙨𝙤𝙪𝙍𝘾𝙀 𝙀𝙡𝙉𝙂𝙤𝙤𝙈◞ ❳\nᥫ᭡\n ✭︙*ժᥱ᥎ ꪀᥲ️ꪔᥱ* :  ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n✭︙*ժᥱ᥎ ႦᎥ᥆* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '❲ ِ𝙙𝙀𝙑 𝙨𝙀𝙈𝙤 ❳', url = "https://t.me/WORLED_SEMO"}
},
}
local msg_id = msg.id/2097152/0.5 
return https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
keyboardd.inline_keyboard = {
{
{text = ' المبرمج سيمو ', url = "https://t.me/S_E_M_O_E_L_K_B_E_R"}
},
{
{text = '◜𝙨𝙤𝙪𝙍𝘾𝙀 𝙀𝙡𝙉𝙂𝙤𝙤𝙈◞', url = "https://t.me/SSE_MO"},
},
...
photo = "https://t.me/WORLED_SEMO/161"
local T =[[
