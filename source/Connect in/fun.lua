...
return send(msg.chat_id, msg.id,'⌔️ تم مسح الموسيقى ومسح الجواب .')
end
...
return send(msg.chat_id, msg.id,'⌔️ ارسل الموسيقى الان ...')
end
...
if #list == 0 then
return send(msg.chat_id, msg.id, "⌔️ لا يوجد اسئله")
end
...
return send(msg.chat_id, msg.id, "⌔️ تم مسح جميع الاسئله")
end
...
return send(msg_chat_id,msg_id,"⌔️ أهلا عزيزي "..msg.Name_Controller.."\n⌔️ الصوتيات العامه بالتاكيد تم تفعيلها\n✓" )
else 
Redis:del(Fast..'lock_geamsAudio'..msg.chat_id) 
return send(msg_chat_id,msg_id,"⌔️ أهلا عزيزي "..msg.Name_Controller.."\n⌔️ تم تفعيل الصوتيات العامه \n✓" )
end 
end
...
return send(msg_chat_id,msg_id,"⌔️ أهلا عزيزي "..msg.Name_Controller.."\n⌔️ الصوتيات العامه بالتأكيد معطله\n✓" )
else
Redis:set(Fast..'lock_geamsAudio'..msg.chat_id,true)  
return send(msg_chat_id,msg_id,"⌔️ أهلا عزيزي "..msg.Name_Controller.."\n⌔️ تم تعطيل الصوتيات العامه\n✓" )
end   
end
...
return send(msg_chat_id,msg_id,"⌔️ أهلا عزيزي "..msg.Name_Controller.."\n⌔️ الصوتيات بالتاكيد تم تفعيلها\n✓" )
else 
...
hggg = '⌔️ الان ارسل اسمك واسم الشخص الثاني :'
...
return send(msg_chat_id,msg_id,'⌔️ تم تعطيل التسليه مسبقا\n ✓',"md")
else
Redis:set(Fast.."amrthshesh"..msg.chat_id,"true")
return send(msg_chat_id,msg_id,'⌔️ تم تعطيل التسليه\n ✓',"md")
end
end
...
if not Redis:get(Fast..'amrthshesh'..msg.chat_id)  then
return send(msg_chat_id,msg_id,'⌔️ تم تفعيل التسليه مسبقا\n ✓',"md")
else
Redis:del(Fast.."amrthshesh"..msg.chat_id)
return send(msg_chat_id,msg_id,'⌔️ تم تفعيل التسليه\n ✓',"md")
end
end
...
return send(msg_chat_id,msg_id,'⌔️ ارسل اسم الصوتيه',"md")
end
...
Redis:set(Fast.."Add:audio:Games"..senderr..":"..msg.chat_id,'start')
return send(msg_chat_id,msg_id, '⌔️ ارسل اسم الصوت الان ...',"md")
end
...
if #list == 0 then
send(msg_chat_id,msg_id, "⌔️ لا توجد صوتيات")
return false
end
message = '⌔️ قائمه الصوتيات :\n     للتشغيل اختر اسم من الاتي:\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n'
for k,v in pairs(list) do
message = message..""..k.."- ("..v..")\n"
end
...
local list = Redis:smembers(Fast.."text:Games:Bot"..msg.chat_id)
if #list == 0 then
send(msg_chat_id,msg_id, "⌔️ لا توجد صوتيات عامه")
return false
end
for k,v in pairs(list) do
...
send(msg_chat_id,msg_id, "⌔️ تم مسح جميع الصوتيات")
end
...
send(msg_chat_id,msg_id, '⌔️ ارسل اسم الصوتيه',"md")
end
...
send(msg_chat_id,msg_id, '⌔️ ارسل اسم الصوت الان ...',"md")
end
...
message = '⌔️ قائمه الصوتيات العامه:\n     للتشغيل اختر اسم من الاتي:\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n'
for k,v in pairs(list) do
message = message..""..k.."- ("..v..")\n"
end
send(msg_chat_id,msg_id,message)
...
send(msg_chat_id,msg_id, '⌔️ تم تعطيل اوامر الصيغ مسبقا\n ✓',"md")
else
Redis:set(Fast.."kadmeat"..msg.chat_id,"true")
send(msg_chat_id,msg_id, '⌔️ تم تعطيل اوامر الصيغ\n ✓',"md")
end
end
...
send(msg_chat_id,msg_id, '⌔️ تم تفعيل اوامر التحويلات مسبقا\n ✓',"md")
else
Redis:del(Fast.."kadmeat"..msg.chat_id)
send(msg_chat_id,msg_id, '⌔️ تم تفعيل اوامر الصيغ\n ✓',"md")
end
end
...
send(msg_chat_id,msg_id, '⌔️ تم تعطيل امر انطق مسبقا\n ✓',"md")
else
Redis:set(Fast.."intg"..msg.chat_id,"true")
send(msg_chat_id,msg_id, '⌔️ تم تعطيل امر انطق\n ✓',"md")
end
end
...
send(msg_chat_id,msg_id, '⌔️ تم تفعيل امر انطق مسبقا\n ✓',"md")
else
Redis:del(Fast.."intg"..msg.chat_id)
send(msg_chat_id,msg_id, '⌔️ تم تفعيل امر انطق\n ✓',"md")
end
end
...
send(msg_chat_id,msg_id, '⌔️ تم تعطيل امر غنيلي مسبقا\n ✓',"md")
else
Redis:set(Fast.."knele"..msg.chat_id,"true")
send(msg_chat_id,msg_id, '⌔️ تم تعطيل امر غنيلي\n ✓',"md")
end
end
...
send(msg_chat_id,msg_id, '⌔️ تم تفعيل امر غنيلي مسبقا\n ✓',"md")
else
Redis:del(Fast.."knele"..msg.chat_id)
send(msg_chat_id,msg_id, '⌔️ تم تفعيل امر غنيلي\n ✓',"md")
end
end
...
send(msg_chat_id,msg_id, '⌔️ تم تعطيل امر الابراج مسبقا\n ✓',"md")
else
Redis:set(Fast.."brjj"..msg.chat_id,"true")
send(msg_chat_id,msg_id, '⌔️ تم تعطيل امر الابراج\n ✓',"md")
end
end
...
send(msg_chat_id,msg_id, '⌔️ تم تفعيل امر الابراج مسبقا\n ✓',"md")
else
Redis:del(Fast.."brjj"..msg.chat_id)
send(msg_chat_id,msg_id, '⌔️ تم تفعيل امر الابراج\n ✓',"md")
end
end
...
return send(msg_chat_id,msg_id,'⌔️ تم تعطيل معنى اسم مسبقا\n ✓',"md")
else
Redis:set(Fast.."mynames"..msg.chat_id,"true")
return send(msg_chat_id,msg_id,'⌔️ تم تعطيل معنى اسم\n ✓',"md")
end
end
...
if not Redis:get(Fast..'mynames'..msg.chat_id)  then
return send(msg_chat_id,msg_id,'⌔️ تم تفعيل معنى اسم مسبقا\n ✓',"md")
else
Redis:del(Fast.."mynames"..msg.chat_id)
return send(msg_chat_id,msg_id,'⌔️ تم تفعيل معنى اسم\n ✓',"md")
end
end
...
return send(msg_chat_id,msg_id,'⌔️ تم تعطيل قول مسبقا\n ✓',"md")
else
Redis:del(Fast.."kolklma"..msg.chat_id)
return send(msg_chat_id,msg_id,'⌔️ تم تعطيل قول\n ✓',"md")
end
end
...
return send(msg_chat_id,msg_id,'⌔️ تم تفعيل قول مسبقا\n ✓',"md")
else
Redis:set(Fast.."kolklma"..msg.chat_id,"true")
return send(msg_chat_id,msg_id,'⌔️ تم تفعيل قول\n ✓',"md")
end
end
...
return send(msg_chat_id,msg_id,'⌔️ تم تعطيل اغنيه مسبقا\n ✓',"md")
else
Redis:set(Fast.."myniknea"..msg.chat_id,"true")
return send(msg_chat_id,msg_id,'⌔️ تم تعطيل اغنيه\n ✓',"md")
end
end
...
return send(msg_chat_id,msg_id,'⌔️ تم تفعيل اغنيه مسبقا\n ✓',"md")
else
Redis:del(Fast.."myniknea"..msg.chat_id)
return send(msg_chat_id,msg_id,'⌔️ تم تفعيل اغنيه\n ✓',"md")
end
end
...
return send(msg.chat_id,msg.id,'⌔️ لم استطيع العثور علي نتيجه في google play ')
end
...
send(msg.chat_id,msg.id,'⌔️ نتائج بحثك عن *'..q..'* في play store',"md",false, false, false, false, reply_markup)
else
send(msg.chat_id,msg.id,"⌔️ البحث باللغه الانجليزيه فقط")
end
end
if text then
