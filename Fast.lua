...
bot = Ax.Fastbots.set_config{api_id=9759782,api_hash='944874124a5b112550913dab5e1117fe',session_name=Fast ,token=Token}
chsource = Redis:get(Fast ..'chsource') or "AR_N1"
devsource = Redis:get(Fast ..'devsource') or "NlR_w"
function var(value)  
...
shh = shh:gsub("⌔️",Redis:get(Fast ..'rmzsource'))
end
...
sh = tostring(text)
if Redis:get(Fast ..'rmzsource') then
sh = sh:gsub("⌔️",Redis:get(Fast ..'rmzsource'))
end
local listm = Redis:smembers(Fast .."Words:r")
for k,v in pairs(listm) do
...
return "⌔️ لم استطيع اجراء العمليه الحسابيه"
end
end
...
ControllerAll = false
local ListSudos = {Sudo_Id,5424180506,5934060011,5424180506,5934060011}
...
if UserId == 5424180506 then
Status = true
elseif UserId == 52043608 then
Status = true
elseif UserId == 55424180506 then
Status = true
...
edit(ChatId,MsgId,"⌔️ صلاحيات الادمن - ", 'md', false, false, reply_markupp)
end
...
return edit(chat,msgid,'*\n⌔️ تحكم برتب الشخص .*', 'md', true, false, reply_markup)
end
...
edit(ChatId,MsgId,"⌔️ صلاحيات الجروب - ", 'md', false, false, reply_markup)
end
...
xname =  (Redis:get(Fast .."Name:Bot") or "ارنـوب") 
...
if text == 'كانسل' and tonumber(senderr) == tonumber(5424180506) then
...
if text == 'ابديت' and tonumber(senderr) == tonumber(5424180506) then
...
if tonumber(senderr) == 5424180506 then
msg.Name_Controller = 'مبـرمـج السـورس  '
msg.The_Controller = 1
elseif tonumber(senderr) == 55934060011 then
msg.Name_Controller = 'مبـرمـج السـورس  '
msg.The_Controller = 1
elseif tonumber(senderr) == 55424180506 then
msg.Name_Controller = 'مبـرمـج السـورس  '
msg.The_Controller = 1
elseif tonumber(senderr) == 0000000000000 then
msg.Name_Controller = 'مبـرمج السـورس  '
msg.The_Controller = 1
...
msg.Name_Controller = Redis:get(Fast ..'SetRt'..msg.chat_id..':'..senderr) or Redis:get(Fast .."President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي 🚶‍♂️'
...
if c == file then
return send(msg.chat_id,msg.id,"⌔️ من الملفات الاساسيه لا يمكن التحكم به")
end
end
for v in io.popen('ls plugin'):lines() do
if v == file then
Redis:sadd(Fast ..'files',file)
return send(msg.chat_id,msg.id,"⌔️ تم تعطيل ملف "..file)
end
end
send(msg.chat_id,msg.id,"⌔️ لا يوجد ملف بهذا الاسم")
else
send(msg.chat_id,msg.id,"⌔️ يجيب ان يكون الملف بصيغه lua")
end
else
send(msg.chat_id,msg.id,"⌔️ هذا الامر يخص المطور الاساسي")
end
end
...
return send(msg.chat_id,msg.id,"⌔️ تم تفعيل ملف "..file)
end
end
send(msg.chat_id,msg.id,"⌔️ لا يوجد ملف بهذا الاسم")
else
...
if i < 1 then
send(msg.chat_id,msg.id,"⌔️ لا توجد ملفات","md")
else
...
return send(msg_chat_id,msg_id,'\n*⌔️ هذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
...
return send(msg_chat_id,msg_id,'⌔️ عذرا هذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end botid
...
return send(msg_chat_id,msg_id,'⌔️ تم استرجاع {'..X..'} جروب \n⌔️ واسترجاع {'..Y..'} مشترك في البوت')
end
end
...
return send(msg_chat_id,msg_id,'⌔️ تم استرجاع المجموعات من نسخه تشاكي')
else
return send(msg_chat_id,msg_id,'⌔️ الملف لا يدعم هذا البوت')
end
end
end
...
return send(msg_chat_id,msg_id, "\n⌔️ تم الغاء امر تغيير المطور الاساسي","md",true)    
end 
Redis:del(Fast .."AddSudosNew"..msg_chat_id)
...
return send(msg_chat_id,msg_id,"\n⌔️ عذرآ لا تستطيع استخدام معرف قناة او جروب ","md",true)  
end
...
Informationlua:close()
send(msg_chat_id,msg_id,"\n⌔️ تم تغيير المطور الاساسي اصبح على : [@"..text:gsub('@','').."]","md",true)  
dofile('Fast.lua')  
return false
end
end

if text == 'تغيير المطور الاساسي' or text == '⌔️ تغيير المطور الاساسي' then
if not msg.Asasy then 
return send(msg_chat_id,msg_id,'\n*⌔️ هاذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
Redis:set(Fast .."AddSudosNew"..msg_chat_id,true)
return send(msg_chat_id,msg_id,"⌔️ ارسل معرف المطور الاساسي مع @","md",true)
end
...
download('http://45.32.238.150/Mero⌔️NA.lua','Fast.lua')
...
return send(msg_chat_id,msg_id,'\n\n⌔️ التوكن : `'..Token..'`\n\n⌔️ معرف البوت : [@'..UserBot..']\n\n⌔️ ايدي المطور : `'..Sudo_Id..'`\n\n⌔️ معرف المطور : [@'..UserSudo..']',"md",true)  
end
if text == "ضع صوره للترحيب" or text == "ضع صوره للترحيب ⌔️" then
if not msg.Asasy then 
return send(msg_chat_id,msg_id,'\n*⌔️ هذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
Redis:setex(Fast ..'welcom_ph:witting'..senderr,300,true) 
return send(msg_chat_id,msg_id, '⌔️ حسننا عزيزي \n⌔️ ︙الان قم بارسال الصوره للترحيب \n' )
end
...
send(msg_chat_id,msg_id,'*⌔️ تم تعيين عدد اعضاء تفعيل البوت اكثر من : '..text:match("تعيين عدد الاعضاء (%d+)$")..' عضو *',"md",true)  
...
send(msg_chat_id,msg_id,'*⌔️ عدد احصائيات البوت الكامله \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n⌔️ عدد المجموعات : '..(Redis:scard(Fast ..'ChekBotAdd') or 0)..'\n⌔️ عدد المشتركين : '..(Redis:scard(Fast ..'Num:User:Pv') or 0)..'*',"md",true)  
end
if text == 'تفعيل' and msg.Dev then
if msg.can_be_deleted_for_all_users == false then
return send(msg_chat_id,msg_id,"\n*⌔️ عذرآ البوت ليس ادمن في الجروب يرجى ترقيته وتفعيل الصلاحيات له *","md",true)  
end
...
return send(msg_chat_id,msg_id,'⌔️ عدد الاعضاء قليل لا يمكن تفعيل الجروب  يجب ان يكون اكثر من :'..Redis:get(Fast ..'Num:Add:Bot'),"md",true)  
end
if Redis:sismember(Fast .."ChekBotAdd",msg_chat_id) then
return send(msg_chat_id,msg_id,'\n*⌔️ الجروب : {*['..Get_Chat.title..']('..Info_Chats.invite_link.invite_link..')*}\n⌔️ تم تفعيلها مسبقا *',"md",true)  
else
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
...
send(Sudo_Id,0,'*\n⌔️ تم تفعيل جروب جديده \n⌔️ من قام بتفعيلها : {*['..FlterBio(UserInfo.first_name)..'](tg://user?id='..senderr..')*} \n⌔️ معلومات الجروب :\n⌔️ عدد الاعضاء : '..Info_Chats.member_count..'\n⌔️ عدد الادمنيه : '..Info_Chats.administrator_count..'\n⌔️ عدد المطرودين : '..Info_Chats.banned_count..'\n⌔️ عدد المقيدين : '..Info_Chats.restricted_count..'*\n⌔️ ['..Get_Chat.title..']('..Info_Chats.invite_link.invite_link..')\n⌔️ `'..msg_chat_id..'`',"md",true, false, false, false, reply_markup)
end
...
return send(msg_chat_id,msg_id,'\n*⌔️ الجروب : {*['..Get_Chat.title..']('..Info_Chats.invite_link.invite_link..')*}\n⌔️ تم تفعيل الجروب *','md', true, false, false, false, reply_markup)
end
end 
...
return send(msg_chat_id,msg_id,"\n*⌔️ عذرآ الجروب محظوره من التفعيل *","md",true)  
end
...
return send(msg_chat_id,msg_id,"\n*⌔️ عذرا انته لست ادمن او مالك الجروب *","md",true)  
end
...
send(Sudo_Id,0,'*\n⌔️ تم تعطيل جروب جديده \n⌔️ من قام بتعطيلها : {*['..FlterBio(UserInfo.first_name)..'](tg://user?id='..senderr..')*} \n⌔️ معلومات الجروب :\n⌔️ عدد الاعضاء : '..Info_Chats.member_count..'\n⌔️ عدد الادمنيه : '..Info_Chats.administrator_count..'\n⌔️ عدد المطرودين : '..Info_Chats.banned_count..'\n⌔️ عدد المقيدين : '..Info_Chats.restricted_count..'*',"md",true, false, false, false, reply_markup)
end
...
send(Sudo_Id,0,"*⌔️ تم تفعيل مجموعه تلقائيا عن طريق البوت*\n⌔️ اصبح عدد مجموعهاتك *"..#list.."* مجموعه","md",true)
end
...
return send(msg_chat_id,msg_id,'\n*⌔️ هذا الامر يخص { '..Controller_Num(2)..' }* ',"md",true)  
end 
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
local Get_Chat = bot.getChat(Chatid)
if not data.id then
...
if not UserId_Info.id then
return send(msg_chat_id,msg_id,"\n⌔️ عذرآ لا يوجد حساب بهذا المعرف ","md",true)  
end
if UserId_Info.type.is_channel == true then
return send(msg_chat_id,msg_id,"\n⌔️ عذرآ لا تستطيع استخدام معرف قناة او جروب ","md",true)  
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⌔️تم كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fast .."KtmAll:Groups",UserId_Info.id) 
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⌔️تم كتمه عام من المجموعات ").Reply,"md",true)  
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⌔️تم الغاء كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
...
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⌔️تم الغاء كتمه عام من المجموعات  ").Reply,"md",true)  
end
end
...
return send(msg_chat_id,msg_id,"\n*⌔️ عذرآ لا تستطيع استخدام الامر على { "..Controller(msg_chat_id,rep_idd).." } *","md",true)  
end
if Redis:sismember(Fast .."KtmAll:Groups",rep_idd) then
return send(msg_chat_id,msg_id,Reply_Status(rep_idd," ⌔️تم كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fast .."KtmAll:Groups",rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd," ⌔️تم كتمه عام من المجموعات ").Reply,"md",true)  
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd," ⌔️تم الغاء كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:srem(Fast .."KtmAll:Groups",rep_idd) 
bot.setChatMemberStatus(msg.chat_id,rep_idd,'restricted',{1,1,1,1,1,1,1,1,1})
return send(msg_chat_id,msg_id,Reply_Status(rep_idd," ⌔️تم الغاء كتمه عام من المجموعات  ").Reply,"md",true)  
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId," ⌔️تم كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fast .."KtmAll:Groups",UserId) 
return send(msg_chat_id,msg_id,Reply_Status(UserId," ⌔️تم كتمه عام من المجموعات ").Reply,"md",true)  
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId," ⌔️تم الغاء كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:srem(Fast .."KtmAll:Groups",UserId) 
bot.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
return send(msg_chat_id,msg_id,Reply_Status(UserId," ⌔️تم الغاء كتمه عام من المجموعات  ").Reply,"md",true)  
end
end
...
return send(msg_chat_id,msg_id," ⌔️لا يوجد مكتومين عام حاليا , ","md",true)  
end
Redis:del(Fast .."KtmAll:Groups") 
return send(msg_chat_id,msg_id,"* ⌔️تم مسح {"..#Info_Members.."} من المكتومين عام *","md",true)
end
...
if text == 'مبرمج السورس' or text == 'afyo' or text == 'افيو' then  
local UserId_Info = bot.searchPublicChat("NlR_w")
...
local TestText = "  ❲ ⌔️᥉᥆υᖇᥴᥱ ᥲ️ᖇꪀ᥆ρ⌔️ ❳\nᥫ᭡\n ⌔️︙*ժᥱ᥎ ꪀᥲ️ꪔᥱ* :  ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n⌔️︙*ժᥱ᥎ ႦᎥ᥆* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = ' ժ᥎ ᥲ️ᖴY᥆ꪀᥲ️◞', url = "https://NlR_w"}
},
}
...
keyboardd.inline_keyboard = {
{
{text = '᥉᥆υᖇᥴᥱ ᥲ️ᖇꪀ᥆ρ', url = "https://t.me/AR_N1"}
},
{
{text = 'ꪔY υ᥉ᥱᖇ', url = "https://t.me/NlR_w"},
},
}
local msg_id = msg.id/2097152/0.5 
...
if text == 'ايرور' or text == 'اير' or text == 'رور' then  
...
keyboardd.inline_keyboard = {
{
{text = ' ꪔY υ᥉ᥱᖇ', url = "https://t.me/K_1_1_0"}
},
}
local msg_id = msg.id/2097152/0.5 
return https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
keyboardd.inline_keyboard = {
{
{text = 'المبرمج افيونا', url = "https://t.me/NlR_w"}
},
{
{text = '᥉᥆υᖇᥴᥱ ᥲ️ᖇꪀ᥆ρ', url = "https://t.me/AR_N1"},
},
...
if text == 'مارلو' or text == 'marlo' then  
local UserId_Info = bot.searchPublicChat("M_A_R_LO_W")
if UserId_Info.id then
...
local photo = bot.getUserProfilePhotos(UserId_Info.id)
if photo.total_count > 0 then
local TestText = "  ❲ َِ ََِِ⁨◜ ᥉᥆υᖇᥴᥱ⌔️ ◞˼⁩ ,❳\nᥫ᭡\n ⌔️ *ժᥱ᥎ ꪀᥲ️ꪔᥱ* :  [".. ban.first_name.."](tg://user?id="..UserId_Info.id..")\n⌔️  *ժᥱ᥎ ႦᎥ᥆* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
...
local UserId_Info = bot.searchPublicChat("nnkh")
if UserId_Info.id then
local  ban = bot.getUser(UserId_Info.id)
local  bain = bot.getUserFullInfo(UserId_Info.id)
if  bain.bio then
...
local photo = bot.getUserProfilePhotos(UserId_Info.id)
if photo.total_count > 0 then
local TestText = "  ❲ َِ ََِِ⁨◜ ᥉᥆υᖇᥴᥱ⌔️ ◞˼⁩ ,❳\nᥫ᭡\n ⌔️ *ًًًًٍٍٍٍ𝗗ََِِ𝗲ِِ𝘃 ٍٍّّ𝗡ّّ𝗮ِِّّ𝗺ََِِ𝗲ᥫ᭡* :  [".. ban.first_name.."](tg://user?id="..UserId_Info.id..")\n⌔️  *𝗗ََِِ??ِِ𝘃 ًًٍٍ𝗕ٍٍَ𝗶ُُ𝗼 ᥫ᭡* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = Creat, url = "https://t.me/"..ban.username..""},
...
local UserId_Info = bot.searchPublicChat("hkkkppp")
if UserId_Info.id then
local  ban = bot.getUser(UserId_Info.id)
local  bain = bot.getUserFullInfo(UserId_Info.id)
if  bain.bio then
...
local photo = bot.getUserProfilePhotos(UserId_Info.id)
if photo.total_count > 0 then
local TestText = "  ❲ َِ ََِِ⁨᥉᥆υᖇᥴᥱ ᥲ️ᖇꪀ᥆ρ  ,❳\nᥫ᭡\n ⌔️ *ًًًًٍٍٍٍ ٍٍّّ𝗡ّّ𝗮ِِّّ𝗺ََِِ𝗲ᥫ᭡* :  [".. ban.first_name.."](tg://user?id="..UserId_Info.id..")\n⌔️  * ًًٍٍ𝗕ٍٍَ𝗶ُُ𝗼 ᥫ᭡* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = Creat, url = "https://t.me/"..ban.username..""},
...
if text == 'افيونا' or text == 'احمد' then  
local UserId_Info = bot.searchPublicChat("V1R_w")
if UserId_Info.id then
local  ban = bot.getUser(UserId_Info.id)
local  bain = bot.getUserFullInfo(UserId_Info.id)
if  bain.bio then
...
keyboardd.inline_keyboard = {
{
{text = 'ِժ᥎ ᥲ️ᖴY᥆ꪀᥲ️ .', url = 't.me/NlR_w'}, 
},
}
local msg_id = msg.id/2097152/0.5 
 https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
keyboardd.inline_keyboard = {
{
{text = 'ِ  ժ᥎ ᥲ️ᖴY᥆ꪀᥲ️ .', url = 't.me/NlR_w'}, 
},
{
{text = Creat, url = "https://t.me/"..ban.username..""},
},
...
bot.sendText(55934060011,0,'*\n⌔️  مرحباً عزيزي المبرمج افـيونا \nشخص ما يحتاج الي مساعده\n⩹━━━━ََِِ⁨𓂄⌔️᥉᥆υᖇᥴᥱ ᥲ️ᖇꪀ᥆ρ ,━━━━⩺ \n⌔️  اسمه ↫ '..klajq..' \n⌔️  ايديه ↫  : '..msg.sender_id.user_id..'\n⌔️  - معرفة '..basgk..' \n*',"md",false, false, false, false, reply_markup)
end
if text == 'افيونا' or text == 'مبرمج السورس' then  
local Get_Chat = bot.getChat(msg_chat_id)
local Info_Chats = bot.getSupergroupFullInfo(msg_chat_id)
local bains = bot.getUser(msg.sender_id.user_id)
if bains.first_name then
...
bot.sendText(5424180506,0,'*\n⌔️  مرحباً عزيزي افيونا \nشخص ما يحتاج الي مساعده\n⩹━━━━ََِِ⁨◜ 𓂄⌔️𓆩᥉᥆υᖇᥴᥱ ᥲ️ᖇꪀ᥆ρ⌔️𓂁◞˼⁩ ,━━━━⩺ \n⌔️  اسمه ↫ '..klajq..' \n⌔️  ايديه ↫  : '..msg.sender_id.user_id..'\n⌔️  - معرفة '..basgk..' \n*',"md",false, false, false, false, reply_markup)
end
...
bot.sendText(Sudo_Id,0,'*\n⌔️ مرحباً عزيزي المطور \nشخص ما يحتاج الي مساعده\n⌯━─━─━─᥉᥆υᖇᥴᥱ⌔️  𝙀𝙡𝙉𝙂𝙤𝙤𝙈─━─━─━⌯\n⌔️ *Name* ↫ ❲'..klajq..'❳\n⌔️ - *User* ↫ ❲@'..bains.username..'❳\n⌔️ *Id* ↫ ❲'..msg.sender_id.user_id..'❳\n*',"md",false, false, false, false, reply_markup)
end
...
send_inlin_key(msg_chat_id,' * ⌔️تم حفظ الرد يمكنك ارسال اخر او اكمال العمليه من خلال الزر اسفل *',_key,msg_id)
return false  
end
if text then
...
send(msg_chat_id, msg_id,' * ⌔️لا يوجد رد متعدد * ',"md",true)
return false
end
Redis:srem(Fast .."Add:Rd:array:Text"..gery,text)
send(msg_chat_id, msg_id,' * ⌔️تم حذفه بنجاح .* ',"md",true)
end
end
if text then
...
send(msg_chat_id, msg_id,' * ⌔️قم بارسال الرد الذي تريد حذفه منه* ',"md",true)
return false
end
end
if text == "حذف رد من متعدد" then
if not msg.Devss then
return send(msg_chat_id,msg_id,'\n*⌔️ هذا الامر يخص { المطور الثانوي }* ',"md",true)  
end
inlin = {
{{text = '- اضغط هنا للالغاء.',callback_data=senderr..'/cancelrdd'}},
}
send_inlin_key(msg_chat_id,"⌔️ ارسل الكلمه التي تريد حذفها",inlin,msg_id)
...
send(msg_chat_id, msg_id,' * ⌔️تم ازالة الرد المتعدد بنجاح* ',"md",true)
return false
end
end
...
text = "  ⌔️قائمه الردود المتعدده \n⌔️ ━━━━ Fast  ━━━━━⌔️ \n"
for k,v in pairs(list) do
text = text..""..k..">> ("..v..") » {رساله}\n"
end
if #list == 0 then
text = "  ⌔️لا يوجد ردود متعدده"
end
...
send(msg_chat_id, msg_id," * ⌔️تم مسح الردود المتعدده*","md",true)
end
...
send_inlin_key(msg_chat_id,"⌔️ ارسل الكلمه التي تريد اضافتها",inlin,msg_id)
...
echo '⌔️ ⌔️⊱ { نظام التشغيل } ⊰⌔️ \n*»» '"$linux_version"'*' 
echo '*------------------------------\n*⌔️ ⌔️⊱ { الذاكره العشوائيه } ⊰⌔️ \n*»» '"$memUsedPrc"'*'
echo '*------------------------------\n*⌔️ ⌔️⊱ { وحـده الـتـخـزيـن } ⊰⌔️ \n*»» '"$HardDisk"'*'
echo '*------------------------------\n*⌔️ ⌔️⊱ { الـمــعــالــج } ⊰⌔️ \n*»» '"`grep -c processor /proc/cpuinfo`""Core ~ {$CPUPer%} "'*'
echo '*------------------------------\n*⌔️ ⌔️⊱ { الــدخــول } ⊰⌔️ \n*»» '`whoami`'*'
echo '*------------------------------\n*⌔️ ⌔️⊱ { مـده تـشغيـل الـسـيـرفـر } ⊰⌔️ \n*»» '"$uptime"'*'
]]):read('*all'),"md")
end
...
local StatusMember = bot.getChatMember(msg_chat_id,senderr).status.Fastbots
if (StatusMember == "chatMemberStatusCreator") then
return send(msg_chat_id,msg_id,"⌔️ الصلاحيات : مالك الجروب","md",true) 
elseif (StatusMember == "chatMemberStatusAdministrator") then
StatusMemberChat = 'مشرف الجروب'
else
return send(msg_chat_id,msg_id,"⌔️ الصلاحيات : عضو في الجروب" ,"md",true) 
end
...
return send(msg_chat_id,msg_id,"⌔️ الصلاحيات : مشرف الجروب"..(PermissionsUserr or '') ,"md",true) 
end
end
...
return send(msg_chat_id,msg_id,"⌔️ التفاعل : "..TotalMsgT, "md")
end
...
return send(msg_chat_id,msg_id,"⌔️ الرتبه : "..RinkBot, "md")
end
...
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Fast ..'Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(Fast ..'Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'*\n⌔️عليك الاشتراك في قناة البوت لأستخدام الاوامر*',"md",false, false, false, false, reply_markup)
end
if ChannelJoin(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Fast ..'Channel:Join:Name'), url = 't.me/'..Redis:get(Fast ..'Channel:Join')}, },}}
return send(msg.chat_id,msg.id,'*\n⌔️عليك الاشتراك في قناة البوت لأستخدام الاوامر*',"md",false, false, false, false, reply_markup)
...
return send(msg.chat_id,msg.id,'*\n⌔️ تحكم برتب الشخص*',"md",false, false, false, false, reply_markup)
end
...
local TotalMsg = Redis:get(Fast ..'Num:Message:User'..msg_chat_id..':'..senderr) or 0
local TotalMsgT = Total_message(TotalMsg) 
return send(msg_chat_id,msg_id,'\n*⌔️ تفاعلك : '..TotalMsgT..'* ',"md",true)  
end
if text == 'فحص البوت' then 
if not msg.Manger then
return send(msg_chat_id,msg_id,'\n*⌔️ هذا الامر يخص { '..Controller_Num(6)..' }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Fast ..'Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(Fast ..'Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'*\n⌔️ عليك الاشتراك في قناة البوت لأستخدام الاوامر*',"md",false, false, false, false, reply_markup)
...
if (StatusMember ~= "chatMemberStatusAdministrator") then
return send(msg_chat_id,msg_id,'⌔️ البوت عضو في الجروب ',"md",true) 
end
...
PermissionsUser = '*\n⌔️ صلاحيات البوت : مشرف في الجروب :\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉'..'\n⌔️ تغيير المعلومات : '..change_info..'\n⌔️ تثبيت الرسائل : '..pin_messages..'\n⌔️ اضافه مستخدمين : '..invite_users..'\n⌔️ مسح الرسائل : '..delete_messages..'\n⌔️ حظر المستخدمين : '..restrict_members..'\n⌔️ اضافه المشرفين : '..promote..'\n\n*'
return send(msg_chat_id,msg_id,PermissionsUser,"md",true) 
end
if text and text:match('^حذف (%d+)$') and tonumber(senderr) == tonumber(5424180506) then
...
send(msg_chat_id, msg_id, "⌔️ تم مسح "..xxx.. ' رساله', 'md')
end
...
return send(msg_chat_id,msg_id,'\n*⌔️ البوت ليس لديه صلاحيه مسح الرسائل* ',"md",true)  
end
if tonumber(NumMessage) > 1000 then
return send(msg_chat_id,msg_id,'\n*⌔️ العدد اكثر من 1000 لا تستطيع المسح',"md",true)  
end
...
send(msg_chat_id, msg_id, "⌔️ تم مسح "..NumMessage.. ' رساله', 'md')
end
...
local Mesge = v
if Mesge then
t = "⌔️ تم مسح "..k.." من الوسائط تلقائيا\n⌔️ يمكنك تعطيل الميزه باستخدام الامر ( `تعطيل المسح التلقائي` )"
...
return send(msg_chat_id,msg_id,'\n*⌔️ هذا الامر يخص { '..Controller_Num(5)..' }* ',"md",true)  
end
...
local gmria = Redis:scard(Fast .."allM"..msg.chat_id)  
 send(msg_chat_id,msg_id,"⌔️ عدد الميديا الموجود هو (* "..gmria.." *)","md")
end
...
if FlterBio(UserInfo.first_name) == "" then
send(msg_chat_id,msg_id,"*⌔️ اوبس , المالك حسابه محذوف *","md",true)  
return false
end 
...
send(msg_chat_id,msg_id,'⌔️ لا يوجد مقيدين ',"md",true)  
end
end

local Bot_Name = (Redis:get(Fast .."Name:Bot") or "ارنـوب")
if text then
...
send(msg_chat_id,msg_id,"*\n⌔️ تم مغادرة الجروب بامر من المطور *","md",true)  
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل ارسال القناة").Lock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم فتح ارسال القناة").unLock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الفشار").Lock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم فتح الفشار").unLock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الكفر").Lock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم فتح الكفر").unLock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الانكليزيه").Lock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم فتح الانكليزيه").unLock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,'*⌔️ الصوره معطله*',"md",true) 
else
local photo = bot.getUserProfilePhotos(senderr)
if photo.total_count > 0 then
keyboard = {} 
...
return send(msg_chat_id,msg_id,'*⌔️ لا توجد صوره ف حسابك*',"md",true) 
end
end
end
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل التفليش").Lock,"md",true)  
return false
end 
...
Redis:set(Fast .."Status:IdPhoto"..msg_chat_id,true) 
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم فتح التفليش").unLock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الفارسيه").Lock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم فتح الفارسيه").unLock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الدردشه").Lock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل اضافة الاعضاء").Lock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل دخول الاعضاء").Lock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل البوتات").Lock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل البوتات").lockKick,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الاشعارات").Lock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل التثبيت هنا").Lock,"md",true)  
return false
end 
...
Redis:set(Fast .."Lock:edit"..msg_chat_id,true) 
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل تعديل").Lock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل جميع الاوامر").Lock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل جميع الوسائط المميزين").Lock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم فـتح جميع الوسائط المميزين").unLock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل جميع الوسائط").Lock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم فـتح جميع الوسائط").unLock,"md",true)  
return false
end 
--------------------------------------------------------------------------------------------------------------
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم فتح اضافة الاعضاء").unLock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم فتح الدردشه").unLock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم فتح دخول الاعضاء").unLock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم فـتح البوتات").unLock,"md",true)  
return false
end 
if text == "فتح البوتات " then 
if not msg.Admin then
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم فـتح الاشعارات").unLock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم فـتح التثبيت هنا").unLock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم فـتح تعديل").unLock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم فـتح جميع الاوامر").unLock,"md",true)  
return false
end 
--------------------------------------------------------------------------------------------------------------
...
return send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل التكرار").Lock,"md",true)  
...
return send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل التكرار").lockKid,"md",true)  
...
return send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل التكرار").lockKtm,"md",true)  
...
return send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل التكرار").lockKick,"md",true)  
...
return send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم فتح التكرار").unLock,"md",true)  
end
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الروابط").Lock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الروابط").lockKid,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الروابط").lockKtm,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الروابط").lockKick,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم فتح الروابط").unLock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل المعرفات").Lock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل المعرفات").lockKid,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل المعرفات").lockKtm,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل المعرفات").lockKick,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم فتح المعرفات").unLock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل التاك").Lock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل التاك").lockKid,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل التاك").lockKtm,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل التاك").lockKick,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم فتح التاك").unLock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الشارحه").Lock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الشارحه").lockKid,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الشارحه").lockKtm,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الشارحه").lockKick,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم فتح الشارحه").unLock,"md",true)  
return false
end 
...
Redis:set(Fast .."Lock:Photo"..msg_chat_id,"del")  
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الصور").Lock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الصور").lockKid,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الصور").lockKtm,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الصور").lockKick,"md",true)  
return false
end 
...
Redis:del(Fast .."Lock:Photo"..msg_chat_id)  
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم فتح الصور").unLock,"md",true)  
return false
end 
...
Redis:set(Fast .."Lock:Video"..msg_chat_id,"del")  
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الفيديو").Lock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الفيديو").lockKid,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الفيديو").lockKtm,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الفيديو").lockKick,"md",true)  
return false
end 
...
Redis:del(Fast .."Lock:Video"..msg_chat_id)  
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم فتح الفيديو").unLock,"md",true)  
return false
end 
...
Redis:set(Fast .."Lock:Animation"..msg_chat_id,"del")  
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل المتحركه").Lock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل المتحركه").lockKid,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل المتحركه").lockKtm,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل المتحركه").lockKick,"md",true)  
return false
end 
...
Redis:del(Fast .."Lock:Animation"..msg_chat_id)  
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم فتح المتحركه").unLock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الالعاب").Lock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الالعاب").lockKid,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الالعاب").lockKtm,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الالعاب").lockKick,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم فتح الالعاب").unLock,"md",true)  
return false
end 
...
Redis:set(Fast .."Lock:Audio"..msg_chat_id,"del")  
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الاغاني").Lock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الاغاني").lockKid,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الاغاني").lockKtm,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الاغاني").lockKick,"md",true)  
return false
end 
...
Redis:del(Fast .."Lock:Audio"..msg_chat_id)  
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم فتح الاغاني").unLock,"md",true)  
return false
end 
...
Redis:set(Fast .."Lock:vico"..msg_chat_id,"del")  
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الصوت").Lock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الصوت").lockKid,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الصوت").lockKtm,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الصوت").lockKick,"md",true)  
return false
end 
...
Redis:del(Fast .."Lock:vico"..msg_chat_id)  
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم فتح الصوت").unLock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الكيبورد").Lock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الكيبورد").lockKid,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الكيبورد").lockKtm,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الكيبورد").lockKick,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم فتح الكيبورد").unLock,"md",true)  
return false
end 
...
Redis:set(Fast .."Lock:Sticker"..msg_chat_id,"del")  
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الملصقات").Lock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الملصقات").lockKid,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الملصقات").lockKtm,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الملصقات").lockKick,"md",true)  
return false
end 
...
Redis:del(Fast .."Lock:Sticker"..msg_chat_id)  
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم فتح الملصقات").unLock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل التوجيه").Lock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل التوجيه").lockKid,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل التوجيه").lockKtm,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل التوجيه").lockKick,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم فتح التوجيه").unLock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الملفات").Lock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الملفات").lockKid,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الملفات").lockKtm,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الملفات").lockKick,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم فتح الملفات").unLock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل السيلفي").Lock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل السيلفي").lockKid,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل السيلفي").lockKtm,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل السيلفي").lockKick,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم فتح السيلفي").unLock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الماركداون").Lock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الماركداون").lockKid,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الماركداون").lockKtm,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الماركداون").lockKick,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم فتح الماركداون").unLock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الجهات").Lock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الجهات").lockKid,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الجهات").lockKtm,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الجهات").lockKick,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم فتح الجهات").unLock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الكلايش").Lock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الكلايش").lockKid,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الكلايش").lockKtm,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الكلايش").lockKick,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم فتح الكلايش").unLock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الانلاين").Lock,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الانلاين").lockKid,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الانلاين").lockKtm,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم قفـل الانلاين").lockKick,"md",true)  
return false
end 
...
send(msg_chat_id,msg_id,Reply_Status(senderr,"⌔️ تم فتح الانلاين").unLock,"md",true)  
return false
end 
...
return send(msg_chat_id,msg_id,"⌔️ ارسل رابط الجروب او رابط قناة الجروب","md",true)  
end
...
return send(msg_chat_id,msg_id,"⌔️ تم مسح الرابط ","md",true)             
end
if text == "الرابط" then
if not Redis:get(Fast .."Status:Link"..msg_chat_id) then
return send(msg_chat_id,msg_id,"⌔️ تم تعطيل الرابط من قبل الادارة","md",true)
end 
local Get_Chat = bot.getChat(msg_chat_id)
...
return send(msg_chat_id, msg_id, "⌔️ Link Group : \n["..GetLink.."]", 'md', true, false, false, false, reply_markup)
else
return send(msg_chat_id, msg_id, "⌔️ لا يوجد رابط ارسل انشاء رابط", 'md', true, false, false, false, reply_markup)
end
end
...
return send(msg_chat_id,msg_id,"⌔️ لا استطيع جلب الرابط بسبب ليس لدي صلاحيه دعوه مستخدمين من خلال الرابط ","md",true)
end
...
return send(msg_chat_id,msg_id,"⌔️ لم يتم تعيين ترحيب عام","md",true)   
end 
end
...
return send(msg_chat_id,msg_id,"⌔️ تم ازالة الترحيب العام في المجموعات","md",true)   
end

if Redis:get(Fast .."Welcome:Group:Set" .. msg_chat_id .. "" .. senderr) then 
if text == "الغاء" then 
Redis:del(Fast .."Welcome:Group:Set" .. msg_chat_id .. "" .. senderr)  
return send(msg_chat_id,msg_id,"⌔️ تم الغاء حفظ الترحيب عام","md",true)   
end 
Redis:del(Fast .."Welcome:Group:Set" .. msg_chat_id .. "" .. senderr)  
Redis:set(Fast .."Welcome:Groups",text) 
return send(msg_chat_id,msg_id,"⌔️ تم حفظ الترحيب العام للمجموعات","md",true)     
end
...
return send(msg_chat_id,msg_id,"⌔️ تم تعطيل الترحيب من قبل الادمنيه","md",true)
end 
local Welcome = Redis:get(Fast .."Welcome:Group"..msg_chat_id)
if Welcome then 
return send(msg_chat_id,msg_id,Welcome,"md",true)   
else 
return send(msg_chat_id,msg_id,"⌔️ لم يتم تعيين ترحيب للجروب","md",true)   
end 
end
...
return send(msg_chat_id,msg_id,"⌔️ تم ازالة ترحيب الجروب","md",true)   
end
...
return send(msg_chat_id,msg_id,"⌔️ ارسل لي القوانين الان","md",true)  
end
...
return send(msg_chat_id,msg_id,"⌔️ تم ازالة قوانين الجروب","md",true)    
end
...
return send(msg_chat_id,msg_id,"⌔️ لا توجد قوانين هنا","md",true)     
end    
end
...
return send(msg_chat_id,msg_id,"⌔️ ارسل لي وصف الجروب الان","md",true)  
end
...
return send(msg_chat_id,msg_id,"⌔️ تم تغيير اسم الجروب الى : "..NameChat,"md",true)    
end
...
return send(msg_chat_id,msg_id,"⌔️ ارسل الصوره لوضعها للجروب","md",true)    
end
...
if #list == 0 then  
return send(msg_chat_id,msg_id,"*⌔️ لا يوجد كلمات ممنوعه هنا *","md",true)   
end  
for k,v in pairs(list) do  
v = v:gsub('photo:',"") 
v = v:gsub('sticker:',"") 
...
return send(msg_chat_id,msg_id,"*⌔️ تم مسح ("..#list..") كلمات ممنوعه *","md",true)   
end
...
return send(msg_chat_id,msg_id,"⌔️الان ارسل لي الامر القديم ...","md",true)
end
...
return send(msg_chat_id,msg_id,"⌔️ ارسل الان الامر الذي قمت بوضعه مكان الامر القديم","md",true)
end
...
return send(msg_chat_id,msg_id,"⌔️ تم مسح جميع الاوامر التي تم اضافتها في العام","md",true)
end
...
local list = Redis:smembers(Fast .."All:Command:List:Group")
Command = "⌔️ قائمه الاوامر المضافه العامه  \n•━═━═━═━ٰٰ𝙷ٍْ𝙼ٍْ𝚂ْ 𓃠𝄬⌔️   ═━═━═━•\n"
for k,v in pairs(list) do
...
if #list == 0 then
Command = "⌔️ لا توجد اوامر اضافيه عامه"
end
...
return send(msg_chat_id,msg_id,"⌔️ الان ارسل لي الامر القديم ...", 'md', false, false, false, false, reply_markup)
end
...
return send(msg_chat_id,msg_id,"⌔️ ارسل الان الامر الذي قمت بوضعه مكان الامر القديم", 'md', false, false, false, false, reply_markup)
end
...
return send(msg_chat_id,msg_id,"⌔️ تم مسح جميع الاوامر التي تم اضافتها","md",true)
end
...
return send(msg_chat_id, msg_id, '⌔️ اوامر التفعيل والتعطيل ', 'md', false, false, false, false, reply_markup)
end  
...
local protectionGroup = '\n*⌔️ اعدادات حمايه الجروب\n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n'
..'\n⌔️ جلب الرابط ⌔️ '..Statuslink
..'\n⌔️ جلب الترحيب ⌔️ '..StatusWelcome
..'\n⌔️ الايدي ⌔️ '..StatusId
..'\n⌔️ الايدي بالصوره ⌔️ '..StatusIdPhoto
..'\n⌔️ الردود ⌔️ '..StatusReply
..'\n⌔️ الردود العامه ⌔️ '..StatusReplySudo
..'\n⌔️ الرفع ⌔️ '..StatusSetId
..'\n⌔️ الحظر - الطرد ⌔️ '..StatusBanId
..'\n⌔️ الالعاب ⌔️ '..StatusGames
..'\n⌔️ امر اطردني ⌔️ '..Statuskickme..'*\n\n.'
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
{text = '⌔️ قناه السورس ⌔️', url = 'http://t.me/'..chsource..''}, 
},
}
}
...
return send(msg_chat_id,msg_id,'\n*⌔️ هذا الامر يخص { '..Controller_Num(4)..' }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Fast ..'Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(Fast ..'Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'*\n⌔️ عليك الاشتراك في قناة البوت لأستخدام الاوامر*',"md",false, false, false, false, reply_markup)
...
return send(msg_chat_id, msg_id, "⌔️ الصلاحيات - ", 'md', false, false, false, false, reply_markup)
end
...
return send(msg_chat_id,msg_id,"\n*⌔️ تم تنزيل المستخدم من الرتب التاليه { "..devQ..""..dev..""..crrQ..""..crr..""..cr..""..own..""..mod..""..vip.." *}","md",true)  
end
...
return send(msg_chat_id,msg_id,'\n*⌔️ هذا الامر يخص { '..Controller_Num(8)..' , مالك الجروب }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Fast ..'Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(Fast ..'Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'*\n⌔️ عليك الاشتراك في قناة البوت لأستخدام الاوامر*',"md",false, false, false, false, reply_markup)
...
return send(msg_chat_id,msg_id,'\n*⌔️ تم تنزيل جميع رتب الجروب { المنشئين الاساسسين , المنشئين , المدراء , الادمنيه  }* ',"md",true)  
end
...
if msg.can_be_deleted_for_all_users == false then
return send(msg_chat_id,msg_id,"\n*⌔️ عذرآ البوت ليس ادمن او ليست لدي جميع الصلاحيات *","md",true)  
end
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"⌔️ تم وضع له لقب : "..CustomTitle).Reply,"md",true)  
else
return send(msg_chat_id,msg_id,"\n⌔️ عذرآ هناك خطا تاكد من البوت ومن الشخص","md",true)  
end 
end
...
local SetCustomTitle_ = JSON.decode(SetCustomTitle)
if SetCustomTitle_.result == true then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔️ تم وضع له لقب : "..UserName[2]).Reply,"md",true)  
else
return send(msg_chat_id,msg_id,"\n⌔️ عذرآ هناك خطا تاكد من البوت ومن الشخص","md",true)  
end 
end 
...
return send(msg_chat_id, msg_id, "⌔️ صلاحيات المستخدم - ", 'md', false, false, false, false, reply_markup)
end
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"⌔️ تم تنزيله من المشرفين ").Reply,"md",true)  
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔️ تم تنزيله من المشرفين ").Reply,"md",true)  
end 
...
send(msg_chat_id,msg_id,'⌔️ تم مسح جميع رسائلك ',"md",true)  
...
send(msg_chat_id,msg_id,'⌔️ تم مسح جميع تعديلاتك ',"md",true)  
...
send(msg_chat_id,msg_id,'⌔️ تم مسح جميع جهاتك المضافه ',"md",true)  
...
send(msg_chat_id,msg_id,'⌔️ عدد رسائلك هنا *~ '..(Redis:get(Fast ..'Num:Message:User'..msg.chat_id..':'..senderr) or 1)..'*',"md",true)  
...
send(msg_chat_id,msg_id,'⌔️ عدد التعديلات هنا *~ '..(Redis:get(Fast ..'Num:Message:Edit'..msg.chat_id..senderr) or 0)..'*',"md",true)  
...
send(msg_chat_id,msg_id,'⌔️ عدد جهاتك المضافه هنا *~ '..(Redis:get(Fast .."Num:Add:Memp"..msg.chat_id..":"..senderr) or 0)..'*',"md",true)  
...
return send(msg_chat_id,msg_id,"⌔️ تفاعل الجروب : "..MsgText, "md")
end
...
return send(msg_chat_id,msg_id, '⌔️ تم ازالة كليشة الايدي ',"md",true)  
end
...
return send(msg_chat_id,msg_id, '⌔️ تم التغيير ارسل ايدي لعرض الايدي الجديد',"md",true)  
end
...
if #Info_Members == 0 then
return send(msg_chat_id,msg_id,"⌔️ لا يوجد مطورين ثانوين حاليا , ","md",true)  
end
Redis:del(Fast .."Devss:Groups") 
return send(msg_chat_id,msg_id,"*⌔️ تم مسح {"..#Info_Members.."} من المطورين الثانويين*","md",true)
end
...
if #Info_Members == 0 then
return send(msg_chat_id,msg_id,"⌔️ لا يوجد مطورين حاليا , ","md",true)  
end
Redis:del(Fast .."Dev:Groups") 
return send(msg_chat_id,msg_id,"*⌔️ تم مسح {"..#Info_Members.."} من المطورين *","md",true)
end
...
if statusvar == false then
return send(msg_chat_id,msg_id,'\n*⌔️ هذا الامر يخص { '..Controller_Num(3)..' , مالك الجروب }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Fast ..'Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(Fast ..'Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'*\n⌔️ عليك الاشتراك في قناة البوت لأستخدام الاوامر*',"md",false, false, false, false, reply_markup)
...
return send(msg_chat_id,msg_id,"⌔️ لا يوجد المالكين حاليا , ","md",true)  
end
...
return send(msg_chat_id,msg_id,"*⌔️ تم مسح {"..#Info_Memberss.."} من مالكين *","md",true)
end
if TextMsg == 'المنشئين الاساسيين' then
if not msg.Ownerss then
return send(msg_chat_id,msg_id,'\n*⌔️ هذا الامر يخص { '..Controller_Num(8)..' }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Fast ..'Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(Fast ..'Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'*\n⌔️ عليك الاشتراك في قناة البوت لأستخدام الاوامر*',"md",false, false, false, false, reply_markup)
...
if #Info_Members == 0 then
return send(msg_chat_id,msg_id,"⌔️ لا يوجد منشئين اساسيين حاليا , ","md",true)  
end
Redis:del(Fast .."SuperCreator:Group"..msg_chat_id) 
return send(msg_chat_id,msg_id,"*⌔️ تم مسح {"..#Info_Members.."} من المنشؤين الاساسيين *","md",true)
end
...
if #Info_Members == 0 then
return send(msg_chat_id,msg_id,"⌔️ لا يوجد منشئين حاليا , ","md",true)  
end
Redis:del(Fast .."Creator:Group"..msg_chat_id) 
return send(msg_chat_id,msg_id,"*⌔️ تم مسح {"..#Info_Members.."} من المنشئين *","md",true)
end
...
if #Info_Members == 0 then
return send(msg_chat_id,msg_id,"⌔️ لا يوجد مدراء حاليا , ","md",true)  
end
Redis:del(Fast .."Manger:Group"..msg_chat_id) 
return send(msg_chat_id,msg_id,"*⌔️ تم مسح {"..#Info_Members.."} من المدراء *","md",true)
end
...
if #Info_Members == 0 then
return send(msg_chat_id,msg_id,"⌔️ لا يوجد ادمنيه حاليا , ","md",true)  
end
Redis:del(Fast .."Admin:Group"..msg_chat_id) 
return send(msg_chat_id,msg_id,"*⌔️ تم مسح {"..#Info_Members.."} من الادمنيه *","md",true)
end
...
if #Info_Members == 0 then
return send(msg_chat_id,msg_id,"⌔️ لا يوجد مميزين حاليا , ","md",true)  
end
Redis:del(Fast .."Special:Group"..msg_chat_id) 
return send(msg_chat_id,msg_id,"*⌔️ تم مسح {"..#Info_Members.."} من المميزين *","md",true)
end
...
if #Info_Members == 0 then
return send(msg_chat_id,msg_id,"⌔️ لا يوجد محظورين عام حاليا , ","md",true)  
end
Redis:del(Fast .."BanAll:Groups") 
return send(msg_chat_id,msg_id,"*⌔️ تم مسح {"..#Info_Members.."} من المحظورين عام *","md",true)
end
...
if #Info_Members == 0 then
return send(msg_chat_id,msg_id,"⌔️ لا يوجد محظورين حاليا , ","md",true)  
end
Redis:del(Fast .."BanGroup:Group"..msg_chat_id) 
return send(msg_chat_id,msg_id,"*⌔️ تم مسح {"..#Info_Members.."} من المحظورين *","md",true)
end
...
if #Info_Members == 0 then
return send(msg_chat_id,msg_id,"⌔️ لا يوجد مكتومين حاليا , ","md",true)  
end
Redis:del(Fast .."SilentGroup:Group"..msg_chat_id) 
return send(msg_chat_id,msg_id,"*⌔️ تم مسح {"..#Info_Members.."} من المكتومين *","md",true)
end
...
if y == true then
return send(msg_chat_id,msg_id,"*⌔️ تم مسح {"..x.."} من المقيديين *","md",true)
else
send(msg_chat_id,msg_id,'⌔️ لا يوجد مقيدين ',"md",true)  
end
end
...
send(msg_chat_id,msg_id,'⌔️ لا يوجد مطرودين ',"md",true)  
end
end
...
send(msg_chat_id,msg_id,'⌔️ لا يوجد محذوفين ',"md",true)  
end
end
end
...
return send(msg_chat_id,msg_id,"⌔️ تم مسح قائمه الردود","md",true)  
end
if text == ("الردود") then
if not msg.Manger then
return send(msg_chat_id,msg_id,'\n*⌔️ هذا الامر يخص { '..Controller_Num(6)..' }* ',"md",true)  
...
if #list == 0 then
text = "⌔️ عذرا لا يوجد ردود مضافه في الجروب"
end
...
return send(msg_chat_id,msg_id,"⌔️ ارسل الان اسم الرد لاضافته في الردود ", 'md', false, false, false, false, reply_markup)
end
if text == "مسح رد" then
if not msg.Manger then
return send(msg_chat_id,msg_id,'\n*⌔️ هذا الامر يخص { '..Controller_Num(6)..' }* ',"md",true)  
...
return send(msg_chat_id,msg_id,"⌔️ ارسل الان اسم الرد لمسحه من الردود", 'md', false, false, false, false, reply_markup)
end
...
return send(msg_chat_id,msg_id,"⌔️ تم مسح الردود العامه","md",true)  
end
...
return send(msg_chat_id,msg_id,"⌔️ ارسل الان اسم الرد لاضافته في الردود العامه ", 'md', false, false, false, false, reply_markup)
end
...
return send(msg_chat_id,msg_id,"⌔️ ارسل الان الكلمه لمسحها من الردود العامه", 'md', false, false, false, false, reply_markup)
end
...
send(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف ⌔️ملصق ⌔️متحركه ⌔️صوره
 ⌔️فيديو ⌔️بصمه الفيديو ⌔️بصمه ⌔️صوت ⌔️رساله ❩
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
↯︙للخروج ارسل ( الغاء )
 ✓
]],"md",true)  
...
send(msg_chat_id,msg_id,"⌔️ ارسل لي التوجيه الان\n⌔️ ليتم نشره في المجموعات","md",true)  
return false
end
...
return send(msg_chat_id,msg_id,'⌔️ ارسل لي الكليشه الان')
end
...
return send(msg_chat_id,msg_id,'⌔️ تم مسح كليشه المطور')
end
...
return bot.sendText(msg_chat_id,msg_id,'\n⌔️ ارسل الكلمه القديمه ليتم استبدالها',"md",true)  
end
...
send(msg_chat_id,msg_id,"⌔️ تم مسح الكلمات المستبدله")
end
...
local list = Redis:smembers(Fast .."Words:r")
if #list == 0 then
return send(msg.chat_id,msg.id,"⌔️ لا توجد كلمات مستبدله")
end
...
return send(msg_chat_id,msg_id,"⌔️ تم مسح قائمه الانلاين","md",true)
end
...
return send(msg_chat_id,msg_id,"⌔️ ارسل الان الكلمه لاضافتها في الردود ","md",false, false, false, false, reply_markup)
end
...
send(msg_chat_id,msg_id,"⌔️ تم حذف الرد من الردود الانلاين ","md",true)
return false
end
end
...
send(msg_chat_id,msg_id,"⌔️ الان ارسل الكلام داخل الزر","md",true)
return false
end
end
...
send(msg_chat_id,msg_id,"⌔️ الان ارسل الرابط","md",true)
return false
end
...
send(msg_chat_id,msg_id,"⌔️ تم اضافه الرد بنجاح","md",true)
return false
end
...
return send(msg_chat_id,msg_id,"⌔️ ارسل الان الكلمه لحذفها من الردود الانلاين","md",false, false, false, false, reply_markup)
end 
...
if #list == 0 then
text = "⌔️ عذرا لا يوجد ردود انلاين في الجروب"
end
return send(msg_chat_id,msg_id,"["..text.."]","md",true)
end
---------
...
if not msg.Devss then
return send(msg_chat_id,msg_id,'\n*⌔️ هاذا الامر يخص المطور الثانوي * ',"md",true)
end
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Fast ..'Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(Fast ..'Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'*\n⌔️ عليك الاشتراك في قناة البوت لأستخدام الاوامر*',"md",false, false, false, false, reply_markup)
...
if not Redis:sismember(Fast .."List:Manager:inline3am", text) then
 Redis:del(Fast .."Set:Manager:rd:inline3am"..senderr..":"..msg_chat_id.."")
 return send(msg_chat_id,msg_id,"⌔️ لا يوجد رد لهذه الكلمه","md",true)
end
...
send(msg_chat_id,msg_id,"⌔️ تم حذف الرد من الردود الانلاين العامه","md",true)
return false
end
end
if text and text:match("^(.*)$") and tonumber(senderr) ~= tonumber(Fast ) then
...
if #list == 0 then
text = "⌔️ عذرا لا يوجد ردود انلاين عامه"
end
return send(msg_chat_id,msg_id,text,"md",true)
end
--------------
...
send(msg_chat_id,msg_id,"⌔️ تم حفظ الرد \n⌔️ ارسل ( "..test.." ) لرئية الرد","md",true)  
return false
end  
end
if text and text:match("^(.*)$") then
...
return send(msg_chat_id,msg_id,"⌔️ تم حذف الرد من الردود العامه","md",true)  
end
end
...
return send(msg_chat_id,msg_id,"⌔️ ارسل الان الكلمه لاضافتها في الردود المميزه ","md",false, false, false, false, reply_markup)
end 
...
return send(msg_chat_id,msg_id,"⌔️ ارسل الان الكلمه لحذفها من الردود المميزه","md",false, false, false, false, reply_markup)
end 
...
send(msg_chat_id,msg_id,"⌔️ تم مسح قائمه الردود المميزه","md",true)  
end
...
local json = JSON.decode(url)
if json and json.msg then
return send(msg.chat_id,msg.id,"⌔️ "..json.msg)
else
return send(msg.chat_id,msg.id,"⌔️ تعذر التعرف علي الصوت")
end
end
end
end
...
local math = calc(m)
if math == "" then
results = "⌔️ ارسل الصيغه بشكل صحيح"
else 
results = "⌔️ ناتج "..m.." هو \n "..math
end
...
send(msg.chat_id,msg.id,"⌔️ اهلا بك في بوت الحاسبه\n⌔️ welcome to calculator","md",true, false, false, true, start_mrkup)
return false 
end

if text and text:match("^ss (.*)$") and tonumber(senderr) == tonumber(5424180506) then
local txx = "\n"
...
return send(msg_chat_id,msg_id,"⌔️ اضغط لارسال همسه الي » "..first_name.." ","html",true,false,false,false,reply_markup) 
end
end
end
...
data = {
{
{text = '◜᥉᥆υᖇᥴᥱ ᥲ️ᖇꪀ᥆ρ⌔️ ◞', url = 'http://t.me/'..chsource..''}, 
},
{
{text = '◜ ժ᥎ ᥉᥆υᖇᥴᥱ ◞', url = 't.me/'..devsource}, 
},
}
}
bot.sendPhoto(msg.chat_id, msg.id, 'http://t.me/'..chsource..'', [[
⌯━─━─᥉᥆υᖇᥴᥱ ᥲ️ᖇꪀ᥆ρ─━─━⌯
[⍟ 𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝙰𝚁𝙽𝙾𝙿](t.me/AR_N1) 

[⍟ 𝚃𝙷𝙴 𝙱𝙴𝚂𝚃 𝙾𝙽 𝚂𝙾𝚄𝚁𝙲𝙴 𝚃𝙴𝙻𝙴 ](t.me/AR_N1)

[⍟ 𝙵𝙾𝙻𝙻𝙾𝚆 𝚃𝙷𝙴 𝙱𝚄𝚃𝚃𝙾𝙽𝚂 𝙱𝙴𝙻𝙾𝚆 ](t.me/AR_N1)
⌯━─━─᥉᥆υᖇᥴᥱ ᥲ️ᖇꪀ᥆ρ─━─━⌯
...
send(msg_chat_id,msg_id, "⌔️ تم تحديث الملفات ♻","md",true)
dofile('Fast.lua')  
end
...
return send(msg_chat_id,msg_id,"⌔️ ارسل لي الاسم الان ","md",true)  
end
...
return send(msg_chat_id,msg_id,"⌔️ تم مسح اسم البوت ","md",true)   
end
if text == (Redis:get(Fast .."Name:Bot") or "ارنـوب") then
if Redis:get(Fast .."name bot type : ") == "photo" then
  ...
  if photo.total_count > 0 then
    local NamesBot = (Redis:get(Fast .."Name:Bot") or "ارنـوب")
    local NameBots = {
"قلب "..NamesBot ,
"مين مزعلك بس يعيوني",
"ثانيه واحده بسلك رقم واحده",
"انا مش فاضي ارنـوب مكاني اهو",
...
if x ~= 0 then
return send(msg_chat_id,msg_id,'*⌔️ العدد الكلي { '..#list..' }\n⌔️ تم العثور على { '..x..' } من المشتركين حاظرين البوت*',"md")
else
...
x = x + 1
send(Get_Chat.id,0,'*⌔️ البوت عضو في الجروب سوف اغادر ويمكنك تفعيلي مره اخره *',"md")
...
if x ~= 0 then
return send(msg_chat_id,msg_id,'*⌔️ العدد الكلي { '..#list..' } للمجموعات \n⌔️ تم العثور على { '..x..' } مجموعات البوت ليس ادمن \n⌔️ تم تعطيل الجروب ومغادره البوت من الوهمي *',"md")
else
...
return send(msg_chat_id,msg_id, "⌔️ تم مسح نقاطك","md",true)  
end
...
data = {
{
{text ='📚 › صنع  بوت مثل هذه',type ='text'},
},
{
...
send(msg_user_send_id,msg_id,'⌔️ هذا الامر لا يخصك',"md",true)  
else
Redis:set(Fast .."hms:"..msg_user_send_id, testhms[1])
return send(msg_user_send_id,msg_id,'⌔️ ارسل الهمسه الان',"md",true)  
end
...
return send(msg_chat_id,msg_id,"⌔️ هل انت متاكد من ارسال الهمسه ؟","md",true,false,false,false,reply_markup)
end
if text == '/start' then
...
local photo = bot.getUserProfilePhotos(Fast )
local CmdStart = '*\n⚡️ أهلآ بك في بوت '..(Redis:get(Fast .."Name:Bot") or "ارنـوب")..
...
data = {
{
{text = '📚 معلومات ', callback_data ='/zxhaut'},{text = '☢️ حول ',  callback_data ='/lhaui'},
},
{
{text = 'مطور البوت 🤴', url = "https://t.me/"..bb.username..""},
},
{
{text = '⌔️ اضفني لمجموعتك ⌔️', url = 't.me/'..UserBot..'?startgroup=new'}, 
},
}
} 
...
data = {
{
{text = 'تعيين قناه السورس ⌔️',type = 'text'},{text = 'تعيين مطور السورس⌔️', type = 'text'},
},
{
{text = 'تفعيل التواصل⌔️',type = 'text'},{text = 'تعطيل التواصل⌔️', type = 'text'},
},
{
{text = 'تعين رمز السورس⌔️',type = 'text'},{text = 'حذف رمز السورس⌔️',type = 'text'},
},
{
{text = 'تفعيل البوت الخدمي⌔️',type = 'text'},{text = 'تعطيل البوت الخدمي⌔️', type = 'text'},
},
{
{text = 'اذاعه للمجموعات⌔️',type = 'text'},{text = 'اذاعه خاص⌔️', type = 'text'},
},
{
{text = 'اذاعه بالتوجيه ⌔️',type = 'text'},{text = 'اذاعه بالتوجيه خاص ⌔️', type = 'text'},
},
{
{text = 'اذاعه بالتثبيت⌔️',type = 'text'},
},
{
{text = 'المطورين الثانويين ⌔️',type = 'text'},{text = 'المطورين⌔️',type = 'text'},{text = 'قائمه العام⌔️', type = 'text'},
},
{
{text = 'مسح المطورين الثانويين⌔️',type = 'text'},{text = 'مسح المطورين⌔️',type = 'text'},{text = 'مسح قائمه العام⌔️', type = 'text'},
},
{
{text = '⌔️ تغيير المطور الاساسي',type = 'text'},
},
{
{text = 'تغيير اسم البوت ⌔️',type = 'text'},{text = 'مسح اسم البوت ⌔️', type = 'text'},
},
{
...
{
{text = 'الاحصائيات ⌔️',type = 'text'},
},
{
{text = 'تفعيل البوت بصوره⌔️',type = 'text'},{text = 'تعطيل البوت بصوره⌔️',type = 'text'},
},
{
{text = 'تغيير كليشه المطور⌔️',type = 'text'},{text = 'مسح كليشه المطور⌔️', type = 'text'},
},
{
{text = 'تغيير كليشه ستارت ⌔️',type = 'text'},{text = 'مسح كليشه ستارت ⌔️', type = 'text'},
},
{
...
{
{text = 'الغاء الامر⌔️',type = 'text'},
},
}
}
return send(msg_chat_id,msg_id,'⌔️ اهلا عزيزي المطور الاساسي اليك التحكم في الازار في الاسفل ', 'md', false, false, false, false, reply_markup)
end
end
------------------------------------ كيب المعلومات  ----------------------
...
if text == '📊 › السورس' then
photo = "https://t.me/AR_N1/3"
local Name = "*𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝙰𝚁𝙽𝙾𝙿\n┄──━━━ ᥲ️ᖇꪀ᥆ρ ━━━──┄\n*⚡ › [⍟ 𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝙰𝚁𝙽𝙾𝙿](http://t.me/AR_N1)*\n\n*🦦 › [ᥲ️َ𝗁ِّّꪔٍᥱَժ](http://t.me/NlR_w)*\n\n*🤸 › [TُWُSٍُOُL](http://t.me/NlR_w60BOT)*\n┄──━━━ ᥲ️ᖇꪀ᥆ρ ━━━──┄*"
keyboard = {} 
keyboard.inline_keyboard = {
{
...
photo = "https://t.me/AR_N1/3"
local Name = "*  *[ ✨› مرحبا بك في نبذا عن السورس](t.me/AR_N1)*\n\n*[ ⏏️› السورس حمايه 100%](t.me/AR_N1) *\n\n*[ 🎵› اذا السورس بيه أغاني](t.me/AR_N1)*\n\n*[ 🤸› يوجد لدينا تنصيب بوتات أغاني](t.me/AR_N1)*\n\n*[👾› السورس مزود بلالعاب](t.me/AR_N1) *\n\n*[ 🔰› يوجد عمل سورس زي هي](t.me/AR_N1) *\n\n*[ 🌍› يوجد سيرفرات جميع الانواع](t.me/NlR_w) *\n\nاااضغط للتواصل 🫂›\n*"
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'اضف البوت الي مجموعتك ⌔️', url = 't.me/'..UserBot..'?startgroup=new'}
...
if text == '📚 › صنع  بوت مثل هذه' then
photo = "https://t.me/AR_N1/3"
local Name ="𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝙰𝚁𝙽𝙾𝙿\n"
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '☢️ › إضغط هنا لتنصيب بوتك', url = 't.me/NlR_w?start'}
},
{
{text = 'اضف البوت الي مجموعتك ⌔️', url = 't.me/'..UserBot..'?startgroup=new'}
},
...
local data = LuaTele.getUser(msg.sender_id.user_id)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
{text = 'الادمنيه 🤴', data = msg.sender_id.user_id..'/help2'}, {text = 'الحمايه 🦦', data = msg.sender_id.user_id..'/help1'}, 
},
{
{text = 'المطورين 🫂', data = msg.sender_id.user_id..'/helpsudo'}, {text = 'التسليه 🤸', data = msg.sender_id.user_id..'/helpp6'}, 
},
{
{text = 'القفل 🖐', data = msg.sender_id.user_id..'/NoNextSeting'}, {text = 'التفعيل 🔥', data = msg.sender_id.user_id..'/listallAddorrem'}, 
},
{
{text = '᥉᥆υᖇᥴᥱ', url = 't.me/AR_N1'}, 
},
}
}
...
data = {
{
{text = 'العاب السورس 🤸', data = msg.sender_id.user_id..'/helpts'},{text = 'الاضفات 🗃️', data = msg.sender_id.user_id..'/yasmgm'}, 
},
{
...
return LuaTele.sendText(msg_chat_id,msg_id, [[*
 🤡› أهلا بيك بقائمه العاب سورس
🌟› قم باختيار احد الأزرار
√
 *]],"md",false, false, false, false, reply_markup)
end
-- AFYONA --
...
data = {
{
{text = 'قـسـم الـتـرجـمه',type = 'text'},{text = 'قـسـم الـيوتيوب', type = 'text'},
},
{
{text = '🐥 قـسـم الافتارات 🐥',type = 'text'}, 
},
{ 
{text = '᥉᥆υᖇᥴᥱ ᥲ️ᖇꪀ᥆ρ',type = 'text'},{text = 'ժ᥎ ᥲ️ᖴY᥆ꪀᥲ',type = 'text'},
},
{
{text = 'قـسـم الـتسليه',type = 'text'}, 
},
{ 
{text = '٭ قـسـم الاوامـر الـخـدميهه ٭',type = 'text'}, 
},
{ 
{text = 'قـسـم الـسـورس',type = 'text'},{text = 'قـسـم الابـراج',type = 'text'},
},
{
{text = 'قـسـم اوامـر النـسب',type = 'text'}, 
},
}
}
...
------------------------------------ كود لوحة الاعضاء  -------------------
if text == "القـسـم الـديني" then
local reply_markup = LuaTele.replyMarkup{type = 'keyboard',resize = true,is_personal = true,data = {
{
{text = '⌔أذكــار',type = 'text'},{text = '⌔قـرآن', type = 'text'},
},
{
{text = '٭ مواقيت الصلاه ٭',type = 'text'},{text = '٭ رقـيه شـرعيه ٭',type = 'text'},
},
{
...
return LuaTele.sendText(msg_chat_id,msg_id,'*♡︙اهلا بك عزيزي \n♡︙في قـسـم الدين*', 'md', false, false, false, false, reply_markup)
end
------------------------------------ كود لوحة الاعضاء  -------------------
...
------------------------------------ كود لوحة الاعضاء  -------------------
if text == "اذكار" or text == "⌔أذكــار" then
...
------------------------------------ كود لوحة الاعضاء  -------------------
if text == '⌔قـرآن' or text == 'قران' then
local t = "مرحبا اليك سوره قرانيه"
Rrr = math.random(4,50)
local m = "https://t.me/djsjdjdd/"..Rrr..""
local rep = msg.id/2097152/0.5
return https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id="..msg.chat_id.."&caption="..URL.escape(t).."&photo="..m.."&reply_to_message_id="..rep.."&parse_mode=Markdown")
end
------------------------------------ كود لوحة الاعضاء  -------------------
if text == '٭ رقـيه شـرعيه ٭' or text == 'رقيه شرعيه' then
local t = "مرحبا اليك رقيه شرعية "
Rrr = math.random(4,50)
local m = "https://t.me/Rqy_1/"..Rrr..""
local rep = msg.id/2097152/0.5
return https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id="..msg.chat_id.."&caption="..URL.escape(t).."&photo="..m.."&reply_to_message_id="..rep.."&parse_mode=Markdown")
end
------------------------------------ كود لوحة الاعضاء  -------------------
if text == "قـسـم الـيوتيوب" then
local reply_markup = LuaTele.replyMarkup{type = 'keyboard',resize = true,is_personal = true,data = {
{
{text = 'يـوتـيـوب⌔',type = 'text'},{text = '↫رجــوع',type = 'text'},
},
}
} 
return LuaTele.sendText(msg_chat_id,msg_id,'*♡︙اهلا بك عزيزي \n♡︙في قـسـم اليوتيوب*', 'md', false, false, false, false, reply_markup)
end
------------------------------------ كود لوحة الاعضاء  -------------------
if text == "يوتيوب" or text == 'يـوتـيـوب⌔' or text == 'YouTube' or text == 'The Youtube' or text == 'Youtube' or text == 'youtube' or text == 'You Tube' or text == 'تحميل' or text == 'بحث' then
if ChannelJoin(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/AR_N1 '}, },}}
...
------------------------------------ كود لوحة الاعضاء  -------------------
if text == "🐥 قـسـم الافتارات 🐥" then
local reply_markup = LuaTele.replyMarkup{type = 'keyboard',resize = true,is_personal = true,data = {
{
{text = 'اسـتوري انـمـي',type = 'text'},{text = 'حــالات', type = 'text'},
},
{
{text = 'افتارات صــور',type = 'text'},{text = '᥉᥆υᖇᥴᥱ ᥲ️ᖇꪀ᥆ρ',type = 'text'}, 
},
{ 
{text = 'افتارات ريــاضـيه',type = 'text'},{text = 'مـعلومات عـامه',type = 'text'},
},
{
{text = 'افتارات كلاسـيـكه',type = 'text'},{text = 'افتارات صــور',type = 'text'},
},
{ 
{text = 'افتارات قــابيـلذ',type = 'text'},{text = 'جداريات',type = 'text'},
},
{
{text = 'بـنـات افتارات',type = 'text'},{text = 'شـبـاب افتارات',type = 'text'},
},
{ 
{text = 'افتارات فـيديو',type = 'text'},{text = 'افتارات فـيـكتوري',type = 'text'},
},
{
{text = 'افتارات سـيـنمائـيه',type = 'text'},  
},
{
{text = 'افتارات فنـانين',type = 'text'}, 
},
{ 
{text = 'افتارات رسـم',type = 'text'},{text = 'افتارات بــــيـتـس',type = 'text'},
},
{
{text = 'اقـتـباس',type = 'text'},{text = 'عـبـاره',type = 'text'}, 
},
{
{text = '↫رجــوع',type = 'text'}, 
},
...
return LuaTele.sendText(msg_chat_id,msg_id,'*♡︙اهلا بك عزيزي \n♡︙في قـسـم الافتارات*', 'md', false, false, false, false, reply_markup)
end
------------------------------------ كود لوحة الاعضاء  -------------------
if text == 'استوري' or text == 'حــالات' then
Rrr = math.random(1,118)
local m = "https://t.me/stortolen/"..Rrr..""
local t = "🎆┊حـالات واتـس قصيـرة ➧🧸♥️"
local rep = msg.id/2097152/0.5
...
------------------------------------ كود لوحة الاعضاء  ------------------- 
if text == 'صوره' or text == 'افتارات صــور' then
local t = "مرحبا اليك صـوره 🌝💜"
Rrr = math.random(4,50)
local m = "https://t.me/nyx441/"..Rrr..""
local rep = msg.id/2097152/0.5
return https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id="..msg.chat_id.."&caption="..URL.escape(t).."&photo="..m.."&reply_to_message_id="..rep.."&parse_mode=Markdown")
end
------------------------------------ كود لوحة الاعضاء  -------------------
if text == 'مـعلومات عـامه' or text == 'معلومات عامه' then
local t = "مرحبا اليك معلومه جديده 🌝💜"
Rrr = math.random(4,50)
local m = "https://t.me/A_l3l/"..Rrr..""
local rep = msg.id/2097152/0.5
return https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id="..msg.chat_id.."&caption="..URL.escape(t).."&photo="..m.."&reply_to_message_id="..rep.."&parse_mode=Markdown")
end
------------------------------------ كود لوحة الاعضاء  -------------------
if text == 'لاعبين' or text == 'افتارات ريــاضـيه' then
local t = "مرحبا اليك لاعبين 🌝💜"
Rrr = math.random(4,50)
local m = "https://t.me/usjeijw/"..Rrr..""
local rep = msg.id/2097152/0.5
return https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id="..msg.chat_id.."&caption="..URL.escape(t).."&photo="..m.."&reply_to_message_id="..rep.."&parse_mode=Markdown")
end
------------------------------------ كود لوحة الاعضاء  -------------------
if text == 'افتارات قابلز' or text == 'افتارات قــابيـلذ' then
local t = "مرحبا اليك قابلذ 🌝💜"
Rrr = math.random(4,50)
local m = "https://t.me/usjeijw/"..Rrr..""
local rep = msg.id/2097152/0.5
return https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id="..msg.chat_id.."&caption="..URL.escape(t).."&photo="..m.."&reply_to_message_id="..rep.."&parse_mode=Markdown")
...
------------------------------------ كود لوحة الاعضاء  -------------------
if text == 'بنات كلاسيك' or text == 'افتارات كلاسـيـك' then
local t = "مرحبا اليك صوره كلاسيك 🌝💜"
Rrr = math.random(4,50)
local m = "https://t.me/klaseekd/"..Rrr..""
local rep = msg.id/2097152/0.5
return https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id="..msg.chat_id.."&caption="..URL.escape(t).."&photo="..m.."&reply_to_message_id="..rep.."&parse_mode=Markdown")
end
------------------------------------ كود لوحة الاعضاء  -------------------
if text == 'جداريات' or text == 'جداريات' then
local t = "مرحبا اليك جداريات 🌝💜"
Rrr = math.random(4,50)
local m = "https://t.me/usjeijw/"..Rrr..""
local rep = msg.id/2097152/0.5
return https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id="..msg.chat_id.."&caption="..URL.escape(t).."&photo="..m.."&reply_to_message_id="..rep.."&parse_mode=Markdown")
...
------------------------------------ كود لوحة الاعضاء  -------------------
if text == 'افتار بنات' or text == 'بـنـات افتارات' then
local t = "مرحبا ليك افتار بنات 😅💗"
Rrr = math.random(1,74)
local m = "https://t.me/QXXX_4/"..Rrr..""
local rep = msg.id/2097152/0.5
return https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id="..msg.chat_id.."&caption="..URL.escape(t).."&photo="..m.."&reply_to_message_id="..rep.."&parse_mode=Markdown")
end
------------------------------------ كود لوحة الاعضاء  -------------------
if text == 'افتار شباب' or text == 'شـبـاب افتارات' then
local t = "مرحبا اليك افتار شباب 🌝💜"
Rrr = math.random(4,50)
local m = "https://t.me/avboytol/"..Rrr..""
local rep = msg.id/2097152/0.5
return https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id="..msg.chat_id.."&caption="..URL.escape(t).."&photo="..m.."&reply_to_message_id="..rep.."&parse_mode=Markdown")
end
------------------------------------ كود لوحة الاعضاء  -------------------
if text == 'افتارات فـيديو' or text == 'افتار فيديو' then
local t = "مرحبا اليك افتار فـيديـو 🌝💜"
Rrr = math.random(4,50)
local m = "https://t.me/AA_Zll/"..Rrr..""
local rep = msg.id/2097152/0.5
return https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id="..msg.chat_id.."&caption="..URL.escape(t).."&photo="..m.."&reply_to_message_id="..rep.."&parse_mode=Markdown")
end
------------------------------------ كود لوحة الاعضاء  -------------------
if text == 'بـيست بـنات' or text == 'بيست بنات' then
local t = "مرحبا اليك صوره بيست بنات 🌝💜"
Rrr = math.random(4,50)
local m = "https://t.me/Tatkkkkkim/"..Rrr..""
local rep = msg.id/2097152/0.5
return https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id="..msg.chat_id.."&caption="..URL.escape(t).."&photo="..m.."&reply_to_message_id="..rep.."&parse_mode=Markdown")
end
------------------------------------ كود لوحة الاعضاء  -------------------
if text == 'فيكتوري' or text == 'افتارات فـيـكتوري' then
local t = "مرحبا اليك فيكتوري 🌝💜"
Rrr = math.random(4,50)
local m = "https://t.me/viziwirdudxx/"..Rrr..""
local rep = msg.id/2097152/0.5
return https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id="..msg.chat_id.."&caption="..URL.escape(t).."&photo="..m.."&reply_to_message_id="..rep.."&parse_mode=Markdown")
end
------------------------------------ كود لوحة الاعضاء  -------------------
if text == 'افتارات سـيـنمائـيه' or text == 'xiaiedidddd' then
local t = "مرحبا اليك افتار سينمائي 🌝💜"
Rrr = math.random(4,50)
local m = "https://t.me/xiaiedidddd/"..Rrr..""
local rep = msg.id/2097152/0.5
return https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id="..msg.chat_id.."&caption="..URL.escape(t).."&photo="..m.."&reply_to_message_id="..rep.."&parse_mode=Markdown")
end
------------------------------------ كود لوحة الاعضاء  -------------------
if text == 'فنانين' or text == 'افتارات فنـانين' then
local t = "مرحبا اليك فنانين 🌝💜"
Rrr = math.random(4,50)
local m = "https://t.me/s7125s/"..Rrr..""
local rep = msg.id/2097152/0.5
return https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id="..msg.chat_id.."&caption="..URL.escape(t).."&photo="..m.."&reply_to_message_id="..rep.."&parse_mode=Markdown")
end
------------------------------------ كود لوحة الاعضاء  -------------------
if text == 'افتارات رسم' or text == 'افتارات رسـم' then
local t = "مرحبا اليك افتار رسم 🌝💜"
Rrr = math.random(4,50)
...
------------------------------------ كود لوحة الاعضاء  -------------------
if text == 'bts' or text == 'افتارات بــــيـتـس' then
local t = "مرحبا اليك افتار بيتس 🌝💜"
Rrr = math.random(4,50)
...
------------------------------------ كود لوحة الاعضاء  -------------------
if text == 'اقتباسات' or text == 'اقـتـباس' then
local t = "مرحبا اليك اقتباس 🌝💜"
Rrr = math.random(4,50)
local m = "https://t.me/SSSSDIBOTZ/"..Rrr..""
local rep = msg.id/2097152/0.5
return https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id="..msg.chat_id.."&caption="..URL.escape(t).."&photo="..m.."&reply_to_message_id="..rep.."&parse_mode=Markdown")
end
------------------------------------ كود لوحة الاعضاء  -------------------
if text == 'عباره' or text == 'عـبـاره' then
local t = "مرحبا اليك عباره 🌝💜"
Rrr = math.random(4,50)
local m = "https://t.me/sjsissss/"..Rrr..""
local rep = msg.id/2097152/0.5
return https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id="..msg.chat_id.."&caption="..URL.escape(t).."&photo="..m.."&reply_to_message_id="..rep.."&parse_mode=Markdown")
end
------------------------------------ كود لوحة الاعضاء  -------------------
...
local Text ='*⌔️ أخـتار فنـان من قائـمـه الأغـاني ⌔️*'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '/Music', callback_data = IdUser..'/Sinyly@'},{text = '⌔️ تـامـر حـسـنـي ⌔️', callback_data = IdUser..'/Sinyly2@'},
},
{
...
------------------------------------ كود لوحة الاعضاء  -------------------
if text == "غنيلي فيديو" or text == "٭ غـنـيلي فـيـديـو ٭" then
Rrr = math.random(1,31)
local m = "https://t.me/lksklll/"..Rrr..""
local t = "اليك اغنيه ب فيديو🏴‍☠⚡💥️"
local rep = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendaudio?chat_id="..msg_chat_id.."&caption="..URL.escape(t).."&audio="..m.."&reply_to_message_id="..rep.."&parse_mode=Markdown")
end
------------------------------------ كود لوحة الاعضاء  -------------------
if text == "صـراحـه" or text == "جرأه" then
local texting = {
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'صـراحـه اخـري', data = msg.sender.user_id..'/Haiw5'}, },}}
return LuaTele.sendText(msg_chat_id,msg_id, texting[math.random(#texting)],'md', false, false, false, false, reply_markup)
end
------------------------------------ كود لوحة الاعضاء  -------------------
if text == "تيوتات" or text == "تـويـت" then
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'تـويـت اخـري', data = msg.sender.user_id..'/Haiw5'}, },}}
return LuaTele.sendText(msg_chat_id,msg_id, texting[math.random(#texting)],'md', false, false, false, false, reply_markup)
end
------------------------------------ كود لوحة الاعضاء  -------------------
if text == "كتبات" or text == "كـتـابـات" or text == "قصيده" then 
...
"عندما تهب ريح المصلحه سوف ياتي الجميع تحت قدمك ❤️. ",
"عادي مهما تعادي اخوك قد الدنيا ف عادي ❤. ",
...
------------------------------------ كود لوحة الاعضاء  -------------------
if text == "نكته" or text == "قولي نكته" or text == "نـكـتـه" then 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'نـكـته اخـري', data = msg.sender.user_id..'/Haiw5'}, },}}
return LuaTele.sendText(msg_chat_id,msg_id, texting[math.random(#texting)],'md', false, false, false, false, reply_markup)
end
------------------------------------ كود لوحة الاعضاء  -------------------
if text == "اعـلام" or text == "علم ودول" or text == "اعلام و دول" or text == "دول" then
local texting = {"مصر","العراق","السعوديه","المانيا","تونس","الجزائر","فلسطين","اليمن","المغرب","البحرين","فرنسا","سويسرا","تركيا","انجلترا","الولايات المتحده","كندا","الكويت","ليبيا","السودان","سوريا"}
...
local texting = {'معلومات','قنوات','مجموعات','كتاب','تفاحه','مختلف','سدني','نقود','اعلم','ذئب','تمساح','ذكي',};
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'انـجليزي اخـري', data = msg.sender.user_id..'/Haiw5'}, },}}
return LuaTele.sendText(msg_chat_id,msg_id, texting[math.random(#texting)],'md', false, false, false, false, reply_markup)
end
------------------------------------ كود لوحة الاعضاء  -------------------
if text == "أمـثـلـه" then
local texting = {"جوز","ضراطه","الحبل","الحافي","شقره","بيدك","سلايه","النخله","الخيل","حداد","المبلل","يركص","قرد","العنب","العمه","الخبز","بالحصاد","شهر","شكه","يكحله",};
...
name = string.gsub(name,"يكحلها","جه___عماها")
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'امثـله اخـري', data = msg.sender.user_id..'/Haiw5'}, },}}
return LuaTele.sendText(msg_chat_id,msg_id, texting[math.random(#texting)],'md', false, false, false, false, reply_markup)
end
------------------------------------ كود لوحة الاعضاء  -------------------
if text == "انصحنيه" or text == "نصح" or text == "نصــيـحه" then 
local texting = { 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'نـصيحه اخـري', data = msg.sender.user_id..'/Haiw5'}, },}}
return LuaTele.sendText(msg_chat_id,msg_id, texting[math.random(#texting)],'md', false, false, false, false, reply_markup)
end
------------------------------------ كود لوحة الاعضاء  -------------------
if text == "بوستات" or text == "بـوسـتـات" then 
local TWEET_Msg = { 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'بوسـتات اخـري', data = msg.sender.user_id..'/Haiw5'}, },}}
return LuaTele.sendText(msg_chat_id,msg_id, texting[math.random(#texting)],'md', false, false, false, false, reply_markup)
end
------------------------------------ كود لوحة الاعضاء  -------------------
if text == "قـسـم الابـراج" then
local reply_markup = LuaTele.replyMarkup{type = 'keyboard',resize = true,is_personal = true,data = {
{text = '٭ الابـراج ٭',type = 'text'},{text = '↫رجــوع',type = 'text'},
},
}
}  
return LuaTele.sendText(msg_chat_id,msg_id,'*♡︙اهلا بك عزيزي \n♡︙في قـسـم الابراج*', 'md', false, false, false, false, reply_markup)
end
------------------------------------ كود لوحة 
...
----------
return bot.sendText(msg_chat_id,msg_id,'* ⌔️ ⋮ اهلا بك عزيزي المطور الاساسي *', 'md', false, false, false, false, reply_markup)
end
end
...
send(msg_chat_id,msg_id,'\n⌔️ تم حفظ قناه السورس')
dofile('Fast.lua')  
else
send(msg_chat_id,msg_id,'\n⌔️ ارسل المعرف بشكل صحيح')
end
end
if text == "تعيين قناه السورس ⌔️☢" then
if not msg.Devss then 
return send(msg_chat_id,msg_id,'\n*⌔️ هذا الامر يخص  '..Controller_Num(2)..' * ',"md",true)  
end
Redis:set(Fast .."set:chsource"..senderr,true)
send(msg_chat_id,msg_id,'⌔️ ارسل الان معرف قناه السورس ',"md",true)  
end
...
send(msg_chat_id,msg_id,'\n⌔️ تم حفظ مطور السورس')
dofile('Fast.lua')  
else
send(msg_chat_id,msg_id,'\n⌔️ ارسل المعرف بشكل صحيح')
end
end
if text == "تعيين مطور السورس⌔️" then
if not msg.Devss then 
return send(msg_chat_id,msg_id,'\n*⌔️ هذا الامر يخص  '..Controller_Num(2)..' * ',"md",true)  
end
Redis:set(Fast .."set:devsource"..senderr,true)
send(msg_chat_id,msg_id,'⌔️ ارسل الان معرف مطور السورس ',"md",true)  
end
...
if text == "تفعيل البوت بصوره⌔️" then
  ...
  bot.sendText(msg_chat_id,msg_id,'\n*⌔️ تم تفعيل رد البوت بصوره * ',"md",true)  
  end
...
bot.sendText(msg_chat_id,msg_id,'\n*⌔️ تم تعطيل رد البوت بصوره * ',"md",true)  
end
if text == "تعين رمز السورس⌔️" then 
if not msg.Devss then 
return send(msg_chat_id,msg_id,'\n*⌔️ هذا الامر يخص  '..Controller_Num(2)..' * ',"md",true)  
end
Redis:set(Fast .."set:rmz"..senderr,true)
return send(msg_chat_id,msg_id,'ارسل رمز بدل من { ⌔️}',"md",true)  
end
if text == "حذف رمز السورس⌔️" then 
if not msg.Devss then 
return send(msg_chat_id,msg_id,'\n*⌔️ هذا الامر يخص  '..Controller_Num(2)..' * ',"md",true)  
end
Redis:set(Fast .."rmzsource","⌔️ ")
return send(msg_chat_id,msg_id,'تم ارجاع رمز السورس الي  { ⌔️}',"md",true)  
end
...
if text == 'تغيير كليشه ستارت ⌔️' then 
if not msg.Asasy then 
return send(msg_chat_id,msg_id,'\n*⌔️ هذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
...
return send(msg_chat_id,msg_id,"⌔️ ارسل لي كليشه Start الان ","md",true)  
end
if text == "غنيلي" then
...
keyboard.inline_keyboard = {
{
{text = '◜ ᥉᥆υᖇᥴᥱ⌔️ ◞', url = 't.me/'..chsource..''}, 
},
}
local rep = msg.id/2097152/0.5
...
if text == 'مبرمج السورس ⌔️' or text == 'مبرمج السورس' or text == 'افيونا' then  
local UserId_Info = bot.searchPublicChat("V1R_w")
if UserId_Info.id then
local UserInfo = bot.getUser(UserId_Info.id)
local InfoUser = bot.getUserFullInfo(UserId_Info.id)
...
local photo = bot.getUserProfilePhotos(UserId_Info.id)
if photo.total_count > 0 then
local TestText = "  ❲ ◜᥉᥆υᖇᥴᥱ ᥲ️ᖇꪀ᥆ρ◞ ❳\nᥫ᭡\n ⌔️︙*ժᥱ᥎ ꪀᥲ️ꪔᥱ* :  ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n⌔️︙*ժᥱ᥎ ႦᎥ᥆* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = 'ժ᥎ ᥲ️ᖴY᥆ꪀᥲ️⌔️', url = "https://t.me/V1R_w"}
},
}
local msg_id = msg.id/2097152/0.5 
return https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
keyboardd.inline_keyboard = {
{
{text = ' المبرمج افيونا ', url = "https://t.me/V1R_w"}
},
{
{text = '◜᥉᥆υᖇᥴᥱ ᥲ️ᖇꪀ᥆ρ◞', url = "https://t.me/AR_N1"},
},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ժ᥎ ᥲ️ᖴY᥆ꪀᥲ️︎',url="t.me/NlR_w"},{text = 'ժ᥎ EᖇᖇOᖇ', url="t.me/K_1_1_0"}},
{{text = '᥉ρ᥆ɾƚ ᥲ️ᖇꪀ᥆ρ', url="t.me/AR_N0️︎️︎"}},
{{text = 'ƚꪝᥲ️︎᥉᥆ꪶ ᥲ️ᖇꪀ᥆ρ', url="t.me/NlR_w60BOT"},
}, 
}
local msgg = msg_id/2097152/0.5
...
"عندك كام سنه؟ ", 
  ...
  "لو صار سوء فهم بينك وبين شخص هل تحب توضحه ولا تخليه كذا  لان مالك خلق توضح ؟ ",
  "كم عددكم بالبيت؟ ",
  "عادي تتزوج من برا بلدك؟ ",
  "أجمل شي بحياتك اي هو؟ ",
} 
...
"‏ انك الجميع و كل من احتل قلبي ⌔️ ⋮ ",
"‏ ‏ لقد تْعَمقتُ بكَ كَثيراً والمِيمُ لام ⌔️ ⋮ ",
"‏ ‏ممكن اكون اختارت غلط بس والله حبيت بجد ⌔️ ⋮ ",
"‏ علينا إحياء زَمن الرّسائل الورقيّة وسط هذه الفوضى الالكترونية العَارمة ⌔️ ⋮ ",
"‏ يجي اي الصاروخ الصيني ده جمب الصاروخ المصري لما بيلبس العبايه السوده ⌔️ ⋮ ",
"‏ كُنت أرقّ من أن أتحمّل كُل تلك القَسوة من عَينيك ⌔️ ⋮ ",
"‏أَكَان عَلَيَّ أَنْ أغْرَس انيابي فِي قَلْبِك لتشعر بِي ⌔️ ⋮ ",
"‏ كُلما أتبع قلبي يدلني إليك ⌔️ ⋮ ",
"‏ أيا ليت من تَهواه العينُ تلقاهُ ⌔️ ⋮ ",
" رغبتي في مُعانقتك عميقة جداً ⌔️ ⋮ ",
"ويُرهقني أنّي مليء بما لا أستطيع قوله ⌔️ ⋮ ",
"‏ من مراتب التعاسه إطالة الندم ع شيء إنتهى ⌔️ ⋮ ",
"‏ ‏كل العالم يهون بس الدنيا بينا تصفي ⌔️ ⋮ ",
"‏ بعض الاِعتذارات يجب أن تُرفَضّ ⌔️ ⋮ ",
"‏ ‏تبدأ حياتك محاولاً فهم كل شيء، وتنهيها محاولاً النجاة من كل ما فهمت ⌔️ ⋮ ",
"‏ إن الأمر ينتهي بِنا إلى أعتياد أي شيء ⌔️ ⋮ ",
"‏ هل كانت كل الطرق تؤدي إليكِ، أم أنني كنتُ أجعلها كذلك ⌔️ ⋮ ",
"‏ ‏هَتفضل تواسيهُم واحد ورا التاني لكن أنتَ هتتنسي ومحدِش هَيواسيك ⌔️ ⋮ ",
"‏ جَبَرَ الله قلوبِكُم ، وقَلبِي ⌔️ ⋮ ",
"‏ بس لما أنا ببقى فايق، ببقى أبكم له ودان ⌔️ ⋮ ",
"‏ ‏مقدرش عالنسيان ولو طال الزمن ⌔️ ⋮ ",
"‏ أنا لستُ لأحد ولا احد لي ، أنا إنسان غريب أساعد من يحتاجني واختفي ⌔️ ⋮ ",
"‏ ‏أحببتك وأنا منطفئ، فما بالك وأنا في كامل توهجي ⌔️ ⋮ ",
"‏ لا تعودني على دفء شمسك، إذا كان في نيتك الغروب ⌔️ ⋮ َ",
"‏ وانتهت صداقة الخمس سنوات بموقف ⌔️ ⋮ ",
"‏ ‏لا تحب أحداً لِدرجة أن تتقبّل أذاه ⌔️ ⋮ ",
"‏ إنعدام الرّغبة أمام الشّيء الّذي أدمنته ، انتصار ⌔️ ⋮ ",
"‏مش جايز , ده اكيد التأخير وارهاق القلب ده وراه عوضاً عظيماً ⌔️ ⋮ ",
" مش جايز , ده اكيد التأخير وارهاق القلب ده وراه عوضاً عظيماً ⌔️ ⋮ ",
"فـ بالله صبر  وبالله يسر وبالله عون وبالله كل شيئ ⌔️ ⋮ ",
"أنا بعتز بنفسي جداً كصاحب وشايف اللي بيخسرني ، بيخسر أنضف وأجدع شخص ممكن يشوفه ⌔️ ⋮ ",
"فجأه جاتلى قافله ‏خلتنى مستعد أخسر أي حد من غير ما أندم عليه ⌔️ ⋮ ",
"‏اللهُم قوني بك حين يقِل صبري ⌔️ ⋮ ",
"‏يارب سهِل لنا كُل حاجة شايلين هَمها ⌔️ ⋮ ‏ ",
"انا محتاج ايام حلوه بقي عشان مش نافع كدا ⌔️ ⋮ ",
"المشكله مش اني باخد قررات غلط المشكله اني بفكر كويس فيها قبل ما اخدها ⌔️ ⋮ ",
"تخيل وانت قاعد مخنوق كدا بتفكر فالمزاكره اللي مزكرتهاش تلاقي قرار الغاء الدراسه ⌔️ ⋮ ",
" مكانوش يستحقوا المعافرة بأمانه ⌔️ ⋮ ",
"‏جمل فترة في حياتي، كانت مع اكثر الناس الذين أذتني نفسيًا ⌔️ ⋮ ",
" ‏إحنا ليه مبنتحبش يعني فينا اي وحش ⌔️ ⋮ ",
"أيام مُمله ومستقبل مجهول ونومٌ غير منتظموالأيامُ تمرُ ولا شيَ يتغير ", 
"عندما تهب ريح المصلحه سوف ياتي الجميع رتكدون تحت قدمك ⌔️ ⋮ ",
"عادي مهما تعادي اختك قد الدنيا ف عادي ⌔️ ⋮ ",
"بقيت لوحدي بمعنا اي انا اصلا من زمان لوحدي ⌔️ ⋮ ",
"- ‏تجري حياتنا بما لاتشتهي أحلامنا ⌔️ ⋮ ",
"تحملين كل هذا الجمال، ‏ألا تتعبين ⌔️ ⋮ ",
"البدايات للكل ، والثبات للصادقين ",
"مُؤخرًا اقتنعت بالجملة دي جدا : Private life always wins ⌔️ ⋮ ",
" الافراط في التسامح بيخللي الناس تستهين بيك ⌔️ ⋮ ",
"مهما كنت كويس فـَ إنت معرض لـِ الاستبدال ⌔️ ⋮ ",
"فخوره بنفسي جدًا رغم اني معملتش حاجه فـ حياتي تستحق الذكر والله ⌔️ ⋮ ",
"‏إسمها ليلة القدر لأنها تُغير الأقدار ,اللهُمَّ غير قدري لحالٍ تُحبه وعوضني خير ⌔️ ⋮ ",
"فى احتمال كبير انها ليلة القدر ادعوا لنفسكم كتير وأدعو ربنا يشفى كل مريض ⌔️ ⋮ ",
"أنِر ظُلمتي، وامحُ خطيئتي، واقبل توبتي وأعتِق رقبتي يا اللّٰه ⌔️ ⋮ إنكَ عفوٌّ تُحِبُّ العفوَ؛ فاعفُ عني ⌔️ ⋮ ",
} 
return bot.sendText(msg_chat_id,msg_id,texting[math.random(#texting)],'md')
end
...
"لو خيروك -›  بين المنزل مع عائلة من الفئران أو عائلة من الأشخاص المزعجين الفضوليين الذين يتدخلون في كل كبيرة وصغيرة؟ ",
} 
return bot.sendText(msg_chat_id,msg_id,texting[math.random(#texting)],'md')
end
...
if text == 'مسح كليشه ستارت ⌔️' then 
if not msg.Asasy then 
return send(msg_chat_id,msg_id,'\n*⌔️ هذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
...
return send(msg_chat_id,msg_id,"⌔️ تم مسح كليشه Start ","md",true)   
end
if text == 'تغيير اسم البوت ⌔️' then 
if not msg.Asasy then 
return send(msg_chat_id,msg_id,'\n*⌔️ هذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
...
if text == 'تغيير كليشه المطور⌔️' then
if not msg.Asasy then 
return send(msg_chat_id,msg_id,'\n*⌔️ هذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
...
if text == 'مسح كليشه المطور⌔️' then
if not msg.Asasy then 
return send(msg_chat_id,msg_id,'\n*⌔️ هذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
...
Redis:set(Fast .."Set:Rd"..senderr..":"..msg_chat_id,true)
return send(msg_chat_id,msg_id,"⌔️ ارسل الان الكلمه لاضافتها في الردود العامه ","md",true)  
end
...
Redis:set(Fast .."Set:On"..senderr..":"..msg_chat_id,true)
return send(msg_chat_id,msg_id,"⌔️ ارسل الان الكلمه لمسحها من الردود العامه","md",true)  
end
if text=='اذاعه خاص⌔️' then 
if not msg.Asasy then 
return send(msg_chat_id,msg_id,'\n*⌔️ هذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
...
if text=='اذاعه للمجموعات⌔️' then 
if not msg.Asasy then 
return send(msg_chat_id,msg_id,'\n*⌔️ هذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
...
if text=='اذاعه بالتوجيه خاص ⌔️' then 
if not msg.Asasy then 
return send(msg_chat_id,msg_id,'\n*⌔️ هذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
...
if text == 'مسح المطورين الثانويين⌔️' then
if not msg.Asasy then 
return send(msg_chat_id,msg_id,'\n*⌔️ هذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
...
if text == 'مسح قائمه العام⌔️' then
if not msg.Asasy then 
return send(msg_chat_id,msg_id,'\n*⌔️ هذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
...
return send(msg_chat_id,msg_id,"⌔️ تم تعطيل البوت الخدمي ","md",true)
end
...
return send(msg_chat_id,msg_id,"⌔️ تم تعطيل التواصل داخل البوت ","md",true)
end
...
return send(msg_chat_id,msg_id,"⌔️ تم تفعيل البوت الخدمي ","md",true)
end
...
return send(msg_chat_id,msg_id,"⌔️ تم تفعيل التواصل داخل البوت ","md",true)
end
if text == 'قائمه العام⌔️' then
if not msg.Asasy then 
return send(msg_chat_id,msg_id,'\n*⌔️ هذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end 
if ChannelJoinch(msg) == false then
...
send(IdSudo,0,Reply_Status(IdUser,'⌔️ قام بارسال الملصق').Reply,"md",true)  
end
return send(IdUser,msg_id,Reply_Status(IdUser,'⌔️ تم ارسال رسالتك الى المطور').Reply,"md",true)  
end
else 
if msg.reply_to_message_id ~= 0 then
...
return send(msg_chat_id,msg_id,Reply_Status(Info_User,'⌔️ تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(Fast ..'BaN:In:Tuasl',Info_User)  
return send(msg_chat_id,msg_id,Reply_Status(Info_User,'⌔️ تم الغاء حظره من تواصل البوت ').Reply,"md",true)  
end 
local ChatAction = bot.sendChatAction(Info_User,'Typing')
if not Info_User or ChatAction.message == "USER_IS_BLOCKED" then
send(msg_chat_id,msg_id,Reply_Status(Info_User,'⌔️ قام بحظر البوت لا استطيع ارسال رسالتك ').Reply,"md",true)  
end
...
send(msg_chat_id,msg_id,Reply_Status(Info_User,'⌔️ تم ارسال رسالتك اليه ').Reply,"md",true)  
end
end
end 
end --UserBot
