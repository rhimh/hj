...
send(msg.chat_id,msg.id,"⌔️ اهلا بك في صانع بوتات سورس ارنـوب \n⌔️ مطور البوت @NlR_w","html",true, false, false, true, reply_markup)
return false 
end
if text == 'السورس' or text == '⌔️ مبرمج السورس' or text == 'مطور السورس ⌔️' then  
...
if text == '⌔️ سورس' or text == 'يا سورس' or text == 'السورس' or text == 'source' then
...
{
{text = ' مبرمج السورس ', url = 't.me/NlR_w '},
},
{
{text = ' تنصيب بوت مدفوع ', url = 't.me/NlR_w'},
},
{
{text = ' قناة التحديثات ', url = 't.me/AR_N1 '},
},
{  
{text = '᥉᥆υᖇᥴᥱ ᥲ️ᖇꪀ᥆ρ', url = 't.me/AR_N1 '},
},
}
...
send(msg.chat_id,msg.id, "\n ⌔️ عـذرا لم تصنع اي بوت من قبل","md",true)  
end
end
