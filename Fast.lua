...
File:write(Get_Json)
File:close()
return LuaTele.sendDocument(msg.chat_id,msg.id,'./'..UserBot..'.json', '*⌔️ تم جلب النسخه الاحتياطيه\n⌔️ تحتوي على 0 جروب \n⌔️ وتحتوي على『 '..#UsersBot..' 』مشترك *\n', 'md')
end
----brodcast all
...
data = {
{
{text = '⌔️ صنع بوت',type = 'text'},{text = '⌔️ طريـقه عـمل بوت',type = 'text'},
},
{
{text = '⌔️ حذف البوت',type = 'text'},
},
{
{text = '⌔️ مبرمج السورس',type = 'text'},{text = 'سـورس⌔',type = 'text'},
},
{
...
send(msg.chat_id,msg.id,"اهلا بـك فـي صـانع بـوتات الـحمايه \n⌔️ مطور البوت @NlR_w","html",true, false, false, true, reply_markup)
return false 
end
if text == '. السورس' or text == '⌔️ ⌔️ مبرمج السورس' or text == 'مطور السورس ⌔️' then  
local UserId_Info = LuaTele.searchPublicChat("NlR_w")
...
local TestText = "*⌔️ مـبرمـج سـورس ارنــوب ⌔️\n⌔️ ɴᴀᴍᴇ ->* ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n*⌔️ ʙɪᴏ -> "..Bio.." *"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = username, url = "https://t.me/NlR_w"}
},
}
...
------------------------------------ كود الـسورس  -------------------
if text == 'سـورس⌔' or text == 'سورس' or text == 'يا سورس' or text == 'source' then
...
{{text = '- اخفاء الامر ', data =msg.sender_id.user_id..'/delAmr'},},}}
 send(msg.chat_id,msg.id,"https://telegra.ph/makebot-11-10","html",false, false, false, false, reply_markup)
end
