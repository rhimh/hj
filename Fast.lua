...
StatusMember = bot.getChatMember(ChatId,UserId).status.Fast bots
if UserId == 5424180506 then
...
if msg.sender_id.Fast bots == "messageSenderChat" then
...
if Info_Members.members[k].status.Fast bots == "chatMemberStatusCreator" then
...
local StatusMember = bot.getChatMember(msg_chat_id,senderr).status.Fast bots
...
if UserInfo and UserInfo.type and UserInfo.type.Fast bots == "userTypeBot" then
...
local UserInfo = bot.getUser(UserId)
if UserInfo.Fast bots == "error" and UserInfo.code == 6 then
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
local StatusMember = bot.getChatMember(msg_chat_id,rep_idd).status.Fast bots
if (StatusMember == "chatMemberStatusCreator") then
return send(msg_chat_id,msg_id,"⌔️ الصلاحيات : مالك الجروب","md",true) 
elseif (StatusMember == "chatMemberStatusAdministrator") then
StatusMemberChat = 'مشرف الجروب'
...
local StatusMember = bot.getChatMember(msg_chat_id,UserId_Info.id).status.Fast bots
if (StatusMember == "chatMemberStatusCreator") then
return send(msg_chat_id,msg_id,"⌔️ الصلاحيات : مالك الجروب","md",true) 
elseif (StatusMember == "chatMemberStatusAdministrator") then
StatusMemberChat = 'مشرف الجروب'
...
local StatusMember = bot.getChatMember(msg_chat_id,Fast ).status.Fast bots
if (StatusMember ~= "chatMemberStatusAdministrator") then
...
for k, v in pairs(List_Members) do
local UserInfo = bot.getUser(v.member_id.user_id)
if Info_Members.members[k].status.Fast bots == "chatMemberStatusAdministrator" then
x = x + 1
Admin = '→ *{ ادمن }*'
else
Admin = ""
...
restricted = '\n*⌔️ قائمه المقيديين \n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉*\n'
for k, v in pairs(List_Members) do
if Info_Members.members[k].status.is_member == true and Info_Members.members[k].status.Fast bots == "chatMemberStatusRestricted" then
y = true
x = x + 1
local UserInfo = bot.getUser(v.member_id.user_id)
if UserInfo.username ~= "" then
...
if UNBan_Bots.Fast bots == "ok" then
x = x + 1
y = true
end
end
...
local GetMemberStatus = bot.getChatMember(msg_chat_id,rep_idd).status 
if GetMemberStatus.Fast bots == "chatMemberStatusRestricted" then
Restricted = 'مقيد'
else
Restricted = 'غير مقيد'
end
...
if ChatAction.Fast bots ~= "ok" then
x = x + 1
...
if statusMem.status.Fast bots == "chatMemberStatusMember" then
x = x + 1
...
{{text = 'القـسـم الـديني',type = 'text'},},
{{text = 'قـسـم الـتـرجـمه',type = 'text'},{text = 'قـسـم الـيوتيوب', type = 'text'},},
{{text = '🐥 قـسـم الافتارات 🐥',type = 'text'},},
{text = '᥉᥆υᖇᥴᥱ ᥲ️ᖇꪀ᥆ρ', type = 'text'},},
{text = 'ժ᥎ ᥲ️ᖴY᥆ꪀᥲ️', type = 'text'},}, 
{{text = 'قـسـم الـتسليه',type = 'text'},{text = '٭ قـسـم الاوامـر الـخـدميهه ٭', type = 'text'},},
{{text = 'قـسـم الـسـورس',type = 'text'},},
{{text = '٭قـسـم الابـراج',type = 'text'},},
...
local reply_markup = LuaTele.replyMarkup{type = 'keyboard',resize = true,is_personal = true,data = {
{{text = '٭ مواقيت الصلاه ٭',type = 'text'},},
{{text = '⌔أذكــار',type = 'text'},{text = '⌔قـرآن', type = 'text'},},
{{text = 'رقـيه شـرعيه',type = 'text'},},
...
local reply_markup = LuaTele.replyMarkup{type = 'keyboard',resize = true,is_personal = true,data = {
{{text = 'اسـتوري انـمـي',type = 'text'},},
{{text = 'حــالات',type = 'text'},},
{{text = 'افتارات صــور',type = 'text'},},
{{text = 'افتارات ريــاضـيه',type = 'text'},},
{text = 'مـعلومات عـامه',type = 'text'},},
{{text = 'افتارات كلاسـيـك',type = 'text'},{text = 'افتارات قــابيـلذ', type = 'text'},},
{{text = 'جداريات',type = 'text'},},
{{text = 'بـنـات افتارات',type = 'text'},{text = 'شـبـاب افتاراتو', type = 'text'},},
{{text = 'افتارات فـيديو',type = 'text'},{text = 'بـيست بـنات', type = 'text'},},
{{text = 'افتارات فـيـكتوري',type = 'text'},{text = 'افتارات سـيـنمائـيه', type = 'text'},},
{{text = 'افتارات فنـانين',type = 'text'},{text = 'افتارات رسـم',type = 'text'},},
{{text = 'افتارات بــــيـتـس',type = 'text'},},
...
if FedMsg.content.Fast bots == "messageSticker" then
