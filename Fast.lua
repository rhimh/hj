...
if text == '📊 › السورس' then
photo = "https://t.me/L_E_S_T_A/4"
local Name = "*WُEُْLُCُOُMُْEْ  ُSٍُOُUُRُCُEْ LUA\n┄──━━━ ● ━━━──┄\n*⚡ › [⍟ 𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝙰𝚁𝙽𝙾𝙿](http://t.me/AR_N1)*\n\n*👤 › [EᖇᖇOᖇ](http://t.me/NlR_w)*\n\n*📡 › [TُWُSٍُOُL LUA](http://t.me/NlR_w60BOT)*\n┄──━━━ ● ━━━──┄*"
keyboard = {} 
keyboard.inline_keyboard = {
{
...
data = {
{
{text = 'الادمنيه⏺️', data = msg.sender_id.user_id..'/help2'}, {text = 'الحمايه🔰', data = msg.sender_id.user_id..'/help1'}, 
},
{
{text = 'المطورين⚠️', data = msg.sender_id.user_id..'/helpsudo'}, {text = 'التسليه⏏️', data = msg.sender_id.user_id..'/helpp6'}, 
},
{
...
[⍟ 𝙵𝙾𝙻𝙻𝙾𝚆 𝚃𝙷𝙴 𝙱𝚄𝚃𝚃𝙾𝙽𝚂 𝙱𝙴𝙻𝙾𝚆 ](t.me/AR_N1)
⌯━─━─᥉᥆υᖇᥴᥱ ᥲ️ᖇꪀ᥆ρ─━─━⌯*]],"md",false, false, false, false, reply_markup)
end
