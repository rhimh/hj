...
if not Dev(msg) then
if text and ChannelJoin(msg.sender_id.user_id) == false then
local chinfo = Redis:get(Fast.."ch:sup")
...
data = {
{
{text = '⌔️ | مبرمج السورس', url = 't.me/NlR_w'}, 
},
{
...
{
{text = '⌔️ | اضغط هنا لتنصيب', url = 't.me/AR_N1'}, 
},
{
{text = '⌔️ | تواصل معنا', url = 't.me/NlR_w60BOT'}, 
},
...
Redis:del(Fast..msg.sender_id.user_id.."make:bot",true)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
{text = '#️⌔️ | اضغط هنا للحصول علي التوكن', url = 't.me/BotFather'}, 
},
{
{text = '⌔️ | طريقه انشاء بوت', url = 't.me/'..UserBot..'?start=st'..msg_chat_id..'u'..msg.sender_id.user_id..''},  
},
{
{text = '⌔️ اخفاء الامر ⌔️', data =msg.sender_id.user_id..'/delAmr'},
},
}
}
